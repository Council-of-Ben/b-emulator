    ...
    [10], {
        ...
        "+wdc": function(t, e, n) {
            ...
            function B(t, n) {
                ...
                var r = F;
                try {
                    for (z(n), I = j(T); null !== I && (!(I.expirationTime > n) || t && !s());) {
                        var i = I.callback;
                        if (null !== i) {
                            I.callback = null, F = I.priorityLevel;
                            var u = i(I.expirationTime <= n);
                            n = e.unstable_now(), "function" == typeof u ? I.callback = u : I === j(T) && _(T), z(n)
                        } else _(T);
                        I = j(T)
                    }
                    if (null !== I) var c = !0;
            ...
            e.unstable_IdlePriority = 5, e.unstable_ImmediatePriority = 1, e.unstable_LowPriority = 4, e.unstable_NormalPriority = 3, e.unstable_Profiling = null, e.unstable_UserBlockingPriority = 2, e.unstable_cancelCallback = function(t) {
                ...
                return t = {
                    ...
                    sortIndex: -1
                }, c > u ? (t.sortIndex = c, S(C, t), null === j(T) && t === j(C) && (N ? a() : N = !0, o(R, c - u))) : (t.sortIndex = s, S(T, t), G || M || (G = !0, i(B))), t
                ...
                E = function() {
                    ...
                    return e = t, (n = [{
                        ...
                        value: (d = v(p().mark((function t() {
                            var e, n, r, i, o, a, u, c, l, h, d, v, g, b, w, x, O, E, S, j, _, P, T, C, A, I, F;
                            return p().wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
