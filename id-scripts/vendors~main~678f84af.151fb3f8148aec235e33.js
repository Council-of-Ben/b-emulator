    ...
    [9], {
        ...
        "+wdc": function(t, e, n) {
                    ...
                    if (n !== e) {
                        ...
                        t: for (var r = 0, i = t.length; r < i;) {
                            var o = 2 * (r + 1) - 1,
                                ...
                                s = o + 1,
                                u = t[s];
                            if (void 0 !== a && 0 > T(a, n)) void 0 !== u && 0 > T(u, a) ? (t[r] = u, t[s] = n, r = s) : (t[r] = a, t[o] = n, r = o);
                            else {
                                if (!(void 0 !== u && 0 > T(u, n))) break t;
                                t[r] = u, t[s] = n, r = s
                            }
                        }
                    }
                ...
                try {
                    for (z(n), I = j(P); null !== I && (!(I.expirationTime > n) || t && !s());) {
                        ...
                        if (null !== i) {
                            ...
                            n = e.unstable_now(), "function" == typeof u ? I.callback = u : I === j(P) && _(P), z(n)
                        } else _(P);
                        I = j(P)
                    }
                    if (null !== I) var c = !0;
            ...
            e.unstable_IdlePriority = 5, e.unstable_ImmediatePriority = 1, e.unstable_LowPriority = 4, e.unstable_NormalPriority = 3, e.unstable_Profiling = null, e.unstable_UserBlockingPriority = 2, e.unstable_cancelCallback = function(t) {
                ...
                return t = {
                    ...
                    sortIndex: -1
                }, c > u ? (t.sortIndex = c, S(C, t), null === j(P) && t === j(C) && (N ? a() : N = !0, o(R, c - u))) : (t.sortIndex = s, S(P, t), G || M || (G = !0, i(B))), t
                ...
                return d.prototype = v, s(b, "constructor", v), s(v, "constructor", d), d.displayName = s(v, a, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                    ...
                    finish: function(t) {
                        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                            ...
                            if (n.finallyLoc === t) return this.complete(n.completion, n.afterLoc), L(n), l
                        }
                    },
                    catch: function(t) {
                        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                E = function() {
                    ...
                    return e = t, (n = [{
                        ...
                        value: (d = v(p().mark((function t() {
                            var e, n, r, i, o, a, u, c, l, h, d, v, g, b, w, x, O, E, S, j, _, T, P, C, A, I, F;
                            return p().wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                    ...
                                    case 62:
                                        (P = this.actualOptions.particles.move.path).generator && this.setPath(L(this, k, "f").plugins.getPathGenerator(P.generator)), this.particles.init(), this.particles.setDensity(), C = m(this.plugins);
                                        try {
        ...
        inmb: function(t, e, n) {
            ...
            function u() {
                ...
                return d.prototype = v, c(b, "constructor", v), c(v, "constructor", d), d.displayName = c(v, a, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                    var e = "function" == typeof t && t.constructor;
                    return !!e && (e === d || "GeneratorFunction" === (e.displayName || e.name))
                }, t.mark = function(t) {
