    ...
    [16], {
        ...
        CXev: function(e, t, a) {
            ...
            function T() {
                ...
                function w(e, t, a) {
                    ...
                    return function(o, s) {
                        ...
                        for (a.method = o, a.arg = s;;) {
                            ...
                            var c = u(e, t, a);
                            if ("normal" === c.type) {
                                if (r = a.done ? "completed" : "suspendedYield", c.arg === f) continue;
                                return {
                                    value: c.arg,
                                    done: a.done
                                }
                ...
                function C(e, t) {
                    ...
                    if (void 0 === a) {
                        if (t.delegate = null, "throw" === t.method) {
                            if (e.iterator.return && (t.method = "return", t.arg = void 0, C(e, t), "throw" === t.method)) return f;
                ...
                return h.prototype = d, r(v, "constructor", {
                    value: d,
                    configurable: !0
                }), r(d, "constructor", {
                    value: h,
                    configurable: !0
                }), h.displayName = c(d, i, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === h || "GeneratorFunction" === (t.displayName || t.name))
                }, e.mark = function(e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, d) : (e.__proto__ = d, c(e, i, "GeneratorFunction")), e.prototype = Object.create(v), e
                }, e.awrap = function(e) {
                    return {
                        __await: e
                    }
                }, b(g.prototype), c(g.prototype, n, (function() {
                    return this
                })), e.AsyncIterator = g, e.async = function(t, a, r, o, s) {
                    void 0 === s && (s = Promise);
                    var n = new g(l(t, a, r, o), s);
                    return e.isGeneratorFunction(a) ? n : n.next().then((function(e) {
                        return e.done ? e.value : n.next()
                    }))
                }, b(v), c(v, i, "Generator"), c(v, s, (function() {
                    return this
                    ...
                    abrupt: function(e, t) {
                        ...
                        return n.type = e, n.arg = t, s ? (this.method = "next", this.next = s.finallyLoc, f) : this.complete(n)
                    },
                    ...
                    finish: function(e) {
                        for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                            ...
                            if (a.finallyLoc === e) return this.complete(a.completion, a.afterLoc), k(a), f
                        }
                    },
                    catch: function(e) {
                        for (var t = this.tryEntries.length - 1; t >= 0; --t) {
            ...
            var M = function(e, t) {
                    ...
                    }, "$".concat(Object(O.q)(e.cash))) : o.a.createElement("div", {
                        className: y.a.stageText
                    }, "Day ".concat(e.day))
                },
                U = function(e) {
                    ...
                    return t = c, (a = [{
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 6:
                                        if (this.isSolo = !this.props.cafe.mode, this.isHw = Boolean(this.props.cafe.resultId), this.isSolo || this.isHw || this.props.liveGameController.setVal({
                                                ...
                                                val: {
                                                    c: P({}, this.props.cafe.corrects),
                                                    i: P({}, this.props.cafe.incorrects)
                                                }
                                                ...
                                                r += e
                                            })), o = this.props.client && this.props.client.blook ? this.props.client.blook : Object(O.k)(Object.keys(S.a)), s = this.props.client && this.props.client.name ? this.props.client.name : "You", (n = this.props.client && this.props.client.standing ? JSON.parse(JSON.stringify(this.props.client.standing)) : [{
                                                name: s,
                                                blook: o,
                                    ...
                                    case 22:
                                        ...
                                        return e.abrupt("return");
                                    case 29:
                                        this.setState(this.props.cafe.mode ? {
                                            name: t.name,
                                    ...
                                    case 31:
                                        this.props.cafe.mode ? this.readyTimeout = setTimeout((function() {
                                            u.setState({
                                                ...
                                                numCorrect: a,
                                                numQuestions: r,
                                                foodServed: u.props.cafe.foodServed,
                                                cafeCash: u.props.cafe.cafeCash,
                                                me: n[i]
                                            })
                                        }), 4750) : t || this.setState(l);
                                    case 32:
                                    case "end":
                                        return e.stop()
                                }
                        ...
                        value: function() {
                            return o.a.createElement("div", {
                                ...
                                title: "Food Served",
                                stat: Object(O.j)(this.state.foodServed)
                            }), o.a.createElement(x.a, {
                                title: "Final Cash",
                                stat: "$".concat(Object(O.j)(this.state.cafeCash))
                            }))
                        }
                    }, {
                        key: "render",
                        value: function() {
                            ...
                            return o.a.createElement("div", {
                                ...
                                myStat: "$".concat(Object(O.j)(this.state.me.cash)),
                    ...
                    return t = p, (a = [{
                            ...
                            return L().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 11:
                                        r = e.sent;
                                    case 12:
                                        if (this.props.setupCafe(r.newSaveId, this.props.id, a, this.props.client && this.props.client.hwId ? this.props.client.hwId : null, this.props.client && this.props.client.amount ? this.props.client.amount : null, this.state.questions, 0, 1, JSON.parse(JSON.stringify(U)), JSON.parse(JSON.stringify(z)), {}, {}, 0, "cafe", {}), !r.oldSave || !r.oldSave.stage) {
                                            e.next = 18;
                                            break
                                        }
                                        return e.next = 16, this.endGame(r.oldSave);
                                    case 16:
                                        e.next = 19;
                                        break;
                                    case 18:
                            ...
                            return L().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return e.next = 2, this.props.user.getData();
                                    case 2:
                                        if (a = e.sent, this.here) {
                                            e.next = 5;
                                            break
                                        }
                                        return e.abrupt("return");
                                    case 5:
                                        r = t.hwName || "You", o = 0, s = 0, Object.values(t.corrects).forEach((function(e) {
                                            o += e, s += e
                                        })), Object.values(t.incorrects).forEach((function(e) {
                                            s += e
                                        })), n = 6 - t.items.level, i = Object(T.k)(Object.keys(N.a)), I.a.put("/api/users/cafestats/solo", {
                                            name: this.name,
                                            place: n,
                                            day: t.day,
                                            cafeCash: t.cafeCash,
                        ...
                        value: function() {
                            return o.a.createElement("div", {
                                ...
                                title: "Food Served",
                                stat: Object(T.j)(this.state.foodServed)
                            }), o.a.createElement(E.a, {
                                title: "Final Cash",
                                stat: Object(T.j)(this.state.cafeCash)
                            }))
                        }
                    }, {
                        key: "render",
                        value: function() {
                            ...
                            return this.props.client && this.props.client.hwId ? this.redirect = !1 : this.state.notLoggedIn && (this.redirect = !0), this.redirect || this.state.ready && (!this.state.questions || 0 === this.state.questions.length) && !this.state.noId ? o.a.createElement(u.a, {
                                ...
                                }, "$".concat(Object(T.j)(t.cafeCash)), o.a.createElement("i", {
                    ...
                    value: function() {
                        if (this.props.host && this.props.host.standings && this.props.host.standings[0] || this.state.standings && this.state.standings[0]) return o.a.createElement("div", {
                            ...
                            stats: this.state.standings.map((function(e) {
                                return "$".concat(Object(b.j)(e.cash))
                            })),
            ...
            var V = ["far fa-hourglass", "fas fa-hourglass-start", "fas fa-hourglass-half", "fas fa-hourglass-end", "fas fa-hourglass"],
                Z = function(e) {
                    ...
                    return t = c, (a = [{
                        ...
                        key: "componentWillUnmount",
                        value: function() {
                            Object(B.p)(), clearTimeout(this.abilityTimeout), Object.keys(this.dbRefStage).length && this.dbRefStage.off("value"), Object.keys(this.dbRefMe).length && this.dbRefMe.off("value")
                        }
                    }, {
                        key: "buyItem",
                        value: function(e) {
                        ...
                        value: function() {
                            ...
                            return this.props.cafe && (this.props.cafe.resultId || this.props.cafe.mode) ? this.redirect = !1 : this.state.notLoggedIn && (this.redirect = !0), this.redirect || !this.props.cafe || this.state.redirect ? o.a.createElement(u.a, {
                                ...
                                }, "time" === s ? "".concat(O.b[s].times[e.state.items[s] - 1], "s").concat(5 !== e.state.items[s] ? " -> ".concat(O.b[s].times[e.state.items[s]], "s") : "", " Bonus Time") : "level" === s ? "x".concat(O.b[s].multipliers[e.state.items[s] - 1]).concat(5 !== e.state.items[s] ? " -> x".concat(O.b[s].multipliers[e.state.items[s]]) : "", " Profits") : e.state.items[s] > 0 ? "$".concat(Object(B.j)(Math.round(O.b[s].profits[e.state.items[s]] * O.b.level.multipliers[e.state.items.level - 1] * (e.props.cafe.mode ? 3.25 : 1.75)))).concat(5 !== e.state.items[s] ? " -> $".concat(Object(B.j)(Math.round(O.b[s].profits[e.state.items[s] + 1] * O.b.level.multipliers[e.state.items.level - 1] * (e.props.cafe.mode ? 3.25 : 1.75)))) : "", " Per Sale") : null, o.a.createElement("br", null), 5 === e.state.items[s] ? "Max Level" : ""), 5 !== e.state.items[s] ? o.a.createElement("div", {
                                    className: v.a.itemUpgrade,
                                    style: {
                                        color: e.state.cafeCash >= n.prices[e.state.items[s]] ? "#4bc22e" : "#c43a35"
                                    }
                                }, "$".concat(Object(B.j)(n.prices[e.state.items[s]]))) : null)) : null
                                ...
                                }, 0 === e.state.abilities[s] ? "Used" : "$".concat(Object(B.j)(Math.round(n.price + e.state.cafeCash * n.percent))))))
                                ...
                                text: "pay" === this.state.attackerAbility ? "".concat(this.state.attackerName, " just gave you a $").concat(Object(B.j)(this.state.cashChange), " paycheck bonus!") : "tax" === this.state.attackerAbility ? "".concat(this.state.attackerName, " just forced you to pay $").concat(Object(B.j)(this.state.cashChange), " in taxes.") : "".concat(this.state.attackerName, " just trashed 3 of each of your foods."),
            ...
            var ue = [].concat(ie(Object.keys(G.a)), ie(Object.keys(H.a)), ie(Object.keys(D.a)), ie(Object.keys(M.a)), ie(Object.keys(U.a))),
                ...
                he = function(e) {
                    ...
                    return t = c, (a = [{
                        ...
                        key: "componentWillUnmount",
                        value: function() {
                            this.here = !1, this.msg.onend = function() {}, window.speechSynthesis.cancel(), Object(A.p)(), this.timeouts.forEach((function(e) {
                                clearTimeout(e)
                        ...
                        value: function() {
                            ...
                            if (!this.state.showTour && this.here && !this.gettingQuestion) {
                                ...
                                var t = Object(A.k)(this.freeQuestions);
                                this.freeQuestions.splice(this.freeQuestions.indexOf(t), 1), t.random && (t.answers = Object(A.r)(t.answers)), this.here && this.setState({
                                    question: t,
                                    phase: "question"
                                }, (function() {
                        ...
                        value: function() {
                            ...
                            for (var o = Math.max(r / this.questions.length / 1.5, 12), s = [], n = 0; n < a; n++) {
                                for (var i = Math.random() > .9, c = Object(A.k)([1, 2, 2, 3, 3, 3]), l = 0, u = {}, f = 0; f < c; f++) {
                                    var p = Object(A.m)(1, Math.min(.35 * this.state.day, i ? 11 : 5) + 2);
                                    u[Object(A.k)(t)] = p, l += p
                                }
                                var h = 0;
                                Object.entries(u).forEach((function(t) {
                                    ...
                                    blook: i ? Object(A.k)(fe) : Object(A.k)(ue),
                            ...
                            this.here && this.setState({
                                ...
                                e.customerTimeout = setTimeout((function() {
                                    var t = [{}, {}, {}];
                                    t[Object(A.m)(0, 3)] = s[0], s.splice(0, 1), e.setState({
                                        customers: t,
                                        futureCustomers: s
                                    }, (function() {
                        ...
                        value: function() {
                            for (var e = this, t = this.state.foods.filter((function(e) {
                                    ...
                                    return e.name
                                })), a = Math.random() > .9, r = Object(A.k)([1, 2, 2, 3, 3, 3]), o = {}, s = 0; s < r; s++) {
                                var n = Object(A.m)(1, Math.min(.03 * (this.foodServed + this.props.cafe.foodServed), a ? 9 : 5) + 2);
                                o[Object(A.k)(t)] = n
                            }
                            var i = 0;
                            ...
                            var c = {
                                blook: a ? Object(A.k)(fe) : Object(A.k)(ue),
                                time: -1,
                        ...
                        value: function() {
                            ...
                            if (this.props.cafe && (this.props.cafe.resultId || this.props.cafe.mode) ? this.redirect = !1 : this.state.notLoggedIn && (Object(h.b)("CafePage cannot render if this.state.notLoggedIn"), this.redirect = !0), this.props.cafe || (Object(h.b)("CafePage cannot render without this.props.cafe"), this.redirect = !0), this.props.cafe.questions || (Object(h.b)("CafePage cannot render without this.props.cafe.questions"), this.redirect = !0), this.props.cafe.questions[0] || (Object(h.b)("CafePage cannot render without this.props.cafe.questions[0]"), this.redirect = !0), this.state.redirect && (Object(h.b)("CafePage cannot render if this.state.redirect"), this.redirect = !0), !this.redirect) return o.a.createElement("div", {
                                ...
                                className: y.a.reportProfit
                            }, "+ $".concat(Object(A.j)(this.state.totalProfit)))), o.a.createElement("div", {
                                ...
                                text: this.state.mode ? "Time" === this.state.mode ? "Make as much money as you can in ".concat(this.state.goal, " ").concat(1 === parseInt(this.state.goal, 10) ? "minute" : "minutes", "!") : "Be the first to make $".concat(Object(A.j)(this.state.goal), "!") : "Your goal for this homework is to keep your Café open for ".concat(this.state.goal, " ").concat(1 === this.state.goal ? "Day" : "Days", "!"),
                                buttonOne: {
                                    text: "Cool",
                                    click: function() {
                                        return e.setState({
                                ...
                                text: "pay" === this.state.ability ? "".concat(this.state.attackerName, " just gave you a $").concat(Object(A.j)(this.state.cashChange), " paycheck bonus!") : "".concat(this.state.attackerName, " just forced you to pay $").concat(Object(A.j)(this.state.cashChange), " in taxes."),
                                blook: this.state.attackerBlook,
                                buttonOne: {
                                    text: "OK",
                                    click: function() {
                            ...
                            }) : null, "inspect" === this.state.ability ? o.a.createElement(P.a, {
                                name: this.state.attackerName,
                                blook: this.state.attackerBlook
            ...
            var K = function(e) {
                ...
                function n(e) {
                    ...
                    return function(e, t) {
                        ...
                        muted: !!e.host && e.host.muted,
                        userToBlock: ""
                    }, t.ok = !1, t.alertContainer = o.a.createRef(), t.getClients = t.getClients.bind(Q(t)), t.changeMuted = t.changeMuted.bind(Q(t)), t.goNext = t.goNext.bind(Q(t)), t.addAlert = t.addAlert.bind(Q(t)), t.scrollToBottom = t.scrollToBottom.bind(Q(t)), t.blockUser = t.blockUser.bind(Q(t)), t.audio = new Audio(L.a), t.audio.muted = t.state.muted, t
                }
                return t = n, (a = [{
                    key: "componentDidMount",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        return this.props.host && this.props.host.settings ? o.a.createElement("div", {
                            ...
                            left: "Blooket",
                            center: "Time" === this.props.host.settings.mode ? this.state.timer : "Goal: $".concat(Object(P.j)(this.props.host.settings.amount)),
                            ...
                            return o.a.createElement("div", {
                                ...
                                }, Object(P.e)(r.place)), o.a.createElement(T.a, {
                                    name: r.blook,
                            ...
                            min: 1,
                            max: Object(P.t)("7vw")
                        }, "$".concat(Object(P.j)(this.state.totalCash)))), this.state.userToBlock ? o.a.createElement(I.a, {
