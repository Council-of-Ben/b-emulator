    ...
    [19], {
        ...
        Dhu9: function(t, e, n) {
            ...
            function P() {
                ...
                return h.prototype = y, r(b, "constructor", {
                    value: y,
                    configurable: !0
                }), r(y, "constructor", {
                    value: h,
                ...
                }, g(b), c(b, s, "Generator"), c(b, i, (function() {
                    return this
            ...
            function T() {
                ...
                return h.prototype = y, r(b, "constructor", {
                    ...
                    finish: function(t) {
                        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                            var n = this.tryEntries[e];
                            if (n.finallyLoc === t) return this.complete(n.completion, n.afterLoc), P(n), f
                        }
                    },
                    catch: function(t) {
                        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                    ...
                    value: function() {
                        ...
                        if (this.props.host && this.props.host.standings && this.props.host.question) return o.a.createElement("div", {
                            ...
                            return o.a.createElement("div", {
                                ...
                                }, Object(P.e)(t.state.move ? r.place : r.questionPlace)), o.a.createElement(j.a, {
                                    name: r.blook,
                                ...
                                }, t.state.showPoints ? Object(P.j)(r.points) : r.correct ? "".concat((r.time / 1e3).toFixed(3), "s") : o.a.createElement("i", {
                    ...
                    value: function() {
                        ...
                        return this.props.client && this.props.client.name ? o.a.createElement("div", {
                            ...
                            return o.a.createElement("div", {
                                ...
                                return o.a.createElement("div", {
                                ...
                                }, Object(T.e)(t.state.move ? r.place : r.questionPlace)), o.a.createElement(E.a, {
                                    name: r.blook,
                                    className: P.a.blookBox
                                    ...
                                    className: v()(P.a.pointsText, R({}, P.a.fadeIn, t.state.showPoints), R({}, P.a.fadeOut, t.state.preShowPoints && !t.state.showPoints))
                                }, t.state.showPoints ? Object(T.j)(r.points) : r.correct ? "".concat((r.time / 1e3).toFixed(3), "s") : o.a.createElement("i", {
                                    className: "fas fa-times"
                                })), o.a.createElement("div", {
                                    className: v()(P.a.addText, t.state.move ? P.a.fadeOut : P.a.fadeIn)
                                }, "+".concat(r.questionPoints))))
                            })))
                        }))) : o.a.createElement(l.a, {
                            to: "/play"
        ...
        glmF: function(t, e, n) {
            ...
            function O() {
                ...
                function j(t, e) {
                    ...
                    if (void 0 === n) {
                        if (e.delegate = null, "throw" === e.method) {
                            if (t.iterator.return && (e.method = "return", e.arg = void 0, j(t, e), "throw" === e.method)) return f;
                            e.method = "throw", e.arg = new TypeError("The iterator does not provide a 'throw' method")
                        }
                        return f
                    }
        ...
        xsDw: function(t, e, n) {
            ...
            var D = function(t) {
                ...
                return e = c, (n = [{
                        ...
                        return T().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    return t.abrupt("return");
                                case 2:
                                    return Object(P.a)(), t.next = 5, this.props.liveGameController.getDatabaseRef("stg");
                                case 5:
                                    this.dbRef = t.sent, this.dbRef.on("value", (function(t) {
                                        var n = t.val();
                                        if (n)
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        this.here = !1, Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(P.p)(), clearTimeout(this.readyTimeout), clearTimeout(this.setTimeout), clearTimeout(this.waitTimeout), clearInterval(this.pointsInterval)
                    }
                }, {
                    key: "render",
                    value: function() {
                        ...
                        }, "".concat(this.state.place).concat(Object(P.e)(this.state.place), " Place")), o.a.createElement("div", {
                            className: x.a.pointsText
                        }, "+".concat(this.state.points, " Points"))) : o.a.createElement(o.a.Fragment, null, o.a.createElement("div", {
                            className: x.a.correctAnswers
                        }, "Correct ".concat(1 === this.state.correctAnswers.length ? "Answer" : "Answers", ": "), Object(P.c)(this.state.correctAnswers, "#fff", 28)), o.a.createElement("div", {
                            className: x.a.pointsText
