    ...
    [12], {
        "+IZH": function(t, e, r) {
            ...
            function O() {
                ...
                var b = h.prototype = p.prototype = Object.create(y);
            ...
            var q = ["Way to Go!", "Nice Work!", "Good Job!", "Keep It Up!", "Well Done!", "Rock On!", "Awesome Sauce!", "Let's Go!"],
                ...
                B = function(t) {
                    ...
                    return e = c, (r = [{
                        ...
                        value: (i = O().mark((function t() {
                            ...
                            return O().wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 2:
                                        return Object(w.a)(), e = this.props.client.team, r = e ? this.props.client.team.name : this.props.client.name, t.next = 7, this.props.firebase.getDatabaseRef(this.props.client.hostId, "stg");
                                    case 7:
                                        ...
                                        return this.setState({
                                            deadHeader: this.props.client.defeated > 0 ? Object(w.m)(q) : Object(w.m)(N)
                                        }), t.abrupt("return");
                                    case 12:
                                            ...
                                            c.state.bothWin || c.props.client.safe || (c.decreaseTimeout = setTimeout((function() {
                                                c.setState({
                                                    loser: k(k({}, c.state.loser), {}, {
                                                        energy: l.isMobile ? c.state.loser.energy - 1 : c.state.loser.energy
                                                    }),
                        ...
                        value: function() {
                            clearTimeout(this.decreaseTimeout), Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(w.r)()
                        }
                    }, {
                        key: "render",
                        value: function() {
            ...
            e.a = Object(u.g)(Object(a.b)((function(t) {
                return {
        ...
        "+UJF": function(t, e, r) {
            ...
            var I = [4200, 2850, 7150, 8150, 8150, 8150, 2575],
                R = function(t) {
                    ! function(t, e) {
                        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                        t.prototype = Object.create(e && e.prototype, {
                    ...
                    function a(t) {
                        ...
                        }, e.ok = !0, e.changeMuted = e.changeMuted.bind(C(e)), e.audio = new Audio(O.a), e.audio.muted = e.state.muted, e
                    }
                    return e = a, (r = [{
                        key: "componentDidMount",
                        value: function() {
                                ...
                                t.startTimeout = setTimeout((function() {
                                    ...
                                    t.props.firebase.getDatabaseVal(e.id, "c", (function(n) {
                                        ...
                                        Object.entries(o).forEach((function(t) {
                                            ...
                                            t.state.standings.length > 0 && (t.state.isTeam ? v.a.post("/api/history", {
        ...
        "6L5a": function(t, e, r) {
            ...
            var R = function(t) {
                ...
                return e = c, (r = [{
                        ...
                        return E().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    return t.abrupt("return");
                                case 2:
                                    return Object(j.a)(), e = this.props.client.team, r = e ? this.props.client.team.name : this.props.client.name, t.next = 7, this.props.firebase.getDatabaseRef(this.props.client.hostId, "stg");
                                case 7:
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(j.r)()
                    }
                }, {
                    key: "render",
                    value: function() {
                        return this.props.client && this.props.client.question && this.props.client.question.answers && this.props.client.answer ? o.a.createElement("div", {
                            className: l.isMobile ? w.a.mBody : w.a.body,
                            style: {
                                backgroundColor: "#fff",
                                overflow: "hidden"
                            }
                            ...
                            className: f()(w.a.bottomTipText, (t = {}, e = v.a.textFade, r = this.state.transitioning, e in t ? Object.defineProperty(t, e, {
                                value: r,
                                enumerable: !0,
                                configurable: !0,
                                writable: !0
        ...
        A0wD: function(t, e, r) {
            ...
            var N = function(t) {
                ...
                return e = c, (r = [{
                        ...
                        return T().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    return t.abrupt("return");
                                case 2:
                                    return Object(k.a)(), this.readyTimeout = setTimeout((function() {
                                                            ...
                                                            if (o.props.client.match && o.props.client.match[0] && o.props.client.question && o.props.client.question.timeLimit) {
                                                                ...
                                                                o.props.firebase.getDatabaseVal(o.props.client.hostId, "c/".concat(o.props.client.match[1].name), (function(r) {
                                                                    if (o.props.client.match && o.props.client.match[0] && o.props.client.question && o.props.client.question.timeLimit) {
                                                                        ...
                                                                        o.props.setMatchResult(l, u, c), e()
                                                                    }
                                                                }))
                                                            }
                                                        }))
                                                        ...
                                                        o.props.firebase.getDatabaseVal(o.props.client.hostId, "a/".concat(o.props.client.match[1].name), (function(r) {
                                                            if (o.props.client.match && o.props.client.match[0] && o.props.client.question && o.props.client.question.timeLimit) {
                                                                var n = r || {},
                                                                    ...
                                                                    c = i.includes(n.a),
                                                                    u = o.props.client.times[o.props.client.times.length - 1],
                                                                    l = Boolean(parseInt(t.val().split("-")[1], 10)),
                                                                    p = s && !c || s && u < a,
                                                                    f = [{
                                                                ...
                                                                o.props.setMatchResult(f, p, l), e()
                                                            }
                                                        }))
                                                    }
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(k.r)(), clearTimeout(this.timeout), clearTimeout(this.transitionTimeout), clearTimeout(this.readyTimeout)
                    }
                }, {
                    key: "render",
                    value: function() {
                        return this.props.client && this.props.client.question && this.props.client.question.correctAnswers ? o.a.createElement("div", {
                            ...
                            className: p()(O.a.regularBody, _.a.background),
                            style: {
                            ...
                            className: _.a.correctAnswers
                        }, "Correct ".concat(1 === this.state.correctAnswers.length ? "Answer:" : "Answers:"), Object(k.c)(this.state.correctAnswers, "#fff", 28))) : null) : o.a.createElement(u.a, {
                            to: "/play"
                        })
                    }
        ...
        CVrY: function(t, e, r) {
            ...
            function w() {
                ...
                }, v(_.prototype), s(_.prototype, i, (function() {
                    return this
            ...
            var C = function(t) {
                ...
                function c(t) {
                    ...
                    return function(t, e) {
                        ...
                        askPlayAgain: !1,
                        muted: !!t.host && t.host.muted
                    }, e.ok = !1, e.leaving = !1, e.onPlayAgainAnswer = e.onPlayAgainAnswer.bind(S(e)), e
                }
                return e = c, (r = [{
                    key: "componentDidMount",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        if (this.props.host && this.props.host.standings && this.props.host.standings[0] || this.state.standings && this.state.standings[0]) return o.a.createElement("div", {
                            ...
                            historyId: this.state.historyId,
                            muted: this.state.muted
                        }) : null, this.state.askPlayAgain ? o.a.createElement(m.a, {
                ...
                D = function(t) {
                    ...
                    function c(t) {
                        ...
                        return function(t, e) {
                            ...
                            centerText: "Loading",
                            muted: !!t.host && t.host.muted
                        }, e.ok = !1, e.here = !0, e.getClients = e.getClients.bind(B(e)), e.updateDimensions = e.updateDimensions.bind(B(e)), e.changeMuted = e.changeMuted.bind(B(e)), e.audio = new Audio(O.a), e.readySetGoAudios = [new Audio(j.a), new Audio(k.a), new Audio(E.a)], e
                    }
                    return e = c, (r = [{
                        key: "componentDidMount",
                                            ...
                                            function t() {
                                                r.rsgTimeout = setTimeout((function() {
                                                    r.setState({
                                                        ...
                                                        e < U.length - 1 && (r.state.muted || r.readySetGoAudios[e].play(), e += 1, t())
                                                    }))
                                                }), U[e].time)
                                ...
                                return o.a.createElement("div", {
                                    ...
                                    return o.a.createElement("div", {
                                        ...
                                        style: {
                                            ...
                                            zIndex: n + 1,
                                            transform: "translateX(".concat(r.progress / (t.state.goalAmount - 1) * (Object(x.v)("96vw") - t.state.size), "px)")
                                        },
        ...
        "RX+X": function(t, e, r) {
            ...
            var I = function(t) {
                ...
                return e = c, (r = [{
                        ...
                        return O().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    ...
                                    }), 1e3), Object(_.a)(), t.next = 7, this.props.firebase.getDatabaseRef(this.props.client.hostId, "stg");
                                case 7:
                                    this.dbRef = t.sent, this.dbRef.on("value", (function(t) {
                                        var e = t.val();
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        this.here = !1, clearInterval(this.timerInterval), Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(_.r)()
                    }
                }, {
                    key: "render",
                    value: function() {
                ...
                A = function(t) {
                    ...
                    function a(t) {
                        ...
                        return function(t, e) {
                            ...
                            standings: [],
                            isBlocked: !1
                        }, e.saveStats = e.saveStats.bind(L(e)), e.renderStats = e.renderStats.bind(L(e)), e
                    }
                    return e = a, (r = [{
                        key: "componentDidMount",
                        value: function() {
        ...
        YoTu: function(t, e, r) {
            ...
            var A = function(t) {
                ...
                return e = c, (r = [{
                        ...
                        return k().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    return t.abrupt("return");
                                case 2:
                                    return Object(O.a)(), this.startTime = p()(), this.answer = "", this.ready = !1, this.readyTimeout = setTimeout((function() {
                                        o.ready = !0
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        this.msg.onend = function() {}, window.speechSynthesis.cancel(), clearTimeout(this.readyTimeout), clearInterval(this.interval), Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(O.r)()
                    }
                }, {
                    key: "onAnswer",
                    value: function(t) {
                ...
                z = function(t) {
                    ...
                    function s(t) {
                        ...
                        return function(t, e) {
                            ...
                            askPlayAgain: !1,
                            isBlocked: !1
                        }, e.ok = !1, e.dbRefStage = {}, e.onPlayAgainAnswer = e.onPlayAgainAnswer.bind(M(e)), e.saveStats = e.saveStats.bind(M(e)), e
                    }
                    return e = s, (r = [{
                        key: "componentDidMount",
                        value: (i = R(S().mark((function t() {
                        ...
                        value: function(t) {
                            var e = this;
                            t ? (this.ok = !0, E.a.put("/c/firebase/join", {
                                id: this.props.client.hostId,
                                name: this.props.client.name
                            }).then(function() {
                                var t = R(S().mark((function t(r) {
                                    var n;
                                    return S().wrap((function(t) {
                                        for (;;) switch (t.prev = t.next) {
                                            case 0:
                                            ...
                                            case 7:
                                                ...
                                                })), e.props.setBlook(n.blook, Object(w.a)(n.blook)), e.props.history.push("/play/lobby"), t.next = 13;
                                                break;
                                            case 12:
                                                e.setState({
                                                    askPlayAgain: !1
                        ...
                        value: function() {
                            var t = this;
                            return this.props.client && this.props.client.standing && this.props.client.standing[0] ? o.a.createElement("div", {
                                className: l.isMobile ? g.a.mBody : g.a.body,
                                style: {
                                    backgroundColor: "#0bc2cf"
                                }
                                ...
                                rightText: "Play Again",
                                rightLink: "/play"
                            }), this.state.ready ? o.a.createElement(O.a, {
                            ...
                            }, "You were blocked from this game.") : null, this.state.askPlayAgain && !this.state.isBlocked ? o.a.createElement(_.a, {
        ...
        bB3c: function(t, e, r) {
            ...
            var U = function(t, e, r, n, o, i) {
                    var a = JSON.parse(JSON.stringify(t || [])),
                        s = Object(j.t)(a.map((function(t) {
                            return B({}, t)
                        })).filter((function(t) {
                    ...
                    var h = R(p.answers);
                    p.random && (h = Object(j.t)(h));
                    for (var y = B(B({}, p), {}, {
                            answers: h
                        }), d = [], m = 0; m < p.answers.length; m++) d.push(h.indexOf(p.answers[m]));
                    var b = d.join(""),
                        v = [],
                        g = {};
                    if (s.length % 2 == 1) {
                    ...
                    for (var x = 0; x < s.length; x += 2) v.unshift([B(B({}, s[x]), {}, {
                        time: 0,
                        correct: !1
                    }), B(B({}, s[x + 1]), {}, {
                        time: 0,
                ...
                D = function(t) {
                    ...
                    function a(t) {
                        ...
                        return function(t, e) {
                            ...
                            matches: [],
                            muted: !!t.host && t.host.muted
                        }, e.ok = !1, e.changeMuted = e.changeMuted.bind(C(e)), e.audio = new Audio(x.a), e.audio.muted = e.state.muted, e
                    }
                    return e = a, (r = [{
                        key: "componentDidMount",
                        value: function() {
                            ...
                            if (this.props.host && this.props.host.round && this.props.host.matches) {
                                ...
                                1 !== e.matches.length && l.animateScroll.scrollToBottom({
                                    duration: .3 * r,
                                    delay: .4 * r,
                                    smooth: "linear",
                                    containerId: "matches"
                                    ...
                                    if (1 === t.props.host.players.length) {
                                        ...
                                        for (var a = n; a <= t.props.host.round; a++)
                                            if (r[a]) {
                                                ...
                                                for (var u = 0; u < r[a].length; u++) "Teams" === t.props.host.settings.mode ? e.push({
                                                    name: r[a][u].name,
                                                    blook: r[a][u].blook,
                                        ...
                                        var p = U(t.props.host.players, "Teams" === t.props.host.settings.mode, t.props.host.usedQuestions, t.props.host.questionsPlayed, t.props.host.questions, t.props.host.dead);
                        ...
                        value: function() {
                            ...
                            if (this.props.host && this.props.host.round && this.props.host.matches) {
                                ...
                                }, "Match Results"), o.a.createElement(l.Element, {
            ...
            var Y = function(t) {
                ...
                function c(t) {
                    ...
                    return function(t, e) {
                        ...
                        showInstructions: !0,
                        readId: ""
                    }, e.dbRefStage = {}, e.dbRefMe = {}, e.dbRefAction = {}, e.questions = [], e.freeQuestions = [], e.corrects = {}, e.incorrects = {}, e.here = !0, e.waiting = !1, e.powerUpCd = 4, e.shield = !1, e.hotCounter = 0, e.msg = {}, e.isReading = !1, e.onAnswer = e.onAnswer.bind(W(e)), e.getQuestion = e.getQuestion.bind(W(e)), e.getPowerUp = e.getPowerUp.bind(W(e)), e.choosePowerUp = e.choosePowerUp.bind(W(e)), e.usePowerUp = e.usePowerUp.bind(W(e)), e.answerNext = e.answerNext.bind(W(e)), e.readQuestion = e.readQuestion.bind(W(e)), e
                }
                return e = c, (r = [{
                    key: "componentDidMount",
                    value: (a = G(z().mark((function t() {
                        var e = this;
                                            ...
                                            if (3 === r.length && r[0] !== e.props.client.name)
                                                if (e.shield) {
                                                    ...
                                                    e.setState({
                                                        ...
                                                        }), P[n].time)) : "party" === n && (clearTimeout(e.partyTimeout), e.partyTimeout = setTimeout((function() {
                                                            e.setState({
                                                                partyBlook: ""
                                                            })
                                                        }), P[n].time))
                    ...
                    value: function() {
                        ...
                        var e = Object(A.m)(this.freeQuestions);
                        this.freeQuestions.splice(this.freeQuestions.indexOf(e), 1), e.random && (e.answers = Object(A.t)(e.answers)), this.here && this.setState({
                            question: e,
                            phase: "question",
                            powerUp: "",
                            numTargets: 0
                    ...
                    value: function() {
                        ...
                        this.here && (this.setState({
                            phase: "powerup",
                            powerUpDisplay: Object(A.m)(Object.values(P)),
                            isChosen: !1
                        }, (function() {
                            t.powerUpInterval = setInterval((function() {
                                t.here && t.setState({
                                    powerUpDisplay: Object(A.m)(Object.values(P).filter((function(e) {
                            ...
                            if (e && t.here) {
                                ...
                                var n = function(t) {
                                    for (var e = Math.min(t, 7), r = 100 * Math.random(), n = 0, o = {}, i = 0; i < S[e].length; i++)
                                        if ((n += S[e][i].rate) >= r) {
                                            var a = S[e][i].name;
                                            o = E({
                                                name: a
                            ...
                            switch (this.state.powerUp.name) {
                                ...
                                case "baby":
                                    ...
                                    this.setState({
                                        ...
                                        notifyIcon: P[this.state.powerUp.name].icon,
                                        notifyBlook: ""
                                    }, (function() {
                    ...
                    value: function() {
                        ...
                        return this.props.client && "Racing" === this.props.client.type && this.props.client.amount && this.props.client.questions && this.props.client.questions[0] ? o.a.createElement("div", {
                            ...
                            className: f()(b.a.regularBody, g.a.powerUpBody),
                            role: "button",
                            tabIndex: 0,
                        ...
                        })) : null, this.state.notifyIcon === P.freeze.icon ? o.a.createElement("div", {
                            className: f()(b.a.regularBody, g.a.freezeContainer)
                        }, o.a.createElement(L.a, {
                            count: l.isMobile ? 85 : 170
                        }), o.a.createElement("i", {
                            className: f()(P.freeze.icon, g.a.freezeIcon)
                        }), o.a.createElement("div", {
                        ...
                        }), this.state.notifyText)) : null), this.state.notifyIcon && this.state.notifyIcon !== P.freeze.icon ? o.a.createElement("div", {
                        ...
                        }, this.state.notifyBlook ? o.a.createElement(I.a, {
                            name: this.state.notifyBlook,
                        ...
                        }) : null)) : null, this.state.partyBlook ? o.a.createElement(C.a, {
            ...
            var P = function(t) {
                ...
                return e = a, (r = [{
                    ...
                    value: function() {
                        var t = this;
                        if (this.props.host && this.props.host.round && this.props.host.matches) {
                            l.animateScroll.scrollToBottom({
                                duration: 3e3,
                                delay: 2e3,
                                smooth: "linear",
                                containerId: "matches"
                    ...
                    value: function() {
                        if (this.props.host && this.props.host.round && this.props.host.matches) {
                            ...
                            }, "Starting In ".concat(this.state.timer)), o.a.createElement(l.Element, {
                            ...
                            if (t.props.host && t.props.host.matches) {
                                ...
                                Object.entries(t.answerObj).forEach((function(n) {
                                    ...
                                    if (s && r.push(a.t), "Teams" === t.props.host.settings.mode) {
                                        for (var c = s ? a.t : 1e3 * t.props.host.question.timeLimit, u = e.length - 1; u >= 0; u--)
                                            if (Object.keys(e[u][0].players).includes(i)) {
                                                if (e[u][0].players[i].time = c, s && (e[u][0].correct = !0), !e[u][0].clone) break
                                            } else if (Object.keys(e[u][1].players).includes(i) && (e[u][1].players[i].time = c, s && (e[u][1].correct = !0), !e[u][1].clone)) break
                                    } else
                                        for (var l = e.length - 1; l >= 0; l--)
                                            ...
                                            } else if (e[l][1].name === i && (e[l][1] = j(j({}, e[l][1]), {}, {
                                            time: a.t,
                                            correct: s
                                        }), !e[l][1].clone)) break
                                }));
                                ...
                                var u = j({}, t.props.host.dead),
                                    l = !1,
                                    p = i.filter((function(t) {
                                        return t.energy > 0
                                    }));
                                0 === p.length ? (l = !0, p = i.map((function(t) {
                                    return j(j({}, t), {}, {
                                        energy: 1
                                    })
                                }))) : u[t.props.host.round] = i.filter((function(t) {
                                    return t.energy <= 0
                                }));
                                ...
                                t.transitionTimeout = setTimeout((function() {
                                    if (t.props.setRoyaleResults(Object.values(t.answerObj).map((function(t) {
                                            return t.a
                                        })), e, p, t.state.numClients, u, r, l), "Teams" === t.props.host.settings.mode) {
                                        var n = {};
