(window.webpackJsonp = window.webpackJsonp || []).push([
    [20], {
        ...
        "8pR5": function(e, t, a) {
            ...
            function Q(e, t) {
                return function(e) {
                    ...
                    var o, n, s = [],
                        ...
                        i = !1;
                    try {
                        for (a = a.call(e); !(r = (o = a.next()).done) && (s.push(o.value), !t || s.length !== t); r = !0);
                    } catch (e) {
                        i = !0, n = e
                    } finally {
                        try {
            ...
            function W() {
                ...
                var p = Object.getPrototypeOf,
                    y = p && p(p(N([])));
                y && y !== t && a.call(y, s) && (_ = y);
                var g = d.prototype = f.prototype = Object.create(_);
                ...
                function w(e, t) {
                    ...
                    if (void 0 === a) {
                        if (t.delegate = null, "throw" === t.method) {
                            if (e.iterator.return && (t.method = "return", t.arg = void 0, w(e, t), "throw" === t.method)) return m;
                    ...
                    var n = o.arg;
                    return n ? n.done ? (t[e.resultName] = n.value, t.next = e.nextLoc, "return" !== t.method && (t.method = "next", t.arg = void 0), t.delegate = null, m) : n : (t.method = "throw", t.arg = new TypeError("iterator result is not an object"), t.delegate = null, m)
                }
                ...
                return h.prototype = d, o(g, "constructor", {
                    value: d,
                    configurable: !0
                }), o(d, "constructor", {
                    value: h,
                    configurable: !0
                }), h.displayName = l(d, i, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === h || "GeneratorFunction" === (t.displayName || t.name))
                }, e.mark = function(e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, d) : (e.__proto__ = d, l(e, i, "GeneratorFunction")), e.prototype = Object.create(g), e
                }, e.awrap = function(e) {
                    return {
                        __await: e
                    }
                    ...
                    return this
                })), e.AsyncIterator = v, e.async = function(t, a, o, n, s) {
                    void 0 === s && (s = Promise);
                    var r = new v(c(t, a, o, n), s);
                    return e.isGeneratorFunction(a) ? r : r.next().then((function(e) {
                        return e.done ? e.value : r.next()
                    }))
                }, b(g), l(g, i, "Generator"), l(g, s, (function() {
                    return this
            ...
            function K(e, t, a, o, n, s, r) {
                ...
                i.done ? t(l) : Promise.resolve(l).then(o, n)
            }
                ...
                ne = function(e) {
                    ...
                    function l(e) {
                        ...
                        return function(e, t) {
                            ...
                            userToBlock: ""
                        }, t.ok = !1, t.dbRefAction = {}, t.alertContainer = n.a.createRef(), t.getClients = t.getClients.bind(te(t)), t.goNext = t.goNext.bind(te(t)), t.addAlert = t.addAlert.bind(te(t)), t.scrollToBottom = t.scrollToBottom.bind(te(t)), t.changeMuted = t.changeMuted.bind(te(t)), t.blockUser = t.blockUser.bind(te(t)), t.audio = new Audio(L.a), t.danceAudio = new Audio(R.a), t.audio.muted = t.state.muted, t
                    }
                    return t = l, (a = [{
                        key: "componentDidMount",
                        value: (s = W().mark((function e() {
                            var t, a, o = this;
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 2:
                                        return this.audio.volume = .6, this.audio.play(), this.audio.addEventListener("ended", (function() {
                                            ...
                                            stage: "fact"
                                        }), this.getClients(!1), e.next = 9, this.props.liveGameController.getDatabaseRef("act");
                                    case 9:
                                            ...
                                            if (t)
                                                if (t.g) {
                                                    ...
                                                    o.setState({
                                                        glitcherName: t.n,
                                                        glitcherBlook: t.b
                                                    }), o.addAlert(t.n, t.b, "activated the ".concat(a, " glitch!"), "", [n.icon, n.color])
                                                } else if (t.s) {
                                                var l = t.s.split("-");
                        ...
                        value: function() {
                            var e = this;
                            clearInterval(this.timerInterval), clearInterval(this.hazardInterval), clearInterval(this.clientsInterval), clearTimeout(this.glitchTimeout), clearTimeout(this.adTimeout), clearTimeout(this.lunchTimeout), clearTimeout(this.jokeTimeout), clearTimeout(this.lolTimeout), clearTimeout(this.slowTimeout), clearTimeout(this.danceTimeout), Object.keys(this.dbRefAction).length && this.dbRefAction.off("value"), !this.ok && this.props.host && this.props.host.id && (this.props.liveGameController.removeHostAndDeleteGame(), this.props.deleteHost()), this.audio.currentTime = 0, this.audio.pause(), this.audio.removeEventListener("ended", (function() {
                            ...
                            this.props.liveGameController.getDatabaseVal("c", (function(a) {
                                ...
                                if (o && 0 !== Object.keys(o).length) {
                                    ...
                                    s.forEach((function(e) {
                                        if (e.toAttack && (t.props.liveGameController.setVal({
                                                path: "act",
                                                val: {
                                                    n: e.name,
                                                    b: e.blook,
                                            ...
                                            }), t.props.liveGameController.removeVal("c/".concat(e.name, "/tat"))), e.synergy) {
                                            var a = e.synergy.split("-");
                                            t.addAlert(e.name, e.blook, "has a ".concat(a[0], " ").concat(a[1], " synergy!")), t.props.liveGameController.removeVal("c/".concat(e.name, "/s"))
                                        }
                                    })), s.sort((function(e, t) {
                                        return t.cash - e.cash
                                    }));
                                    for (var r = 0, i = 0; i < s.length; i++) s[i].place = i + 1, r += s[i].cash, "Cash" === t.props.host.settings.mode && s[i].cash >= t.props.host.settings.amount && (n = !0);
                                    n ? t.goNext(J(s)) : t.setState({
                                        players: s,
                                        totalCash: r
                                    }), e && t.goNext(J(s))
                                }
                        ...
                        value: function(e, t, a, o, n) {
                            var s = [].concat(J(this.state.alerts), [{
                                name: e,
                                blook: t,
                                msg: a,
                                endBlook: o,
                        ...
                        value: function() {
                            ...
                            if (this.props.host && this.props.host.settings) {
                                ...
                                return n.a.createElement("div", {
                                    ...
                                    left: "Blooket",
                                    center: "Time" === this.props.host.settings.mode ? this.state.timer : "Goal: $".concat(Object(z.j)(this.props.host.settings.amount)),
                                    ...
                                    return n.a.createElement("div", {
                                        className: _()(E.a.left, E.a.invisibleScrollbar)
                                    }, s.map((function(s) {
                                        var r = s.key,
                                            i = s.data,
                                            l = s.state,
                                        ...
                                        }, i.place), n.a.createElement("div", {
                                            className: E.a.superPlaceText,
                                            style: {
                                                color: t ? "#fff" : null
                                            }
                                        }, Object(z.e)(i.place)), n.a.createElement(P.a, {
                                            name: i.blook,
                                        ...
                                        }, i.name), n.a.createElement(u.Textfit, {
                                        ...
                                        }, "$".concat(Object(z.q)(i.cash))))
                                    })))
                                })), n.a.createElement("div", {
                                    className: _()(E.a.chatroom, E.a.invisibleScrollbar),
                                    id: "alerts",
                                    style: {
                                    ...
                                    className: _()(E.a.noAlertsIcon, "far fa-clock")
                                }), n.a.createElement("div", {
                                    className: E.a.noAlertsText
                                }, "Waiting For Action..."))), n.a.createElement(u.Textfit, {
                                ...
                                }, "$".concat(Object(z.j)(this.state.totalCash)))), this.state.lunch ? n.a.createElement("div", {
                                    className: N.a.modal
                                }, n.a.createElement("i", {
                                    className: _()("fas fa-hamburger", E.a.burger),
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }), n.a.createElement("div", {
                                    className: E.a.burgerText
                                }, "Lunch Break")) : null, this.state.ads.reduce((function(e, t) {
                                    return e + t
                                }), 0) > 0 ? n.a.createElement(S.a, {
                                    ads: this.state.ads,
                                    onClick: function() {},
                                    night: t,
                                    hazards: [a].concat(J(o))
                                }) : null, this.state.lol ? n.a.createElement(j.a, null) : null, this.state.joke ? n.a.createElement(B.a, null) : null, this.state.slow ? n.a.createElement(I.a, {
                                    night: t
                                }) : null), this.state.dance ? n.a.createElement(F.a, {
                                    name: this.state.glitcherName,
                                    blook: this.state.glitcherBlook
                                }) : null, this.state.userToBlock ? n.a.createElement(k.a, {
        ...
        FRAn: function(e, t, a) {
            ...
            var A = function(e) {
                    return n.a.createElement("div", {
                        className: p.a.cashText
                    }, "$".concat(Object(w.q)(e.cash)))
                },
                q = function(e) {
                    ! function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                    ...
                    function r(e) {
                        ...
                        return function(e, t) {
                            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                        }(this, r), (t = s.call(this, e)).state = {
                            numCorrect: "",
                            numQuestions: "",
                            ready: !1,
                            standings: [],
                            isBlocked: !1
                        }, t.saveStats = t.saveStats.bind(F(t)), t.renderStats = t.renderStats.bind(F(t)), t.isSolo = !1, t.isHW = !1, t
                    }
                    return t = r, (a = [{
                        key: "componentDidMount",
                        value: function() {
                            ...
                            if (this.props.client && this.props.client.standing && this.props.client.standing[0]) {
                                this.isSolo = this.props.client.mode.includes("Solo"), this.isHW = Boolean(this.props.client.hwId), this.isSolo || this.isHW || this.props.liveGameController.setVal({
                                ...
                                if (-1 !== a) {
                                    ...
                                    Object.values(this.props.client.corrects).forEach((function(e) {
                                        ...
                                        n += e
                                    })), this.isHW && k.a.post("/api/results", {
                        ...
                        key: "saveStats",
                        value: function(e, t) {
                            k.a.put("/api/users/factorystats", {
                                name: e,
                        ...
                        value: function() {
                            return this.props.client && this.props.client.standing && this.props.client.standing[0] ? n.a.createElement("div", {
                                ...
                                myStat: "$".concat(Object(w.j)(this.state.me.cash)),
                    ...
                    }]) && j(t.prototype, a), o && j(t, o), Object.defineProperty(t, "prototype", {
                        writable: !1
                    }), r
                }(n.a.Component);
            q.propTypes = {
        ...
        GQvx: function(e, t, a) {
            ...
            var q = function(e) {
                ...
                return t = l, (a = [{
                    ...
                    key: "render",
                    value: function() {
                        return this.props.client && this.props.client.hwId ? this.redirect = !1 : this.state.notLoggedIn && (this.redirect = !0), this.redirect || !this.props.id && (!this.props.client || !this.props.client.hwId) || this.state.ready && 0 === this.state.questions.length ? n.a.createElement(u.a, {
                            to: "/play"
                        }) : n.a.createElement("div", {
                        ...
                        }, "Start Game")), n.a.createElement("div", {
                            className: b.a.factoriesContainer
                        }, n.a.createElement("div", {
                            className: b.a.factory
                        }, n.a.createElement("div", {
                            className: b.a.blookHolder
                        }, n.a.createElement(C.a, {
                            name: "Chick",
                            className: b.a.factoryBlook
                        }), n.a.createElement("div", {
                            className: b.a.factoryBarHolder
                        }, n.a.createElement("div", {
                            className: b.a.factoryBar,
                            style: {
                                transform: "translateX(-50%)",
                                backgroundColor: Object(k.a)("Chick")
                            }
                        }))), n.a.createElement("div", {
                            className: b.a.blookDesc
                        }, "III: $".concat(Object(T.q)(65), " / 1s")), n.a.createElement("div", {
                            className: b.a.factoryButtonContainer
                        }, n.a.createElement("div", {
                            className: b.a.factoryUpgrade,
                            style: {
                                color: "#4bc22e"
                            }
                        }, n.a.createElement("i", {
                            className: h()(b.a.upgradeIcon, "fas fa-angle-double-up")
                        }), n.a.createElement("div", {
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.q)(3e4)))), n.a.createElement("div", {
                            className: b.a.factoryClass
                        }, "🌽"))), n.a.createElement("div", {
                            className: b.a.factory
                        }, n.a.createElement("div", {
                            className: b.a.blookHolder
                            ...
                            style: {
                                ...
                                backgroundColor: Object(k.a)("Jester")
                            }
                        }))), n.a.createElement("div", {
                            className: b.a.blookDesc
                        }, "I: $".concat(Object(T.q)(25e3), " / 3s")), n.a.createElement("div", {
                            className: b.a.factoryButtonContainer
                        }, n.a.createElement("div", {
                            className: b.a.factoryUpgrade,
                            style: {
                            ...
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.q)(2e6)))), n.a.createElement("div", {
                            className: b.a.factoryClass
                            ...
                            style: {
                                ...
                                backgroundColor: Object(k.a)("Walrus")
                            }
                        }))), n.a.createElement("div", {
                            className: b.a.blookDesc
                        }, "IV: $".concat(Object(T.q)(3700), " / 4s")), n.a.createElement("div", {
                            className: b.a.factoryButtonContainer
                        }, n.a.createElement("div", {
                            className: b.a.factoryUpgrade,
                            style: {
                            ...
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.q)(1e6)))), n.a.createElement("div", {
                            className: b.a.factoryClass
                        }, "❄️"))), n.a.createElement("div", {
                            className: b.a.factory
                        }, n.a.createElement("div", {
                            ...
                            style: {
                                ...
                                backgroundColor: Object(k.a)("Hamster")
                            }
                        }))), n.a.createElement("div", {
                            className: b.a.blookDesc
                        }, "III: $450 / 4s"), n.a.createElement("div", {
                            className: b.a.factoryButtonContainer
                        }, n.a.createElement("div", {
                            className: b.a.factoryUpgrade,
                            style: {
                            ...
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.q)(8e4)))), n.a.createElement("div", {
                            className: b.a.factoryClass
                        }, "🐾"))), n.a.createElement("div", {
                            className: b.a.factory
                        }, n.a.createElement("div", {
                            ...
                            style: {
                                ...
                                backgroundColor: Object(k.a)("Macaw")
                            }
                        }))), n.a.createElement("div", {
                            className: b.a.blookDesc
                        }, "II: $8 / 1s"), n.a.createElement("div", {
                            className: b.a.factoryButtonContainer
                        }, n.a.createElement("div", {
                            className: b.a.factoryUpgrade,
                            style: {
                            ...
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.q)(5400)))), n.a.createElement("div", {
                            className: b.a.factoryClass
                        }, "🌴"))), n.a.createElement("div", {
                            className: b.a.factory
                        }, n.a.createElement("div", {
                            ...
                            style: {
                                ...
                                backgroundColor: Object(k.a)("Jaguar")
                            }
                        }))), n.a.createElement("div", {
                            className: b.a.blookDesc
                        }, "I: $8 / 3s"), n.a.createElement("div", {
                            className: b.a.factoryButtonContainer
                        }, n.a.createElement("div", {
                            className: b.a.factoryUpgrade,
                            style: {
                            ...
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.q)(390)))), n.a.createElement("div", {
                            className: b.a.factoryClass
                        }, "🌴"))))))
                    }
                }]) && S(t.prototype, a), o && S(t, o), Object.defineProperty(t, "prototype", {
                    writable: !1
                }), l
            }(n.a.Component);
            q.propTypes = {
            ...
            t.a = Object(w.c)(Object(c.f)(Object(r.b)((function(e) {
                return {
                    id: e.hosts.id,
                    client: e.clients.client
                }
        ...
        HFYo: function(e, t, a) {
            ...
            function i(e, t, a) {
                return function(e, t, a) {
                    for (var o = a ? .05 : .03, n = []; n.length < 3;) {
                        var s = Math.random(),
                            i = e[Math.floor(Math.random() * e.length)];
                        if (s < o && t)
                            for (var l = s / o, c = 0, u = 0; u < r.length; u++)
                                if ((c += r[u].rate) >= l) {
                                    i = r[u];
                                    break
        ...
        MnXr: function(e, t, a) {
            ...
            var O = function(e) {
                ...
                return t = r, (a = [{
                        ...
                        if (this.props.host && this.props.host.standings && this.props.host.standings[0]) {
                            ...
                            this.setState({
                                ...
                                e.startTimeout = setTimeout((function() {
                                    var a = {};
                                    e.props.liveGameController.getDatabaseVal("c", (function(o) {
                                        var n = o || {};
                                        ...
                                        })), t && t.id && (e.props.liveGameController.removeHostAndDeleteGame(t.id), e.props.deleteHost()), e.waitTimeout = setTimeout((function() {
                    ...
                    value: function() {
                        if (this.props.host && this.props.host.standings && this.props.host.standings[0] || this.state.standings && this.state.standings[0]) return n.a.createElement("div", {
                            ...
                            title: "Host Blooket",
                            desc: "Host a game of Blooket with any question set. Then, have players join and answer questions to compete in an action-packed activity."
                        }), this.state.standings.length > 0 ? n.a.createElement(d.a, {
                            standings: this.state.standings,
                            stats: this.state.standings.map((function(e) {
                                return "$".concat(Object(_.j)(e.cash))
                            })),
                ...
                }]) && w(t.prototype, a), o && w(t, o), Object.defineProperty(t, "prototype", {
                    writable: !1
                }), r
            }(n.a.Component);
            O.propTypes = {
        ...
        S5NC: function(e, t, a) {
                                ...
                                return new t((function(n, r) {
                                    ! function o(n, s, r, i) {
                                        ...
                                        if ("throw" !== l.type) {
                                            var c = l.arg,
                                                m = c.value;
                                            return m && "object" == Q(m) && a.call(m, "__await") ? t.resolve(m.__await).then((function(e) {
                                                o("next", e, r, i)
                                            }), (function(e) {
                                                o("throw", e, r, i)
                                            })) : t.resolve(m).then((function(e) {
            ...
            var re = function(e) {
                ...
                ie = ["I", "II", "III", "IV", "V"],
                le = ["#FF00FF", "#FF6600", "#FFFF00", "#00FFFF", "#FF0000", "#00FF00"],
                ce = function(e) {
                    var t = e.length;
                    if (0 === t) return "";
                ...
                ue = function(e) {
                    ...
                    function l(e) {
                        ...
                        return function(e, t) {
                            ...
                            askTour: !0,
                            zoomedImage: ""
                        }, t.dbRefStage = {}, t.dbRefAction = {}, t.waiting = !1, t.timeouts = [], t.upgrades = 0, t.corrects = {}, t.incorrects = {}, t.reminder = 0, t.reminding = !1, t.safe = !1, t.winSent = !1, t.isSolo = !1, t.isHW = !1, t.fullTimer = 60, t.questions = [], t.freeQuestions = [], t.msg = {}, t.isReading = !1, t.tourRef = n.a.createRef(), t.randomQ = t.randomQ.bind(ne(t)), t.onAnswer = t.onAnswer.bind(ne(t)), t.onKeyPress = t.onKeyPress.bind(ne(t)), t.goNext = t.goNext.bind(ne(t)), t.chooseBlook = t.chooseBlook.bind(ne(t)), t.addCash = t.addCash.bind(ne(t)), t.upgrade = t.upgrade.bind(ne(t)), t.deleteBlook = t.deleteBlook.bind(ne(t)), t.closeAd = t.closeAd.bind(ne(t)), t.checkResize = t.checkResize.bind(ne(t)), t.readToMe = t.readToMe.bind(ne(t)), t
                    }
                    return t = l, (a = [{
                        key: "componentDidMount",
                        value: (r = $(W().mark((function e() {
                            var t, a, o = this;
                            return W().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                    ...
                                    case 2:
                                        if (Object(D.a)(), this.isSolo = this.props.client.mode && this.props.client.mode.includes("Solo"), this.isHW = Boolean(this.props.client.hwId), window.addEventListener("resize", this.checkResize), this.isSolo || this.isHW && this.props.client.mode && "Time" === this.props.client.mode ? (t = this.props.client.amount < 1.5, this.fullTimer = Math.max(60 * this.props.client.amount, 60), this.setState({
                                                ...
                                                o.timerInterval = setInterval((function() {
                                                    if (o.fullTimer -= 1, o.setState({
                                                        ...
                                                        o.props.factoryResults(o.upgrades, o.corrects, o.incorrects, n), o.props.history.push("/play/factory/final")
                                                    }
                                                }), 1e3)
                                        ...
                                        return e.next = 11, this.props.liveGameController.getDatabaseRef("stg");
                                    case 11:
                                        return this.dbRefStage = e.sent, this.dbRefStage.on("value", (function(e) {
                                            switch (e.val()) {
                                                case "fin":
                                                    o.props.liveGameController.getDatabaseVal("st", (function(e) {
                                                    ...
                                                    break;
                                                case null:
                                                    o.props.liveGameController.getDatabaseVal("stg", (function(e) {
                                                        e || (o.props.deleteClient(), o.props.history.push("/play"))
                                                    }))
                                            }
                                        })), e.next = 15, this.props.liveGameController.getDatabaseRef("act");
                                    case 15:
                                        this.dbRefAction = e.sent, this.dbRefAction.on("value", (function(e) {
                                            if (e.val() && e.val().g)
                                                if (o.safe) o.safe = !1;
                                                ...
                                                if (clearTimeout(o.nameTimeout), "Lunch Break" === t) o.setState({
                                                    ...
                                                    o.adTimeout = setTimeout((function e() {
                                                        ...
                                                        t[n] = 1, o.setState({
                                                            ads: t
                                                        }), (n += 1) < o.state.ads.length && (o.adTimeout = setTimeout(e, 800))
                                                    }), 800)
                                                } else if ("Error 37" === t) {
                                                    clearInterval(o.hazardInterval), clearTimeout(o.nightTimeout);
                                                    var s = 3,
                                                        r = function() {
                                                            var e = Object(D.r)(le).slice(0, 5);
                                                            o.setState({
                                                                color: "error",
                                                                hazards: e
                                                            })
                                                    ...
                                                    r(), o.hazardInterval = setInterval((function() {
                                                        r(), s <= 0 ? (clearInterval(o.hazardInterval), o.setState({
                                                            color: ""
                                                        })) : s -= 1
                                                    }), 3250)
                                    ...
                                    case 17:
                                        this.questions = JSON.parse(JSON.stringify(this.props.client.questions)), this.freeQuestions = [], a = this.randomQ(), this.setState({
                                            ...
                                            ready: !0,
                                            name: this.props.client.name
                                        }), !this.props.client.cash || this.isSolo || this.isHW || (this.upgrades = this.props.client.upgrades, this.corrects = Y({}, this.props.client.corrects), this.incorrects = Y({}, this.props.client.incorrects), this.setState({
                                            cash: this.props.client.cash,
                                            blooks: JSON.parse(JSON.stringify(this.props.client.blooks))
                                        }, (function() {
                                            o.props.client && o.props.client.hostId && o.props.client.name && o.props.client.blook ? o.props.liveGameController.setVal({
                                                path: "c/".concat(o.props.client.name, "/ca"),
                                                val: o.state.cash
                                            }) : o.props.history.push("/play")
                                        }))), this.isHW || this.isSolo || (this.cashInterval = setInterval((function() {
                                            o.props.client.blook && o.props.client.hostId && o.props.client.name && o.props.liveGameController.setVal({
                                                path: "c/".concat(o.props.client.name, "/ca"),
                                                val: o.state.cash
                                            })
                        ...
                        key: "componentWillUnmount",
                        value: function() {
                            this.props.factoryDisconnect(this.upgrades, this.corrects, this.incorrects, this.state.cash, this.state.blooks), Object(D.p)(), document.removeEventListener("keypress", this.onKeyPress), clearTimeout(this.remindTimeout), clearInterval(this.cashInterval), clearInterval(this.timerInterval), clearInterval(this.incorrectInterval), clearTimeout(this.questionTimeout), clearTimeout(this.feedbackTimeout), clearTimeout(this.minuteTimeout), clearTimeout(this.adTimeout), clearInterval(this.hazardInterval), clearTimeout(this.nightTimeout), clearTimeout(this.glitchTimeout), clearTimeout(this.lolTimeout), clearTimeout(this.jokeTimeout), clearTimeout(this.slowTimeout), clearTimeout(this.danceTimeout), clearTimeout(this.nameTimeout), clearTimeout(this.reminderTimeout), this.timeouts.forEach((function(e) {
                                clearTimeout(e)
                        ...
                        value: function() {
                            ...
                            if (!this.waiting && !this.state.choices[0])
                                if (this.state.correct && this.state.showTour && 1 === Object.values(this.corrects).reduce((function(e, t) {
                                        return e + t
                                    })) && this.tourRef.current.setStep(p.isMobile ? 3 : 1), this.waiting = !0, this.state.progress >= this.state.progressNeeded) {
                                    var t = this.randomQ();
                                    this.setState({
                                        choices: Object(N.a)(!this.state.showTour && this.props.client.glitchesOn, this.state.blooks.length >= 10, this.state.cash > 6e3),
                                        waiting: !0,
                                        feedback: !1,
                                        question: t
                                    }, (function() {
                                        e.state.showTour && e.tourRef.current.setStep(p.isMobile ? 6 : 3), e.feedbackTimeout = setTimeout((function() {
                                            e.waiting = !1
                                        }), 700)
                                    }))
                                } else {
                        ...
                        value: function() {
                            ...
                            var e = Object(D.k)(this.freeQuestions);
                            return this.freeQuestions.splice(this.freeQuestions.indexOf(e), 1), e.random && (e.answers = Object(D.r)(e.answers)), e
                        }
                    }, {
                        key: "chooseBlook",
                        value: function(e) {
                            ...
                            if (!this.waiting) {
                                ...
                                if (this.state.blooks.length >= 10) return this.waiting = !1, void(p.isMobile ? this.setState({
                                    deleteFor: e,
                                    choices: [],
                                    feedback: !1,
                                    showQ: !1,
                                ...
                                var a = K(this.state.blooks),
                                    ...
                                    s = a.map((function(e) {
                                        return e.class
                                    })).lastIndexOf(e.class); - 1 !== n ? a.splice(n + 1, 0, o) : -1 !== s ? a.splice(s + 1, 0, o) : a.push(o), this.state.classes.includes(e.class) || this.setState({
                                    classes: [].concat(K(this.state.classes), [e.class])
                                });
                                var r = a.filter((function(t) {
                                    return t.class === e.class
                                }));
                                ![5, 7, 10].includes(r.length) || this.isSolo || this.isHW || this.props.liveGameController.setVal({
                                    ...
                                    t.state.showTour && t.tourRef.current.setStep(p.isMobile ? 8 : 4), t.questionTimeout = setTimeout((function() {
                                        t.waiting = !1
                                    }), 300)
                                })), this.upgrades += 1
                            }
                        ...
                        key: "chooseGlitch",
                        value: function(e) {
                            this.waiting || (this.waiting = !1, this.safe = !0, this.props.client.name && this.props.client.blook && this.props.client.hostId && this.props.liveGameController.setVal({
                            ...
                            if (this.state.deleteFor.name) {
                                ...
                                if (-1 !== o) {
                                    ...
                                    if (n.forEach((function(e) {
                                            a[a.indexOf(e)].bonus = 1 + .5 * (n.length - 1)
                                        })), 0 === n.length) {
                                        var s = JSON.parse(JSON.stringify(this.state.classes));
                                        s.splice(s.indexOf(e.class), 1), this.setState({
                                            classes: s
                                        })
                                    }
                                    this.setState({
                        ...
                        value: function(e) {
                            var t = this,
                                a = K(this.state.blooks);
                            a[a.indexOf(e)].active = !0;
                            var o = this.state.cash + Math.round(e.cash[e.level] * e.bonus);
                            if ("Cash" === this.props.client.mode && o >= this.props.client.amount && this.props.client.hostId && this.props.client.blook && !this.winSent && !this.isHW) this.winSent = !0, this.props.liveGameController.setVal({
                            ...
                            if (this.reminder < 3 && !this.state.remind && !this.reminding)
                                for (var i = function(e) {
                                        var n = a[e];
                                        if (n.price[n.level] < o) return t.reminding = !0, t.remindTimeout = setTimeout((function() {
                                            t.reminding = !1, n.price[n.level] < o && t.setState({
                                                remind: !0
                                            })
                                        }), 7e3), "break"
                            ...
                            var c = setTimeout((function() {
                                var o = (a = K(t.state.blooks)).indexOf(e);
                                if (-1 !== o) {
                                    a[o].active = !1, t.setState({
                                        blooks: a
                                    });
                                    var n = t.timeouts.indexOf(c); - 1 !== n && t.timeouts.splice(n, 1)
                                }
                            }), 600);
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 2:
                                        return this.isReading = !0, t = function(e, t, o) {
                                            ...
                                            e.includes("`*`") && (n = e.slice(0, e.indexOf("`*`"))), a.msg = new SpeechSynthesisUtterance(n), document.getElementById(t) && (document.getElementById(t).style.textDecoration = "underline"), window.speechSynthesis.speak(a.msg), a.msg.onend = function() {
                        ...
                        value: function() {
                            var e = this;
                            if (!this.props.client || !this.props.client.questions || !this.props.client.questions[0]) return n.a.createElement(u.a, {
                                to: "/play"
                            });
                            var t = "night" === this.state.color,
                                a = "error" === this.state.color,
                                o = this.state.hazards;
                            return n.a.createElement("div", {
                                className: p.isMobile ? E.a.mBody : E.a.body,
                                id: "body",
                                style: {
                                    overflow: "hidden",
                                    backgroundColor: t ? "#000" : a ? o[0] : null
                                ...
                                className: S.a.headerTextLeft
                            }, p.isMobile ? null : n.a.createElement("i", {
                                className: h()(S.a.expandIcon, this.state.full ? "fas fa-compress" : "fas fa-expand"),
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                                    return e.setState({
                            ...
                            }), this.state.feedback || this.state.choices[0] || p.isMobile && !this.state.showQ || !window.speechSynthesis ? null : n.a.createElement("i", {
                                className: h()(S.a.expandIcon, "fas fa-volume-up"),
                                role: "button",
                                tabIndex: 0,
                                onClick: this.readToMe
                            }), p.isMobile && this.state.cash > 1e9 ? "" : this.state.fullTimer || this.state.name), n.a.createElement("div", {
                                className: S.a.headerTextRight
                            }, "$".concat(Object(D.j)(this.state.cash)))), this.state.ready && !p.isMobile ? n.a.createElement("div", {
                                className: E.a.regularBody,
                                id: "regularBody",
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[2] : null
                                }
                            }, this.state.showTour ? n.a.createElement(A.a, {
                                steps: v,
                                onExit: function() {
                                    return e.setState({
                                        showTour: !1
                                ...
                                className: S.a.progressBox,
                                style: {
                                    backgroundColor: t ? "#fff" : null
                                }
                            }, n.a.createElement("div", {
                                className: S.a.progressText,
                                style: {
                                    color: t ? "#000" : a ? o[2] : null
                                }
                            }, this.state.progressNeeded - this.state.progress))), n.a.createElement("div", {
                                className: S.a.bottomRight
                            }, n.a.createElement("div", {
                                className: S.a.factories
                            }, this.state.blooks[0] ? this.state.blooks.map((function(s, r) {
                                return n.a.createElement("div", {
                                    key: e.state.blooks.indexOf(s),
                                    className: h()(e.state.deleteFor.name ? S.a.factoryButton : S.a.factory),
                                    role: "button",
                                    tabIndex: "0",
                                    onClick: function() {
                                        return e.deleteBlook(s)
                                    },
                                    id: "blook".concat(r)
                                }, s.active ? n.a.createElement("div", {
                                    className: S.a.factoryFloat
                                }, "+$".concat(Object(D.q)(Math.round(s.cash[s.level] * s.bonus)))) : null, n.a.createElement("div", {
                                    className: S.a.blookHolder,
                                    style: {
                                        boxShadow: re(s.bonus),
                                        backgroundColor: t ? "#000" : a ? o[3] : null
                                    }
                                }, n.a.createElement(F.a, {
                                    name: s.name,
                                    className: S.a.factoryBlook
                                }), n.a.createElement("div", {
                                    className: S.a.factoryBarHolder,
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[4] : null
                                    }
                                }, n.a.createElement("div", {
                                    className: S.a.factoryBar,
                                    onAnimationIteration: function() {
                                        return e.addCash(s)
                                    },
                                    style: {
                                        backgroundColor: t ? "#fff" : s.color,
                                        animationDuration: "".concat(e.state.slow ? 1.75 * s.time[s.level] : s.time[s.level], "s")
                                    }
                                }))), s.bonus > 1 ? n.a.createElement("div", {
                                    className: S.a.blookBonus,
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[0] : null,
                                        color: t ? "#fff" : null
                                    }
                                }, "x".concat(s.bonus.toFixed(1))) : null, n.a.createElement("div", {
                                    className: S.a.blookDesc,
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[1] : null,
                                        color: t ? "#fff" : null
                                    }
                                }, "".concat(ie[s.level], ": $").concat(Object(D.q)(Math.round(s.cash[s.level] * s.bonus)), " / ").concat(s.time[s.level], "s")), n.a.createElement("div", {
                                    className: S.a.factoryButtonContainer
                                }, 4 !== s.level ? n.a.createElement("div", {
                                    className: S.a.factoryUpgrade,
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[2] : e.state.cash >= s.price[s.level] ? "#4bc22e" : null,
                                        color: t || e.state.cash >= s.price[s.level] ? "#fff" : "#999"
                                    },
                                    role: "button",
                                    tabIndex: "0",
                                    onClick: function() {
                                    ...
                                    className: h()(S.a.upgradeIcon, "fas fa-angle-double-up"),
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }), n.a.createElement("div", {
                                    className: S.a.upgradeText,
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }, "$".concat(Object(D.q)(s.price[s.level])))) : n.a.createElement("div", {
                                    className: S.a.factoryUpgradeMax,
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[3] : null
                                    }
                                }, n.a.createElement("i", {
                                ...
                                }, "MAX")), n.a.createElement("div", {
                                    className: S.a.factoryClass,
                                    id: "class".concat(r),
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[4] : null
                                    }
                                }, e.state.slow ? "⏰" : s.class)))
                            })) : n.a.createElement("div", {
                                className: S.a.nothingText,
                                style: {
                                    color: t ? "#fff" : null
                                }
                            }, "Answer Questions To", n.a.createElement("br", null), "Start Your Factory")))), n.a.createElement("div", {
                                className: S.a.left,
                                id: "left",
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[3] : null
                                }
                            }, this.state.feedback || this.state.choices[0] ? this.state.remind && !this.state.choices[0] ? n.a.createElement("div", {
                                className: this.state.prefeedback ? S.a.questionContainerFaded : S.a.questionContainer
                            }, n.a.createElement("div", {
                                className: S.a.remindText,
                                style: {
                                    color: t ? "#fff" : null
                                }
                            }, "You should probably upgrade a unit"), n.a.createElement("div", {
                                className: S.a.remindButton,
                                tabIndex: 0,
                                role: "button",
                                onClick: function() {
                            ...
                            }, "No, I Want To Lose")) : this.state.feedback ? n.a.createElement("div", {
                                className: this.state.prefeedback ? S.a.feedbackContainerFaded : S.a.feedbackContainer,
                                style: {
                                ...
                                role: "button",
                                tabIndex: "0"
                            }, this.state.choices[0] ? null : n.a.createElement(n.a.Fragment, null, n.a.createElement("div", {
                                className: S.a.feedbackText
                            }, this.state.correct ? "CORRECT" : "INCORRECT"), n.a.createElement("div", {
                                className: S.a.feedbackTextTwo
                            }, n.a.createElement("i", {
                                className: this.state.correct ? "fas fa-check" : "fas fa-times"
                            })), this.state.correct ? null : n.a.createElement("div", {
                                className: S.a.feedbackTextThree
                            }, "Correct ".concat(this.state.question.correctAnswers.length > 1 ? "Answers" : "Answer", ": "), Object(D.c)(this.state.question.correctAnswers, "#fff", 28)), n.a.createElement("div", {
                                className: S.a.feedbackTextNext,
                                style: {
                                    textDecoration: this.state.next ? "underline" : "none"
                                }
                            }, this.state.waiting ? this.state.timer : "Click Anywhere to Go Next"))) : n.a.createElement("div", {
                                style: {
                                    width: "100%",
                                    height: "100%",
                                ...
                                className: S.a.questionTextContainer,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[3] : P.b.default.background
                                }
                            }, this.state.question.audio ? n.a.createElement("div", {
                                className: S.a.imageContainer,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[4] : P.b.default.background
                                }
                            }, n.a.createElement(U.a, {
                                audioUrl: this.state.question.audio,
                                autoplay: !0,
                                width: "80%"
                            })) : this.state.question.image ? n.a.createElement("div", {
                                className: S.a.imageContainer,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[4] : P.b.default.background
                                },
                                ...
                                src: Object(D.d)(this.state.question.image),
                                alt: "Upload",
                                className: S.a.image,
                                draggable: !1
                            })) : this.state.question.text.includes("`*`") ? n.a.createElement("div", {
                                className: h()(S.a.imageContainer, S.a.funcContainer),
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[4] : P.b.default.background
                                }
                            }, n.a.createElement(y.StaticMathField, {
                                className: S.a.qMathField,
                                style: {
                                    color: t ? "#fff" : P.b.default.text,
                                    borderColor: t ? "#fff" : P.b.default.text
                                }
                            }, this.state.question.text.slice(this.state.question.text.indexOf("`*`") + 3, this.state.question.text.length - 3))) : null, n.a.createElement(m.Textfit, {
                                ...
                                max: 38,
                                id: "qText"
                            }, this.state.question.text.includes("`*`") ? this.state.question.text.slice(0, this.state.question.text.indexOf("`*`")) : this.state.question.text)), n.a.createElement("div", {
                                className: S.a.answersHolder
                            }, this.state.question.answers.map((function(s, r) {
                                return n.a.createElement("div", {
                                    className: S.a.answerWrapper,
                                    key: s
                                }, n.a.createElement("div", {
                                    className: S.a.answerContainer,
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[0] : P.b.default.answers[r].background
                                    },
                                    onClick: function() {
                                        return e.onAnswer(s)
                                    },
                                    role: "button",
                                    tabIndex: "0"
                                }, 2 === s.split("`~`").length ? n.a.createElement("div", {
                                    className: S.a.answerImgContainer
                                }, n.a.createElement("img", {
                                    src: Object(D.d)(s.split("`~`")[1]),
                                    alt: "Answer",
                                    className: S.a.answerImg,
                                    draggable: !1
                                })) : "`*`" === s.slice(0, 3) ? n.a.createElement("div", {
                                    className: S.a.answerImgContainer
                                }, n.a.createElement(y.StaticMathField, {
                                    className: S.a.mathField,
                                    style: {
                                        color: P.b.default.answers[r].text,
                                        borderColor: P.b.default.answers[r].text
                                    }
                                }, s.slice(3, s.length - 3))) : n.a.createElement(m.Textfit, {
                            ...
                            })))), this.state.choices[0] ? n.a.createElement("div", {
                                className: S.a.choiceContainer,
                                id: "choices",
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[1] : null
                                }
                            }, n.a.createElement("div", {
                                className: S.a.choiceText,
                                style: {
                                    color: t ? "#fff" : null
                                }
                            }, this.state.deleteFor.name ? "Choose a Blook to Replace >" : "Choose a Blook"), n.a.createElement("div", {
                                className: S.a.blookChoices
                            }, this.state.choices.map((function(s) {
                                return e.state.deleteFor.name && e.state.deleteFor.name !== s.name ? null : "g" === s.class ? n.a.createElement("div", {
                                    key: s.name,
                                    className: S.a.blookChoice,
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[2] : null
                                    },
                                    role: "button",
                                    tabIndex: "0",
                                    onClick: function() {
                                        return e.chooseGlitch(s)
                                    }
                                }, n.a.createElement("i", {
                                    className: h()(S.a.glitchIcon, s.icon),
                                    style: {
                                        color: t ? "#fff" : s.color,
                                        fontSize: "fas fa-grin-tears" === s.icon ? "5.5vw" : null
                                    }
                                }), n.a.createElement("div", {
                                    className: S.a.blookChoiceInfo,
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }, s.name), n.a.createElement("div", {
                                    className: S.a.blookChoiceName,
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }, "Glitch")) : n.a.createElement("div", {
                                    key: s.name,
                                    className: S.a.blookChoice,
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[3] : null
                                    ...
                                    tabIndex: "0",
                                    onClick: function() {
                                        return e.chooseBlook(s)
                                    }
                                }, n.a.createElement(F.a, {
                                    name: s.name,
                                    className: S.a.blookChoiceImage
                                }), n.a.createElement("div", {
                                    className: S.a.blookChoiceInfo,
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }, "$".concat(Object(D.q)(s.cash[0]), " / ").concat(s.time[0], "s")), n.a.createElement("div", {
                                    className: S.a.blookChoiceName,
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }, "".concat(s.name, " ").concat(s.class)))
                            }))), this.state.blooks.length >= 10 ? n.a.createElement("div", {
                                className: S.a.skipButton,
                                role: "button",
                                tabIndex: "0",
                                onClick: function() {
                            ...
                            }, "Skip") : this.state.classes.length > 0 ? n.a.createElement("div", {
                                className: S.a.classHelperText
                            }, "Match Blooks with ".concat(ce(this.state.classes), " for the Class Synergy Bonus!")) : null) : null), this.state.zoomedImage ? n.a.createElement("div", {
                                className: h()(E.a.modal, E.a.modalButton),
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                                    return e.setState({
                                ...
                                src: Object(D.d)(this.state.zoomedImage, !0),
                                alt: "Upload",
                                className: E.a.bigImage,
                                draggable: !1
                            })) : null) : this.state.ready && p.isMobile ? n.a.createElement("div", {
                                className: E.a.regularBody,
                                id: "regularBody",
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[0] : null
                                ...
                                className: S.a.mProgressHolder,
                                id: "mProgress",
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[1] : null
                                }
                            }, this.state.deleteFor.name ? n.a.createElement("div", {
                                className: S.a.mDeleteText,
                                style: {
                                    color: t ? "#fff" : null
                                }
                            }, "Replace a Blook") : n.a.createElement("div", null, n.a.createElement("div", {
                                className: S.a.mProgressContainer,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[2] : null
                                }
                            }, n.a.createElement("div", {
                                className: S.a.mProgressBar,
                                style: {
                                    transform: "translateX(-".concat(100 - this.state.progress / this.state.progressNeeded * 100, "%)"),
                                    backgroundColor: t ? "#fff" : null
                                }
                            })), n.a.createElement("div", {
                                className: S.a.mProgressBox,
                                style: {
                                    backgroundColor: t ? "#fff" : null
                                }
                            }, n.a.createElement("div", {
                                className: S.a.mProgressText,
                                style: {
                                    color: t ? "#000" : a ? o[3] : null
                                }
                            }, this.state.progressNeeded - this.state.progress)))), this.state.showTour && this.state.blooks[0] ? this.state.blooks.map((function(s, r) {
                                return n.a.createElement("div", {
                                    key: e.state.blooks.indexOf(s),
                                    className: h()(e.state.deleteFor.name ? S.a.mFactoryButton : S.a.mFactory),
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[4] : null,
                                    ...
                                    className: S.a.mFactoryFloat,
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }, "+$".concat(Object(D.q)(Math.round(s.cash[s.level] * s.bonus)))) : null, n.a.createElement("div", {
                                    className: S.a.mBlookHolder,
                                    style: {
                                        boxShadow: re(s.bonus),
                                        backgroundColor: t ? "#000" : a ? o[0] : null
                                    }
                                    ...
                                    className: h()(S.a.mUpgradeIcon, "fas fa-angle-double-up"),
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }), n.a.createElement("div", {
                                    className: S.a.mUpgradeText
                                }, "$".concat(Object(D.q)(s.price[s.level])))) : n.a.createElement("div", {
                                    className: S.a.factoryUpgradeMax,
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[0] : null
                                ...
                                className: S.a.mFactories
                            }, this.state.blooks[0] ? n.a.createElement("div", {
                                style: {
                                    height: 15
                                }
                            }) : null, !this.state.showTour && this.state.blooks[0] ? this.state.blooks.map((function(s, r) {
                                return n.a.createElement("div", {
                                    key: e.state.blooks.indexOf(s),
                                    className: h()(e.state.deleteFor.name ? S.a.mFactoryButton : S.a.mFactory),
                                    style: {
                            ...
                            })) : this.state.blooks[0] ? null : n.a.createElement("div", {
                                className: S.a.mNothingText,
                                style: {
                                    color: t ? "#fff" : null
                                }
                            }, "Answer", n.a.createElement("br", null), "Questions", n.a.createElement("br", null), "To Start", n.a.createElement("br", null), "Your Factory")), this.state.blooks[0] ? n.a.createElement("div", {
                                style: {
                                    height: 30
                                }
                            }) : null), !this.state.showQ && this.state.deleteFor.name ? n.a.createElement("div", {
                                className: S.a.mNextQuestion,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[2] : null,
                                    color: t ? "#fff" : null
                                },
                            ...
                            }, "Skip") : this.state.showQ ? null : n.a.createElement("div", {
                                className: S.a.mNextQuestion,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[3] : null,
                                    color: t ? "#fff" : null
                                ...
                                id: "mBottom"
                            }, "Next Question")), this.state.showQ ? n.a.createElement("div", {
                                className: S.a.mQuestion,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[4] : null
                                }
                            }, this.state.feedback || this.state.choices[0] ? this.state.remind && !this.state.choices[0] ? n.a.createElement("div", {
                                className: this.state.prefeedback ? S.a.mQuestionContainerFaded : S.a.mQuestionContainer
                            }, n.a.createElement("div", {
                                className: S.a.remindText,
                                style: {
                                    fontSize: 36,
                            ...
                            }, "OK")) : this.state.feedback ? n.a.createElement("div", {
                                className: this.state.prefeedback ? S.a.mFeedbackContainerFaded : S.a.mFeedbackContainer,
                                style: {
                                ...
                                return n.a.createElement("div", {
                                    ...
                                    className: S.a.mAnswerContainer,
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[0] : P.b.default.answers[r].background
                                    },
                                    onClick: function() {
                                ...
                                className: S.a.mChoiceContainer,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[2] : null
                                }
                            }, n.a.createElement("div", {
                                className: S.a.mChoiceText,
                                style: {
                                    color: t ? "#fff" : null
                                }
                            }, "Choose a Blook"), n.a.createElement("div", {
                                className: S.a.mBlookChoices
                            }, this.state.choices.map((function(s) {
                                return e.state.deleteFor.name && e.state.deleteFor.name !== s.name ? null : "g" === s.class ? n.a.createElement("div", {
                                    key: s.name,
                                    className: S.a.mBlookChoice,
                                    role: "button",
                                    tabIndex: "0",
                                    onClick: function() {
                                        return e.chooseGlitch(s)
                                    ...
                                    className: h()(S.a.mGlitchIcon, s.icon),
                                    style: {
                                        color: t ? "#fff" : s.color,
                                        fontSize: "fas fa-grin-tears" === s.icon ? "14vw" : null
                                    }
                                }), n.a.createElement("div", {
                                    className: S.a.mBlookChoiceInfo,
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }, s.name), n.a.createElement("div", {
                                    className: S.a.mBlookChoiceName,
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                                }, "Glitch")) : n.a.createElement("div", {
                                    ...
                                    name: s.name,
                                    className: S.a.mBlookChoiceImage
                                }), n.a.createElement("div", {
                                    className: S.a.mBlookChoiceInfo,
                                    style: {
                                        color: t ? "#fff" : null
                                ...
                                className: S.a.mClassHelperText
                            }, "Match Blooks with ".concat(ce(this.state.classes), " for the Class Synergy Bonus!")) : null) : null) : null, this.state.zoomedImage ? n.a.createElement("div", {
                                className: h()(E.a.modal, E.a.modalButton),
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                                ...
                                className: E.a.bigImage,
                                draggable: !1
                            })) : null) : null, this.state.glitcherName ? n.a.createElement("div", {
                                className: p.isMobile ? S.a.mGlitcherContainer : S.a.glitcherContainer,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[1] : null
                                }
                            }, n.a.createElement("div", {
                                className: p.isMobile ? S.a.mGlitcherText : S.a.glitcherText,
                                style: {
                                    color: t ? "#fff" : null
                                }
                            }, "Glitch By: ".concat(this.state.glitcherName)), n.a.createElement(F.a, {
                                name: this.state.glitcherBlook,
                                className: p.isMobile ? S.a.mGlitcherBlook : S.a.glitcherBlook
                            })) : null, this.state.glitchMsg ? n.a.createElement(I.a, {
                            ...
                            }) : null, this.state.bites > 0 ? n.a.createElement("div", {
                                className: E.a.modal,
                                role: "button",
                                tabIndex: 0,
                                style: {
                                ...
                                className: h()("fas fa-hamburger", S.a.burger),
                                style: {
                                    opacity: .1 + this.state.bites / 20 * .9,
                                    color: t ? "#fff" : null
                                }
                            }), n.a.createElement("div", {
                                className: S.a.burgerText
                            }, "Click to Eat the Burger")) : null, this.state.ads.reduce((function(e, t) {
                                return e + t
                            }), 0) > 0 ? n.a.createElement(z.a, {
                                ads: this.state.ads,
                                onClick: this.closeAd,
                                night: t,
                                hazards: [a].concat(K(o))
                            }) : null, this.state.lol ? n.a.createElement(q.a, null) : null, this.state.joke ? n.a.createElement(L.a, null) : null, this.state.slow ? n.a.createElement(R.a, {
                                night: t
                            }) : null, this.state.oneMin ? n.a.createElement("div", {
                                className: S.a.minuteModal
                            }, n.a.createElement("div", {
                                className: S.a.modalContainer,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[2] : null
                                }
                            }, n.a.createElement("div", {
                                className: S.a.modalText,
                                style: {
                                    color: t ? "#fff" : null
                                }
                            }, "One Minute Remaining"))) : null), this.state.dance ? n.a.createElement(M.a, {
                                name: this.state.glitcherName,
                                blook: this.state.glitcherBlook
                            }) : null, this.state.askTour ? n.a.createElement(I.a, {
                            ...
                            }) : this.state.popUpAmount > 0 && !this.state.showTour ? n.a.createElement(I.a, {
                                text: "Cash" === this.state.popUpType ? "Your goal is to make $".concat(Object(D.j)(this.state.popUpAmount), "!") : "Your goal is to make as much money as you can in ".concat(this.state.popUpAmount, " ").concat(1 === this.state.popUpAmount ? "minute" : "minutes", "!"),
                                buttonOne: {
                                    text: "OK",
                                    click: function() {
                                        return e.setState({
                    ...
                    }]) && ee(t.prototype, a), o && ee(t, o), Object.defineProperty(t, "prototype", {
                        writable: !1
                    }), l
                }(n.a.Component);
            ue.propTypes = {
