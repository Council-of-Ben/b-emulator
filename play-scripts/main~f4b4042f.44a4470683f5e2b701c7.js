    ...
    [20], {
        "0fI1": function(e, t, n) {
                            ...
                            return new t((function(a, s) {
                                ! function a(o, r, s, i) {
                                    ...
                                    if ("throw" !== c.type) {
                                        var u = c.arg,
                                            p = u.value;
                                        return p && "object" == P(p) && n.call(p, "__await") ? t.resolve(p.__await).then((function(e) {
                                            a("next", e, s, i)
                                        }), (function(e) {
                                            a("throw", e, s, i)
            ...
            var Z = function(e) {
                ...
                function p(e) {
                    ...
                    return function(e, t) {
                        ...
                        newIndex: -1,
                        chooseMap: !1
                    }, t.redirect = !1, t.name = "", t.working = !0, t.here = !0, t.loadGame = t.loadGame.bind(U(t)), t.newGame = t.newGame.bind(U(t)), t.endGame = t.endGame.bind(U(t)), t
                }
                return t = p, (n = [{
                            ...
                            for (;;) switch (e.prev = e.next) {
                                ...
                                case 3:
                                    (t = e.sent) ? (this.name = t.name, this.setState({
                                        loggedIn: !0
                                    }), this.working = !1, N.a.get("/api/defenses/byuser").then((function(e) {
                                        n.here && n.setState({
                    ...
                    value: (s = z(R().mark((function e(t) {
                        ...
                        return R().wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                ...
                                case 15:
                                    return e.next = 17, new Promise((function(e) {
                                        N.a.get("/api/homeworks/byid", {
                                            ...
                                            r.state.noId ? o = !0 : a = r.state.questions, Object(d.b)(t), e()
                                        }))
                                    }));
                                case 17:
                                    if (!o) {
                                ...
                                case 21:
                                    n.hwName && this.props.addClientName(n.hwName), this.props.setDefense(A(A({}, this.props.defense), {}, {
                                        defenseId: n._id,
                                        setId: n.setId,
                                        resultId: n.resultId,
                                        hwId: n.hwId,
                        ...
                        return R().wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                ...
                                case 11:
                                    a = e.sent;
                                case 12:
                                    this.props.setDefense(A(A({}, this.props.defense), {}, {
                    ...
                    value: function(e) {
                        ...
                        var r = Math.max(1, 30 - (e.round - 1)),
                            s = Object(E.m)(j.b);
                        N.a.put("/api/users/defensestats/solo", {
                            name: this.name,
                            place: r,
                            round: e.round,
                            blookUsed: s,
                    ...
                    value: function() {
                        ...
                        return this.props.client && this.props.client.hwId ? this.redirect = !1 : this.state.notLoggedIn && (this.redirect = !0), this.redirect || this.state.ready && (!this.state.questions || 0 === this.state.questions.length) && !this.state.noId ? o.a.createElement(l.a, {
                            ...
                            className: f()(u.isMobile ? g.a.mBody : g.a.body, v.a.background),
                            style: {
                            ...
                            className: v.a.savesHeader
                        }, this.state.loading ? "Choose a Save" : "Choose a Save Slot"), o.a.createElement("div", {
                            className: v.a.savesHolder
                        }, this.state.savesArray.map((function(t, n) {
                            return t ? o.a.createElement("div", {
                                className: v.a.saveContainer,
                                key: t._id
                            }, o.a.createElement("div", {
                                className: v.a.saveTitle
                            }, "Round ".concat(t.round)), o.a.createElement("div", {
                                className: v.a.saveRow
                            }, "".concat(Object(E.l)(t.tokens)), o.a.createElement("i", {
                                className: f()(v.a.saveIcon, "fas fa-coins")
                            })), o.a.createElement("div", {
                                className: v.a.saveRow
                            }, T.a[t.map].name, o.a.createElement("i", {
                                className: f()(v.a.saveIcon, "fas fa-map")
                            })), o.a.createElement("div", {
                                className: v.a.saveRow
                            }, t.hwName || "Not Homework", o.a.createElement("i", {
                                className: f()(v.a.saveIcon, "fas fa-file-alt")
                            })), o.a.createElement("div", {
                                className: v.a.saveRow
                            }, o.a.createElement("div", {
                                className: v.a.saveHealthHolder
                            }, o.a.createElement("div", {
                                className: v.a.saveHealthBar,
                                style: {
                                    transform: "scaleX(".concat(t.health / 100, ")")
                                }
                            })), o.a.createElement("i", {
                                className: f()(v.a.saveIcon, "fas fa-heart")
                            })), o.a.createElement("div", {
                                className: v.a.loadButton,
                                role: "button",
                                tabIndex: 0,
                            ...
                            className: v.a.mapContainer
                        }, o.a.createElement("div", {
                            className: v.a.mapHeader
                        }, "Choose a Map:"), o.a.createElement("div", {
                            className: v.a.mapRow
                        }, Object.entries(T.a).map((function(t) {
                            var n = B(t, 2),
                                a = n[0],
                                r = n[1];
                            return o.a.createElement("div", {
                                className: v.a.mapButton,
                                key: a,
                                role: "button",
                                tabIndex: 0,
                                ...
                                src: r.img,
                                alt: r.name,
                                className: v.a.mapImg,
                                draggable: !1
                            }), r.locked ? o.a.createElement("div", {
                                className: v.a.lockedMap
                            }, o.a.createElement("i", {
            ...
            Z.propTypes = {
                ...
                id: c.a.string,
                setDefense: c.a.func.isRequired,
                addClientName: c.a.func.isRequired,
                user: c.a.object
            };
            t.a = Object(k.c)(Object(l.g)(Object(s.b)((function(e) {
                return {
                    id: e.hosts.id,
                        ...
                        value: function() {
                            ...
                            if (this.props.host && this.props.host.settings) {
                                var t = function(e) {
                                    ...
                                    for (var c = n / s, l = Math.ceil(o), u = Math.ceil(e / l); l < u * a;) l += 1, u = Math.ceil(e / l);
                                    var p = t / l;
                                    return Math.max(c, p, 80)
