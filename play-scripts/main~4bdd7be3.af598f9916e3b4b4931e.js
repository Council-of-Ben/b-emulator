    ...
    [5], {
                    ...
                    return t = c, (n = [{
                        ...
                        value: function() {
                            ...
                            return o.a.createElement("div", {
                                ...
                                style: {
                                    backgroundImage: "url(".concat(j.a.basic.blookCheckers, ")")
                                }
        ...
        oQpA: function(e, t, n) {
            ...
            var H = function(e) {
                ...
                return t = c, (n = [{
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        this.msg.onend = function() {}, window.speechSynthesis.cancel(), Object(j.r)(), clearTimeout(this.nextTimeout), clearTimeout(this.nextReadyTimeout), clearTimeout(this.waitTimeout), clearTimeout(this.claimTimeout), clearTimeout(this.pickingTimeout), this.here = !1, Object.keys(this.dbRefStage).length && this.dbRefStage.off("value"), Object.keys(this.dbRefMe).length && this.dbRefMe.off("value")
                    }
                }, {
                    key: "onAnswer",
                    value: function(e) {
        ...
        tmkA: function(e, t, n) {
            ...
            var q = function(e) {
                    ...
                    }, Object(x.s)(e.numBlooks)), o.a.createElement(w.a, {
                        name: e.blook,
                    ...
                    return t = s, (n = [{
                        ...
                        value: function() {
                            return this.props.client && this.props.client.standing && this.props.client.standing[0] ? o.a.createElement("div", {
                                ...
                                myStat: "".concat(Object(x.l)(this.state.me.numBlooks), " ").concat(1 === this.state.me.numBlooks ? "Blook" : "Blooks"),
