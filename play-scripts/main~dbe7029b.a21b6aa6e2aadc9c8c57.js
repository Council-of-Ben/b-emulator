            ...
            var R = function(t) {
                ...
                function c(t) {
                    ...
                    return function(t, e) {
                        ...
                        timer: 10,
                        readId: ""
                    }, e.dbRef = {}, e.startTime = 0, e.msg = {}, e.isReading = !1, e.onAnswer = e.onAnswer.bind(q(e)), e.readQuestion = e.readQuestion.bind(q(e)), e
                }
                return e = c, (n = [{
                    key: "componentDidMount",
                    value: (a = P(j().mark((function t() {
                        var e, n = this;
                        return j().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    return Object(O.a)(), t.next = 5, this.props.firebase.getDatabaseRef(this.props.client.hostId, "stg");
                                case 5:
                    ...
                    value: function() {
                        this.msg.onend = function() {}, window.speechSynthesis.cancel(), Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(O.r)(), clearInterval(this.interval), clearTimeout(this.readyTimeout)
                    }
                }, {
                    key: "onAnswer",
                    value: function(t) {
                ...
                N = function(t) {
                    ...
                    function a(t) {
                        ...
                        return function(t, e) {
                            ...
                            points: 0,
                            isBlocked: !1
                        }, e.saveStats = e.saveStats.bind(q(e)), e
                    }
                    return e = a, (n = [{
                        key: "componentDidMount",
                        value: function() {
                        ...
                        key: "saveStats",
                        value: function(t, e) {
                            O.a.put("/api/users/classicstats", {
                                name: t,
                        ...
                        value: function() {
                            return this.props.client && this.props.client.standing && this.props.client.standing[0] ? o.a.createElement("div", {
                                ...
                                myStat: "".concat(Object(w.l)(this.state.points), " ").concat(1 === this.state.points ? "Point" : "Points"),
                    ...
                    value: function() {
                        ...
                        this.setState({
                            ...
                            t.transitionTimeout = setTimeout((function() {
                                ...
                                })), t.props.setClassicResults(t.state.numClients, r), t.props.firebase.setVal({
                                    id: t.props.host.id,
                                    path: "c",
                                    val: e
                                }, (function() {
                    ...
                    value: function() {
                        ...
                        if (this.props.host && this.props.host.standings && this.props.host.question) return o.a.createElement("div", {
                            ...
                            return o.a.createElement("div", {
                                ...
                                }, t.state.showPoints ? Object(E.l)(r.points) : r.correct ? "".concat((r.time / 1e3).toFixed(3), "s") : o.a.createElement("i", {
        ...
        bwEY: function(t, e, n) {
            ...
            var L = function(t) {
                ...
                return e = c, (n = [{
                        ...
                        return E().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    return t.abrupt("return");
                                case 2:
                                    return Object(x.a)(), t.next = 5, this.props.firebase.getDatabaseRef(this.props.client.hostId, "stg");
                                case 5:
                                    this.dbRef = t.sent, this.dbRef.on("value", (function(t) {
                                        switch (t.val()) {
                                            case "cres":
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(x.r)(), clearTimeout(this.timeout)
                    }
                }, {
                    key: "render",
                    value: function() {
                        return this.props.client ? o.a.createElement("div", {
                            ...
                            className: f()(b.a.bottomTipText, (t = {}, e = w.a.textFade, n = this.state.transitioning, e in t ? Object.defineProperty(t, e, {
                                value: n,
                                enumerable: !0,
                                configurable: !0,
                                writable: !0
                            ...
                            className: this.state.transitioning ? w.a.fade : w.a.fadeWaiting
                        }))) : o.a.createElement(u.a, {
                            to: "/play"
                        });
                        var t, e, n
        ...
        eWHQ: function(t, e, n) {
            ...
            var G = function(t) {
                ...
                return e = c, (n = [{
                        ...
                        return S().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    return t.abrupt("return");
                                case 2:
                                    return Object(P.a)(), t.next = 5, this.props.firebase.getDatabaseRef(this.props.client.hostId, "stg");
                                case 5:
                                    if (this.dbRef = t.sent, this.dbRef.on("value", (function(t) {
                                            ...
                                            if (e)
                                                if (3 === e.split("-").length) {
                                                    ...
                                                    if (r < 0) return;
                                                    for (var o = JSON.parse(JSON.stringify(a.props.client.questions[r])), i = R(o.answers), s = n[2].split(""), c = 0; c < i.length; c++) o.answers[s[c]] = i[c];
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(P.r)(), clearTimeout(this.pointsTimeout), clearTimeout(this.moveTimeout), clearTimeout(this.exitTimeout), clearTimeout(this.transitionTimeout), clearInterval(this.interval)
                    }
                }, {
                    key: "render",
                    value: function() {
                        ...
                        return this.props.client && this.props.client.name ? o.a.createElement("div", {
                            className: y.isMobile ? O.a.mBody : O.a.body,
                            style: {
                                backgroundColor: "#0bc2cf"
                            }
                        }, o.a.createElement(w.a, {
                            ...
                            return o.a.createElement("div", {
                                ...
                                return o.a.createElement("div", {
                                ...
                                }, Object(P.e)(t.state.move ? r.place : r.questionPlace)), o.a.createElement(E.a, {
                                    name: r.blook,
                                    ...
                                    className: m()(j.a.pointsText, L({}, j.a.fadeIn, t.state.showPoints), L({}, j.a.fadeOut, t.state.preShowPoints && !t.state.showPoints))
                                }, t.state.showPoints ? Object(P.l)(r.points) : r.correct ? "".concat((r.time / 1e3).toFixed(3), "s") : o.a.createElement("i", {
                                    className: "fas fa-times"
                                })), o.a.createElement("div", {
        ...
        glmF: function(t, e, n) {
            ...
            var C = function(t) {
                ...
                return e = c, (n = [{
                        ...
                        return _().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    return t.abrupt("return");
                                case 2:
                                    return Object(g.a)(), t.next = 5, this.props.firebase.getDatabaseRef(this.props.client.hostId, "stg");
                                case 5:
                                    this.dbRef = t.sent, this.dbRef.on("value", (function(t) {
                                        var n = t.val();
                                        if (n)
                                            if (3 === n.split("-").length) {
                                                ...
                                                if (o < 0) return;
                                                for (var i = JSON.parse(JSON.stringify(e.props.client.questions[o])), a = O(i.answers), s = r[2].split(""), c = 0; c < a.length; c++) i.answers[s[c]] = a[c];
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(g.r)()
                    }
                }, {
                    key: "render",
                    value: function() {
                        ...
                        }, o.a.createElement(v.a, null))) : o.a.createElement(u.a, {
                            to: "/play"
                        })
                    }
                        ...
                        if (this.props.host && this.props.host.standings && this.props.host.standings[0] || this.state.standings && this.state.standings[0]) {
                            ...
                            this.setState({
                                ...
                                t.startTimeout = setTimeout((function() {
                                    var n = {};
                                    t.props.firebase.getDatabaseVal(e.id, "c", (function(r) {
                                        var o = r || {};
                    ...
                    value: function() {
                        if (this.props.host && this.props.host.standings && this.props.host.standings[0] || this.state.standings && this.state.standings[0]) return o.a.createElement("div", {
                            ...
                            stats: this.state.standings.map((function(t) {
                                return "".concat(Object(m.l)(t.points), " ").concat(1 === t.points ? "Point" : "Points")
                            })),
        ...
        xsDw: function(t, e, n) {
            ...
            var D = function(t) {
                ...
                return e = c, (n = [{
                        ...
                        return P().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    return t.abrupt("return");
                                case 2:
                                    return Object(j.a)(), t.next = 5, this.props.firebase.getDatabaseRef(this.props.client.hostId, "stg");
                                case 5:
                                    this.dbRef = t.sent, this.dbRef.on("value", (function(t) {
                                        var n = t.val();
                                        if (n)
                                            if (3 === n.split("-").length) {
                                                ...
                                                if (o < 0) return;
                                                for (var i = JSON.parse(JSON.stringify(e.props.client.questions[o])), a = q(i.answers), s = r[2].split(""), c = 0; c < a.length; c++) i.answers[s[c]] = a[c];
                                                e.props.getQuestion(i), e.props.history.push("/play/classic/question")
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        this.here = !1, Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(j.r)(), clearTimeout(this.readyTimeout), clearTimeout(this.setTimeout), clearTimeout(this.waitTimeout), clearInterval(this.pointsInterval)
                    }
                }, {
                    key: "render",
                    value: function() {
                        return this.props.client ? o.a.createElement("div", {
                            ...
                            className: f()(w.a.regularBody, O.a.background),
                            style: {
                            ...
                            className: O.a.correctAnswers
                        }, "".concat(this.state.place).concat(Object(j.e)(this.state.place), " Place")), o.a.createElement("div", {
                            className: O.a.pointsText
                        }, "+".concat(this.state.points, " Points"))) : o.a.createElement(o.a.Fragment, null, o.a.createElement("div", {
                            className: O.a.correctAnswers
                        }, "Correct ".concat(1 === this.state.correctAnswers.length ? "Answer" : "Answers", ": "), Object(j.c)(this.state.correctAnswers, "#fff", 28)), o.a.createElement("div", {
                            className: O.a.pointsText
