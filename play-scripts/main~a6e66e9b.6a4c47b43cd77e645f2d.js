            ...
            var N = ["Way to Go!", "Nice Work!", "Good Job!", "Keep It Up!", "Well Done!", "Rock On!", "Awesome Sauce!", "Let's Go!"],
                ...
                B = function(t) {
                    ...
                    return e = c, (r = [{
                                ...
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 7:
                                        ...
                                        return this.setState({
                                            deadHeader: this.props.client.defeated > 0 ? Object(_.m)(N) : Object(_.m)(G)
                                        }), t.abrupt("return");
                                    case 12:
                        ...
                        value: function() {
                            clearTimeout(this.decreaseTimeout), Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(_.r)()
                        }
                    }, {
                        key: "render",
                        value: function() {
        ...
        "6L5a": function(t, e, r) {
            ...
            var A = function(t) {
                ...
                return e = c, (r = [{
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(k.r)()
                    }
                }, {
                    key: "render",
                    value: function() {
        ...
        A0wD: function(t, e, r) {
            ...
            var G = function(t) {
                ...
                return e = c, (r = [{
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(E.r)(), clearTimeout(this.timeout), clearTimeout(this.transitionTimeout), clearTimeout(this.readyTimeout)
                    }
                }, {
                    key: "render",
                    value: function() {
        ...
        "RX+X": function(t, e, r) {
            ...
            var I = function(t) {
                ...
                return e = c, (r = [{
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        this.here = !1, clearInterval(this.timerInterval), Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(x.r)()
                    }
                }, {
                    key: "render",
                    value: function() {
        ...
        YoTu: function(t, e, r) {
            ...
            var q = function(t) {
                ...
                return e = c, (r = [{
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        this.msg.onend = function() {}, window.speechSynthesis.cancel(), clearTimeout(this.readyTimeout), clearInterval(this.interval), Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(j.r)()
                    }
                }, {
                    key: "onAnswer",
                    value: function(t) {
            ...
            var Y = function(t) {
                ...
                function c(t) {
                    ...
                    return function(t, e) {
                        ...
                        showInstructions: !0,
                        readId: ""
                    }, e.dbRefStage = {}, e.dbRefMe = {}, e.dbRefAction = {}, e.questions = [], e.freeQuestions = [], e.corrects = {}, e.incorrects = {}, e.here = !0, e.waiting = !1, e.powerUpCd = 4, e.shield = !1, e.hotCounter = 0, e.msg = {}, e.isReading = !1, e.onAnswer = e.onAnswer.bind(V(e)), e.getQuestion = e.getQuestion.bind(V(e)), e.getPowerUp = e.getPowerUp.bind(V(e)), e.choosePowerUp = e.choosePowerUp.bind(V(e)), e.usePowerUp = e.usePowerUp.bind(V(e)), e.answerNext = e.answerNext.bind(V(e)), e.readQuestion = e.readQuestion.bind(V(e)), e
                }
                return e = c, (r = [{
                    key: "componentDidMount",
                    ...
                    value: function() {
                        ...
                        this.here && (this.setState({
                            phase: "powerup",
                            powerUpDisplay: Object(A.m)(Object.values(S)),
                            isChosen: !1
                        }, (function() {
                            t.powerUpInterval = setInterval((function() {
                                t.here && t.setState({
                                    powerUpDisplay: Object(A.m)(Object.values(S).filter((function(e) {
