    ...
    [6], {
        ...
        VmLb: function(e, t, s) {
            ...
            var q = function(e, t) {
                    ...
                    }, Object(O.s)(e.dmg), a.a.createElement("i", {
                        className: d()(g.a.stageIcon, "fas fa-splotch")
                ...
                G = function(e) {
                    ...
                    return t = l, (s = [{
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 6:
                                        if (this.isSolo = !this.props.defense.isLive, this.isHw = Boolean(this.props.defense.resultId), this.isSolo || this.isHw || this.props.firebase.setVal({
                                                ...
                                                val: {
                                                    c: N({}, this.props.defense.corrects),
                                                    i: N({}, this.props.defense.incorrects)
                                                }
                                                ...
                                                i += e
                                            })), a = this.props.client && this.props.client.blook ? this.props.client.blook : Object(O.m)(S.b), o = this.props.client && this.props.client.name ? this.props.client.name : "You", (n = this.props.client && this.props.client.standing ? JSON.parse(JSON.stringify(this.props.client.standing)) : [{
                                                name: o,
                                                blook: a,
                                    ...
                                    case 22:
                                        l = n[r].place, this.stats = {
                                            ...
                                            Object(p.b)(e)
                                        })), this.props.defense.defenseId && E.a.delete("/api/defenses", {
                                            params: {
                                                name: t.name,
                        ...
                        key: "saveStats",
                        value: function(e, t) {
                            this.isSolo ? E.a.put("/api/users/defensestats/solo", {
                                name: e,
                                ...
                                return Object(p.b)(e)
                            })) : E.a.put("/api/users/defensestats/live", {
                                name: e,
                                place: this.stats.place,
                                round: this.stats.round,
                                dmg: this.stats.dmg,
                        ...
                        value: function() {
                            return a.a.createElement(k.a, {
                                title: "Damage",
                                stat: Object(O.l)(this.state.dmg)
                            })
                        }
                    }, {
                        key: "render",
                        value: function() {
                            if (this.props.defense && (this.props.defense.hwId || this.props.defense && this.props.defense.isLive) ? this.redirect = !1 : this.state.notLoggedIn && (this.redirect = !0), this.redirect || !this.props.defense || "final" !== this.props.defense.stage || !this.props.defense.questions || !this.props.defense.questions[0]) return a.a.createElement(c.a, {
                                to: "/play"
                            });
                            ...
                            return a.a.createElement("div", {
                                ...
                                rightLink: "/play"
                            }), this.state.ready ? this.state.isLive ? a.a.createElement(x.a, {
                    ...
                    }]) && I(t.prototype, s), i && I(t, i), Object.defineProperty(t, "prototype", {
                        writable: !1
                    }), l
                }(a.a.Component);
            G.propTypes = {
            ...
            t.a = Object(_.c)(Object(c.g)(Object(n.b)((function(e) {
                return {
        ...
        vkpZ: function(e, t, s) {
                                                    ...
                                                    for (;;) switch (e.prev = e.next) {
                                                        case 0:
                                                            ...
                                                            return s = 0, t.dmgInterval = setInterval((function() {
                                                                t.setState({
                                                                    totalDmg: t.dmg
                                                                }), t.notified ? t.notified = !1 : (s += 1) >= 5 && (s = 0, t.props.firebase.setVal({
            ...
            t.a = Object(E.c)(Object(c.g)(Object(o.b)((function(e) {
                return {
                    id: e.hosts.id,
                    client: e.clients.client,
                    defense: e.clients.client ? e.clients.client.defense : null
