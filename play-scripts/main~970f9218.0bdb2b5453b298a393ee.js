    ...
    [9], {
                            ...
                            return new t((function(r, c) {
                                ! function r(a, o, c, i) {
                                    ...
                                    if ("throw" !== s.type) {
                                        var p = s.arg,
                                            f = p.value;
                                        return f && "object" == u(f) && n.call(f, "__await") ? t.resolve(f.__await).then((function(e) {
                                            r("next", e, c, i)
                                        }), (function(e) {
                                            r("throw", e, c, i)
            ...
            var O = window.FirebaseApiDetails = {
                ...
                j = function() {
                    function e() {
                        ...
                        }(this, e), this._isHost = !1, this._liveGameCode = null, this._liveShardIdx = null, this._liveApp = null
                    }
                    var t, n, a, o, u, p, f, d, b, y, v, E, j, k, S;
                    return t = e, n = [{
                        key: "getDatabaseVal",
                        value: (S = V(g().mark((function e(t, n) {
                            var r, a;
                        ...
                        key: "setStage",
                        value: (y = V(g().mark((function e(t, n) {
                            var r, a, o;
                            return g().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                    ...
                                    case 6:
                                        return e.abrupt("return", new Promise((function(e, r) {
                                            ...
                                            i.a.post("/c/firebase/hosted-games", a).then(function() {
                                                var t = V(g().mark((function t(o) {
                                                    ...
                                                    return g().wrap((function(t) {
                                                        for (;;) switch (t.prev = t.next) {
                                                            ...
                                                            case 3:
                                                                return c = o.data, t.next = 6, n._setLiveGameCode(c.id, c.fbToken);
                                                            case 6:
                                                ...
                                                n._setLiveGameCode(null, null, !0), Object(c.b)("error attempting to host a game", e), r(e)
                                            }))
                                        })));
                                    case 7:
                                    case "end":
                        ...
                        value: (p = V(g().mark((function e(t, n) {
                            ...
                            return g().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 10:
                                        if (a = e.sent, o = a.data, c = "", u = null, !o.success) {
                                            e.next = 32;
                                            break
                                        }
                                        return e.next = 17, this._setLiveGameCode(t, o.fbToken);
                                    case 17:
                                        return e.next = 19, this._liveApp.database().ref(this._liveGameCode).once("value");
                                    case 19:
                                        return p = e.sent, u = p.val(), f = {}, Object.entries(u.c || {}).filter((function(e) {
                                            return A(e, 1)[0] !== n
                                        })).forEach((function(e) {
                                            var t = A(e, 2)[1];
                                            f[t.b] = !0
                                            ...
                                            f[e] || h.push(e)
                                        })), 0 === h.length && h.push.apply(h, m(s.b)), c = Object(l.m)(h), e.next = 30, this._setClient(n, c);
                                    case 30:
                                        e.next = 34;
                                        break;
                                    case 32:
                                        return e.next = 34, this._setLiveGameCode(null, null, !0);
                                    case 34:
                        ...
                        value: (u = V(g().mark((function e(t, n, a) {
                            var o, i;
                            return g().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        if (this._isHost = !1, this._liveGameCode = null, this._liveShardIdx = null, !this._liveApp) {
                                            e.next = 7;
                                            break
                                        }
                                    ...
                                    case 13:
                                        return this._liveGameCode = t, this._liveShardIdx = (s = t) < 1249999 ? 0 : s < 1499999 ? 1 : s < 1749999 ? 2 : s < 1999999 ? 3 : s < 2249999 ? 4 : s < 2499999 ? 5 : s < 2749999 ? 6 : s < 2999999 ? 7 : s < 3249999 ? 8 : s < 3499999 ? 9 : s < 3749999 ? 10 : s < 3999999 ? 11 : s < 4249999 ? 12 : s < 4499999 ? 13 : s < 4749999 ? 14 : s < 4999999 ? 15 : s < 5249999 ? 16 : s < 5499999 ? 17 : s < 5749999 ? 18 : s < 5999999 ? 19 : s < 6249999 ? 20 : s < 6499999 ? 21 : s < 6749999 ? 22 : s < 6999999 ? 23 : s < 7249999 ? 24 : s < 7499999 ? 25 : s < 7749999 ? 26 : s < 7999999 ? 27 : s < 8249999 ? 28 : s < 8499999 ? 29 : s < 8749999 ? 30 : s < 8999999 ? 31 : s < 9249999 ? 32 : s < 9499999 ? 33 : s < 9749999 ? 34 : 35, this._liveApp = r.a.initializeApp(h(h({}, O), {}, {
                                            databaseURL: x[this._liveShardIdx]
                                        })), o = r.a.auth(this._liveApp), e.next = 19, o.setPersistence(r.a.auth.Auth.Persistence.SESSION).catch((function(e) {
                                            Object(c.b)(e, {
                                                while: "setting session persistence in _setLiveGameCode"
                                            })
                                        }));
                                    case 19:
                                        return e.next = 21, o.signInWithCustomToken(n).catch((function(e) {
                                            Object(c.b)(e, {
        ...
        tjUo: function(e, t, n) {
            ...
            var Se = n("8eya"),
                ...
                kn = n("OYaq");
            l.a.logConsoleSuspensionWarning(), jn.a.get("/api/config").then((function(e) {
                var t = e.data.securityBase;
                l.a.securityBaseURL = t
            }));
            var Sn, In, Pn, Dn, Ln = (In = [je, d()()], Pn = [f.a.apply(void 0, In), ke()], (Dn = Object(f.e)(ve, Sn, f.d.apply(void 0, Pn))).runSaga = je.run(Ee), Dn);
            c.a.render(a.a.createElement(u.a, null, a.a.createElement(i.a, {
                store: Ln
