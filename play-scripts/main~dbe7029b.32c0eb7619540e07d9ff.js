        ...
        Dhu9: function(t, e, n) {
            ...
            var N = function(t) {
                ...
                return e = c, (n = [{
                    ...
                    value: function() {
                        this.msg.onend = function() {}, window.speechSynthesis.cancel(), Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(x.r)(), clearInterval(this.interval), clearTimeout(this.readyTimeout)
                    }
                }, {
                    key: "onAnswer",
                    value: function(t) {
                    ...
                    return e = a, (n = [{
                        ...
                        value: function() {
                            return this.props.client && this.props.client.standing && this.props.client.standing[0] ? o.a.createElement("div", {
                                ...
                                myStat: "".concat(Object(_.l)(this.state.points), " ").concat(1 === this.state.points ? "Point" : "Points"),
        ...
        bwEY: function(t, e, n) {
            ...
            var R = function(t) {
                ...
                return e = c, (n = [{
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(j.r)(), clearTimeout(this.timeout)
                    }
                }, {
                    key: "render",
                    value: function() {
        ...
        eWHQ: function(t, e, n) {
            ...
            var W = function(t) {
                ...
                return e = c, (n = [{
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(T.r)(), clearTimeout(this.pointsTimeout), clearTimeout(this.moveTimeout), clearTimeout(this.exitTimeout), clearTimeout(this.transitionTimeout), clearInterval(this.interval)
                    }
                }, {
                    key: "render",
                    value: function() {
                        ...
                        return this.props.client && this.props.client.name ? o.a.createElement("div", {
                            ...
                            return o.a.createElement("div", {
                                ...
                                }, t.state.showPoints ? Object(T.l)(r.points) : r.correct ? "".concat((r.time / 1e3).toFixed(3), "s") : o.a.createElement("i", {
                                    className: "fas fa-times"
                                })), o.a.createElement("div", {
        ...
        glmF: function(t, e, n) {
            ...
            var q = function(t) {
                ...
                return e = c, (n = [{
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(w.r)()
                    }
                }, {
                    key: "render",
                    value: function() {
        ...
        xsDw: function(t, e, n) {
            ...
            var D = function(t) {
                ...
                return e = c, (n = [{
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        this.here = !1, Object.keys(this.dbRef).length && this.dbRef.off("value"), Object(E.r)(), clearTimeout(this.readyTimeout), clearTimeout(this.setTimeout), clearTimeout(this.waitTimeout), clearInterval(this.pointsInterval)
                    }
                }, {
                    key: "render",
                    value: function() {
