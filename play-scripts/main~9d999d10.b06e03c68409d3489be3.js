            ...
            var D = [{
                ...
                Q = function(e) {
                    ...
                    return t = l, (a = [{
                                    ...
                                    case 9:
                                        this.dbRefMe = e.sent, this.dbRefMe.on("value", (function(e) {
                                            if (e.val()) {
                                                ...
                                                t.setState({
                                                    attackerMsg: "".concat(a[0], " just ").concat("swap" === a[2] ? "swapped gold with you!" : "took ".concat(Object(j.j)(a[2]), " gold from you!")),
                                                    attackerBlook: a[1],
                                                    gold: s,
                                                    gold2: n
                                                }), t.props.liveGameController.setVal({
                        ...
                        key: "componentWillUnmount",
                        value: function() {
                            this.msg.onend = function() {}, window.speechSynthesis.cancel(), Object(j.p)(), clearTimeout(this.timeout), clearTimeout(this.waitTimeout), clearTimeout(this.claimTimeout), this.here = !1, Object.keys(this.dbRefStage).length && this.dbRefStage.off("value"), Object.keys(this.dbRefMe).length && this.dbRefMe.off("value")
                        }
                    }, {
                        key: "onAnswer",
                        value: function(e) {
                        ...
                        value: function() {
                            ...
                            return this.props.client && this.props.client.questions && this.props.client.questions[0] ? n.a.createElement("div", {
                                ...
                                }, Object(j.j)(t.gold)), n.a.createElement("img", {
                                    src: T.a.basic.candy,
                                    alt: "Candy",
                    ...
                    return t = r, (a = [{
                        ...
                        value: function() {
                            return this.props.client && this.props.client.standing && this.props.client.standing[0] ? n.a.createElement("div", {
                                ...
                                username: this.props.client.username,
                                plus: this.props.client.plus,
                                myStat: "".concat(Object(w.j)(this.state.me.gold), " ").concat(O.a ? "Candy" : "Gold"),
                                saveStats: this.saveStats,
                                ...
                                r.forEach((function(e) {
                                    if (e.toAttack) {
                                        ...
                                        if ("swap" === a[1]) {
                                            ...
                                            }), r[s].gold = Math.max((n.gold || 0) - a[1], 0), t.addAlert(e.name, e.blook, "just took ".concat(Object(B.j)(a[1]), " ").concat(A.a ? "candy" : "gold", " from ").concat(n.name))
                                        }
                ...
                return t = r, (a = [{
                    ...
                    value: function() {
                        if (this.props.host && this.props.host.standings && this.props.host.standings[0] || this.state.standings && this.state.standings[0]) return n.a.createElement("div", {
                            ...
                            standings: this.state.standings,
                            stats: this.state.standings.map((function(e) {
                                return "".concat(Object(g.j)(e.gold), " ").concat(x.a ? "Candy" : "Gold")
                            })),
                            gameId: this.props.gameId,
                            historyId: this.state.historyId,
                            muted: this.state.muted,
