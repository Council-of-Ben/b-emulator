            ...
            var n = r("q1tI"),
                ...
                E = function() {
                    ...
                    return e.forEach((function(e) {
                        var r = e.blook ? k[Object(T.a)(e.blook)] : k[x.a[e].rarity];
                        t.push({
                            card: e,
                            price: Object(C.o)(r[0], r[1])
                        })
                    })), t
                },
                S = r("Truy"),
            ...
            var Q = function(e) {
                ...
                return t = c, (r = [{
                    ...
                    value: function() {
                        ...
                        }, [].concat(R(this.state.artifacts), R(this.state.cards)).map((function(t, r) {
                            return o.a.createElement("div", {
                        ...
                        }))) : null, this.state.noBuy ? o.a.createElement(j.a, {
                        ...
                        }) : this.state.buyPrice ? o.a.createElement(j.a, {
            ...
            var Y = function(e) {
                ...
                return t = c, (r = [{
                    ...
                    value: function() {
                        ...
                        var t = Object(k.m)(this.freeQuestions);
                        this.freeQuestions.splice(this.freeQuestions.indexOf(t), 1), t.random && (t.answers = Object(k.t)(t.answers)), this.setState({
                            question: t,
                            phase: "question"
                        }, (function() {
            ...
            var I = function(e) {
                ...
                function c(e) {
                    ...
                    return function(e, t) {
                        ...
                        wins: 0
                    }, t.endGame = t.endGame.bind(j(t)), t
                }
                return t = c, (r = [{
                    key: "componentDidMount",
                    ...
                    value: function() {
                        ...
                        }, "You are the ".concat(Object(v.l)(this.state.wins)).concat(Object(v.e)(this.state.wins), " adventurer to ascend the Tower of Doom!")), o.a.createElement("div", {
            ...
            var n = r("q1tI"),
                ...
                x = function(e, t) {
                    var r = {},
                        n = 0;
                    if ("+" === t) {
                        n = Math.round(.01 * Object(g.o)(25, 41) * (100 - e)) || 10;
                        var o = Object(g.m)(b.b[0 === Object(g.o)(0, 2) ? "uncommon" : "rare"]);
                        r = {
                            blook: o,
                            strength: Object(g.o)(16, 19),
                            charisma: Object(g.o)(16, 19),
                            wisdom: Object(g.o)(16, 19),
                            class: b.c[o].class
                        }
                    } else {
                        n = -Math.round(.01 * Object(g.o)(30, 46) * e) || -10;
                        var a = Object(g.m)(b.b.common);
                        r = {
                            blook: a,
                            strength: Object(g.o)(0, 5),
                            charisma: Object(g.o)(0, 5),
                            wisdom: Object(g.o)(0, 5),
                            class: b.c[a].class
                        }
                    }
                    return {
                ...
                return t = c, (r = [{
                    ...
                    value: function(e) {
                        ...
                        if (this.ready) {
                            ...
                            e ? (r = [].concat(S(this.props.tower.cards), [this.state.card]), this.props.setTowerCards(r)) : (n += this.state.health, this.props.setTowerLife(n)), this.props.tower.towerId ? k.a.put("/api/towers/save", {
                                id: this.props.tower.towerId,
                                stage: "map",
                                cards: r,
                                life: n
            ...
            var z = function(e) {
                ...
                function c(e) {
                    ...
                    return function(e, t) {
                        ...
                        showTour: !1,
                        readId: ""
                    }, t.freeQuestions = [], t.waiting = !1, t.done = !1, t.qRemaining = 5, t.msg = {}, t.isReading = !1, t.tourRef = o.a.createRef(), t.onAnswer = t.onAnswer.bind(M(t)), t.getQuestion = t.getQuestion.bind(M(t)), t.answerNext = t.answerNext.bind(M(t)), t.selectCard = t.selectCard.bind(M(t)), t.endTour = t.endTour.bind(M(t)), t.readQuestion = t.readQuestion.bind(M(t)), t
                }
                return t = c, (r = [{
                    key: "componentDidMount",
                    value: (s = B(L().mark((function e() {
                        return L().wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                    ...
                    value: function() {
                        var e = this;
                        0 === this.freeQuestions.length && (this.freeQuestions = JSON.parse(JSON.stringify(this.props.tower.questions)));
                        var t = Object(S.m)(this.freeQuestions);
                        this.freeQuestions.splice(this.freeQuestions.indexOf(t), 1), t.random && (t.answers = Object(S.t)(t.answers)), this.setState({
                            question: t,
                            phase: "question"
                        }, (function() {
                            e.waiting = !0, e.waitTimeout = setTimeout((function() {
                    ...
                    value: function() {
                        ...
                        if (this.props.tower && this.props.tower.hwId ? this.redirect = !1 : this.state.notLoggedIn && (this.redirect = !0), !this.redirect && this.props.tower && this.props.tower.questions && this.props.tower.questions.length) return o.a.createElement("div", {
                            ...
                            readId: this.state.readId,
                            theme: "tower"
                        }) : "feedback" === this.state.phase ? o.a.createElement(T.a, {
                            incorrectTime: 3,
                            correctAnswers: this.state.question.correctAnswers,
                            correct: this.state.correct,
                            onNext: this.answerNext
