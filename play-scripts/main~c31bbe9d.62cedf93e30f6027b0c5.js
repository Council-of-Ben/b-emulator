(window.webpackJsonp = window.webpackJsonp || []).push([
    [15], {
        ...
        CXev: function(e, t, a) {
                            ...
                            return new t((function(r, n) {
                                ! function r(o, s, n, i) {
                                    ...
                                    if ("throw" !== c.type) {
                                        var u = c.arg,
                                            f = u.value;
                                        return f && "object" == E(f) && a.call(f, "__await") ? t.resolve(f.__await).then((function(e) {
                                            r("next", e, n, i)
                                        }), (function(e) {
                                            r("throw", e, n, i)
            ...
            var M = function(e, t) {
                    return t ? o.a.createElement("div", {
                        className: _.a.stageText
                    }, "$".concat(Object(S.s)(e.cash))) : o.a.createElement("div", {
                        className: _.a.stageText
                    }, "Day ".concat(e.day))
                },
                U = function(e) {
                    ...
                    return t = c, (a = [{
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 6:
                                        if (this.isSolo = !this.props.cafe.mode, this.isHw = Boolean(this.props.cafe.resultId), this.isSolo || this.isHw || this.props.firebase.setVal({
                                                ...
                                                val: {
                                                    c: I({}, this.props.cafe.corrects),
                                                    i: I({}, this.props.cafe.incorrects)
                                                }
                                                ...
                                                r += e
                                            })), o = this.props.client && this.props.client.blook ? this.props.client.blook : Object(S.m)(Object.keys(k.a)), s = this.props.client && this.props.client.name ? this.props.client.name : "You", (n = this.props.client && this.props.client.standing ? JSON.parse(JSON.stringify(this.props.client.standing)) : [{
                                                name: s,
                                                blook: o,
                                    ...
                                    case 22:
                                        c = n[i].place, this.stats = {
                                            ...
                                            message: Object(C.a)((c - 1) / 5),
                                            ready: !this.props.cafe.cafeId || this.state.ready,
                                            standings: n
                                        }), t && (this.saveStats(t.name, (function() {})), j.a.put("/api/users/plan").then((function(e) {
                                            l.here && l.setState({
                                            ...
                                            Object(f.b)(e)
                                        })), this.props.cafe.cafeId && j.a.delete("/api/cafes", {
                                            params: {
                                                name: t.name,
                        ...
                        key: "saveStats",
                        value: function(e, t) {
                            this.isSolo ? j.a.put("/api/users/cafestats/solo", {
                                name: e,
                                ...
                                return Object(f.b)(e)
                            })) : j.a.put("/api/users/cafestats/live", {
                                name: e,
                                place: this.stats.place,
                                cafeCash: this.stats.cafeCash,
                                foodServed: this.stats.foodServed,
                        ...
                        value: function() {
                            return o.a.createElement("div", {
                                ...
                                title: "Food Served",
                                stat: Object(S.l)(this.state.foodServed)
                            }), o.a.createElement(x.a, {
                                title: "Final Cash",
                                stat: "$".concat(Object(S.l)(this.state.cafeCash))
                            }))
                        }
                    }, {
                        key: "render",
                        value: function() {
                            if (this.props.cafe && (this.props.cafe.resultId || this.props.cafe.mode) ? this.redirect = !1 : this.state.notLoggedIn && (Object(f.b)("FinalPageContainer cannot render if this.state.notLoggedIn"), this.redirect = !0), this.props.cafe || (Object(f.b)("FinalPageContainer cannot render without this.props.cafe"), this.redirect = !0), "final" !== this.props.cafe.stage && (Object(f.b)("FinalPageContainer cannot render if this.props.cafe.stage !== 'final'"), this.redirect = !0), this.redirect) return o.a.createElement(l.a, {
                                to: "/play"
                            });
                            ...
                            return o.a.createElement("div", {
                                ...
                                rightLink: "/play"
                            }), this.state.ready ? this.props.cafe.mode ? o.a.createElement(w.a, {
                                ...
                                myStat: "$".concat(Object(S.l)(this.state.me.cash)),
            ...
            t.a = Object(p.c)(Object(l.g)(Object(n.b)((function(e) {
                return {
                    cafe: e.cafes.cafe,
        ...
        "Kr+K": function(e, t, a) {
                    ...
                    return t = f, (a = [{
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 3:
                                        (t = e.sent) ? (this.name = t.name, this.setState({
                                            loggedIn: !0
                                        }), T.a.get("/api/cafes/byuser").then((function(e) {
                                            a.here && a.setState({
                                    ...
                                    case 15:
                                        return e.next = 17, new Promise((function(e) {
                                            T.a.get("/api/homeworks/byid", {
                                                ...
                                                s.state.noId ? o = !0 : r = s.state.questions, Object(h.b)(t), e()
                                            }))
                                        }));
                                    case 17:
                                        if (!o) {
                        ...
                        value: function(e) {
                            ...
                            var s = 6 - e.items.level,
                                n = Object(N.m)(Object.keys(E.a));
                            T.a.put("/api/users/cafestats/solo", {
                                name: this.name,
                                place: s,
                                day: e.day,
                                cafeCash: e.cafeCash,
                        ...
                        value: function() {
                            return o.a.createElement("div", {
                                ...
                                title: "Food Served",
                                stat: Object(N.l)(this.state.foodServed)
                            }), o.a.createElement(j.a, {
                                title: "Final Cash",
                                stat: Object(N.l)(this.state.cafeCash)
                            }))
                        }
                    }, {
                        key: "render",
                        value: function() {
                            ...
                            return this.props.client && this.props.client.hwId ? this.redirect = !1 : this.state.notLoggedIn && (this.redirect = !0), this.redirect || this.state.ready && (!this.state.questions || 0 === this.state.questions.length) && !this.state.noId ? o.a.createElement(l.a, {
                                ...
                                className: p()(u.isMobile ? v.a.mBody : v.a.body, g.a.background)
                            }, o.a.createElement(x.a, {
                                ...
                                className: g.a.saveHeaderHolder
                            }, o.a.createElement("div", {
                                className: g.a.savesHeader
                            }, this.state.loading ? "Choose a Save" : "Choose a Save Slot")), o.a.createElement("div", {
                                className: g.a.savesHolder
                            }, this.state.savesArray.map((function(t, a) {
                                return t ? o.a.createElement("div", {
                                    className: g.a.saveContainer,
                                    key: t._id
                                }, o.a.createElement("div", {
                                    className: g.a.saveTitle
                                }, "Day ".concat(t.day)), o.a.createElement("div", {
                                    className: g.a.saveSubTitle
                                }, "Café Level ".concat(t.items.level)), o.a.createElement("div", {
                                    className: g.a.saveRow
                                }, "$".concat(Object(N.l)(t.cafeCash)), o.a.createElement("i", {
                                    className: p()(g.a.saveIcon, "fas fa-coins")
                                })), o.a.createElement("div", {
                                    className: g.a.saveRow
                                }, "shop" === t.stage ? "Shop" : "Café Day", o.a.createElement("i", {
                                    className: p()(g.a.saveIcon, "fas fa-store")
                                })), o.a.createElement("div", {
                                    className: g.a.saveRow
                                }, t.hwName || "Not Homework", o.a.createElement("i", {
                                    className: p()(g.a.saveIcon, "fas fa-file-alt")
                                })), o.a.createElement("div", {
                                    className: g.a.loadButton,
                                    role: "button",
                                    tabIndex: 0,
            ...
            t.a = Object(C.c)(Object(l.g)(Object(n.b)((function(e) {
                return {
                    id: e.hosts.id,
                    client: e.clients.client
                }
                                ...
                                e.startTimeout = setTimeout((function() {
                                    ...
                                    e.props.firebase.getDatabaseVal(t.id, "c", (function(r) {
                                        ...
                                        Object.entries(o).forEach((function(e) {
                                            ...
                                            e.state.standings.length > 0 && x.a.post("/api/history", {
        ...
        "Xz+/": function(e, t, a) {
            ...
            var W = ["far fa-hourglass", "fas fa-hourglass-start", "fas fa-hourglass-half", "fas fa-hourglass-end", "fas fa-hourglass"],
                V = function(e) {
                    ! function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                        e.prototype = Object.create(t && t.prototype, {
                    ...
                    return t = c, (a = [{
                        ...
                        value: (s = q().mark((function e() {
                            ...
                            return q().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 7:
                                        if (Object(P.a)(), this.foodStocks = U({}, this.props.cafe.foodStocks), this.setState({
                                            ...
                                            }), this.props.cafe && this.props.cafe.resultId && A.a.put("/api/results", {
                                                id: this.props.cafe.resultId,
                                                data: {
                                                    corrects: this.props.cafe.corrects,
                                                    incorrects: this.props.cafe.incorrects,
                        ...
                        key: "componentWillUnmount",
                        value: function() {
                            Object(P.r)(), clearTimeout(this.abilityTimeout), Object.keys(this.dbRefStage).length && this.dbRefStage.off("value"), Object.keys(this.dbRefMe).length && this.dbRefMe.off("value")
                        }
                    }, {
                        key: "buyItem",
                        value: function(e) {
                                ...
                                if (o > this.state.cafeCash || 5 === r) this.buying = !1;
                                    ...
                                    this.props.client && this.props.client.hostId && this.props.cafe.mode && this.props.firebase.setVal({
                                        ...
                                        val: {
                                            ...
                                            ca: n,
                                            up: "food" === S.b[e].type ? "".concat(e, ":").concat(s[e]) : null
                                        }
                                    }), this.setState({
                                        items: s,
                        ...
                        value: function(e) {
                            ...
                            }) : "back" === this.state.ability ? (a = U({}, O.b)).back = 0 : "crate" === this.state.ability ? Object.entries(this.state.items).forEach((function(e) {
                                var a = H(e, 2),
                                    r = a[0];
                        ...
                        value: function() {
                            ...
                            delete t.level, delete t.time, this.props.cafe.cafeId ? A.a.put("/api/cafes/save", {
                                id: this.props.cafe.cafeId,
                                foods: t,
                                items: a,
                        ...
                        value: function() {
                            ...
                            return this.props.cafe && (this.props.cafe.resultId || this.props.cafe.mode) ? this.redirect = !1 : this.state.notLoggedIn && (this.redirect = !0), this.redirect || !this.props.cafe || this.state.redirect ? o.a.createElement(l.a, {
                                ...
                                id: "regularBody"
                            }, this.state.showTour ? o.a.createElement(I.a, {
                                steps: L.a,
                                onExit: function() {},
                                functions: [function() {
                            ...
                            }, Object.entries(S.b).map((function(t, a) {
                                var r = H(t, 2),
                                    s = r[0],
                                    n = r[1];
                                return "time" === s && e.state.items[s] || "time" !== s ? o.a.createElement("div", {
                                    className: p()(y.a.itemContainer, z({}, y.a.itemContainerHover, e.state.items[s] < 5 && e.state.cafeCash >= n.prices[e.state.items[s]])),
                                    key: s,
                                    role: "button",
                                    tabIndex: 0,
                                    onClick: function() {
                                    ...
                                    className: p()(y.a.plate, z({}, y.a.plate4, 4 === e.state.items[s]), z({}, y.a.plate5, 5 === e.state.items[s]))
                                }, e.state.items[s] > 1 ? o.a.createElement("div", {
                                    className: y.a["plateLevel".concat(e.state.items[s])]
                                    ...
                                    className: y.a.backgroundContainer
                                }, o.a.createElement(j.a, {
                                    level: e.state.items[s]
                                })) : "time" === s ? o.a.createElement("div", {
                                    className: y.a.iconContainer
                                }, o.a.createElement("i", {
                                    className: p()(W[e.state.items[s] - 1], y.a.upgradeIcon)
                                })) : null, o.a.createElement("div", {
                                    className: y.a.rightContainer
                                }, o.a.createElement("div", {
                                    className: y.a.itemName
                                }, n.name || s), o.a.createElement("div", {
                                    className: y.a.itemLevel
                                }, 0 === e.state.items[s] ? "Locked" : "Level ".concat(e.state.items[s])), o.a.createElement("div", {
                                    className: y.a.itemDesc
                                }, "time" === s ? "".concat(S.b[s].times[e.state.items[s] - 1], "s").concat(5 !== e.state.items[s] ? " -> ".concat(S.b[s].times[e.state.items[s]], "s") : "", " Bonus Time") : "level" === s ? "x".concat(S.b[s].multipliers[e.state.items[s] - 1]).concat(5 !== e.state.items[s] ? " -> x".concat(S.b[s].multipliers[e.state.items[s]]) : "", " Profits") : e.state.items[s] > 0 ? "$".concat(Object(P.l)(Math.round(S.b[s].profits[e.state.items[s]] * S.b.level.multipliers[e.state.items.level - 1] * (e.props.cafe.mode ? 3.25 : 1.75)))).concat(5 !== e.state.items[s] ? " -> $".concat(Object(P.l)(Math.round(S.b[s].profits[e.state.items[s] + 1] * S.b.level.multipliers[e.state.items.level - 1] * (e.props.cafe.mode ? 3.25 : 1.75)))) : "", " Per Sale") : null, o.a.createElement("br", null), 5 === e.state.items[s] ? "Max Level" : ""), 5 !== e.state.items[s] ? o.a.createElement("div", {
                                    className: y.a.itemUpgrade,
                                    style: {
                                        color: e.state.cafeCash >= n.prices[e.state.items[s]] ? "#4bc22e" : "#c43a35"
                                    }
                                }, "$".concat(Object(P.l)(n.prices[e.state.items[s]]))) : null)) : null
                            }))), this.props.cafe.mode && !this.state.showTour ? o.a.createElement("div", {
                                className: y.a.abilityHeader
                            }, "Abilities") : null, this.props.cafe.mode && !this.state.showTour ? o.a.createElement("div", {
                                className: y.a.shopContainer
                            }, Object.entries(S.a).map((function(t, a) {
                                var r = H(t, 2),
                                    s = r[0],
                                    n = r[1];
                                return o.a.createElement("div", {
                                    className: p()(y.a.itemContainer, z({}, y.a.itemContainerHover, 1 === e.state.abilities[s] && e.state.cafeCash >= Math.round(n.price + e.state.cafeCash * n.percent))),
                                    key: s,
                                    role: "button",
                                    tabIndex: 0,
                                    onClick: function() {
                                    ...
                                    className: p()(n.icon, y.a.upgradeIcon)
                                })), o.a.createElement("div", {
                                    className: y.a.rightContainer
                                }, o.a.createElement("div", {
                                    className: y.a.itemName
                                ...
                                }, 0 === e.state.abilities[s] ? "Used" : "$".concat(Object(P.l)(Math.round(n.price + e.state.cafeCash * n.percent))))))
                            }))) : null, this.state.showPlayers ? this.state.players.length > 0 ? o.a.createElement("div", {
                                className: y.a.playerWrapper
                            }, o.a.createElement("div", {
                                className: y.a.playerHeader
                            }, "Choose a Player"), o.a.createElement("div", {
                                className: y.a.playerHolder
                            }, this.state.players.map((function(t) {
                                return o.a.createElement("div", {
                                    className: y.a.playerContainer,
                                    key: t.name,
                                    role: "button",
                                    tabIndex: 0,
                                    onClick: function() {
                                    ...
                                    name: t.blook,
                                    className: y.a.playerBlook
                                }), o.a.createElement("div", {
                                    className: y.a.playerColumn
                                }, o.a.createElement("div", {
                                    className: y.a.playerText
                                }, t.name), o.a.createElement("div", {
                                    className: y.a.playerCash
                                }, "$".concat(Object(P.l)(t.cash)))))
                            }))), o.a.createElement("div", {
                                style: {
                                    height: 30
                                }
                                ...
                                className: y.a.noPlayers,
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                                    return e.useAbility(null)
                                }
                            }, "Next")) : null, this.state.goalCompleted ? o.a.createElement(N.a, {
                            ...
                            }) : ["pay", "tax", "trash"].includes(this.state.attackerAbility) ? o.a.createElement(N.a, {
                                text: "pay" === this.state.attackerAbility ? "".concat(this.state.attackerName, " just gave you a $").concat(Object(P.l)(this.state.cashChange), " paycheck bonus!") : "tax" === this.state.attackerAbility ? "".concat(this.state.attackerName, " just forced you to pay $").concat(Object(P.l)(this.state.cashChange), " in taxes.") : "".concat(this.state.attackerName, " just trashed 3 of each of your foods."),
                            ...
                            }) : null) : null, "inspect" === this.state.attackerAbility ? o.a.createElement(E.a, {
                                name: this.state.attackerName,
                                blook: this.state.attackerBlook
                            }) : null)
                        }
                    }]) && F(t.prototype, a), r && F(t, r), Object.defineProperty(t, "prototype", {
                        writable: !1
                    }), c
                }(o.a.Component);
            V.propTypes = {
            ...
            t.a = Object(g.c)(Object(l.g)(Object(n.b)((function(e) {
                return {
                    id: e.hosts.id,
                    client: e.clients.client,
                    cafe: e.cafes.cafe
        ...
        lt4V: function(e, t, a) {
            ...
            var ue = [].concat(ie(Object.keys(H.a)), ie(Object.keys(D.a)), ie(Object.keys(M.a)), ie(Object.keys(U.a)), ie(Object.keys(z.a))),
                fe = [].concat(ie(Object.keys(G.a)), ie(Object.keys(F.a)), ie(Object.keys(J.a))),
                pe = {
                    Toast: 0,
                    Cereal: 0,
                    Yogurt: 0,
                    ...
                    return t = c, (a = [{
                        ...
                        value: function() {
                            ...
                            if (this.props.cafe && (this.props.cafe.resultId || this.props.cafe.mode) ? this.redirect = !1 : this.state.notLoggedIn && (Object(h.b)("CafePage cannot render if this.state.notLoggedIn"), this.redirect = !0), this.props.cafe || (Object(h.b)("CafePage cannot render without this.props.cafe"), this.redirect = !0), this.props.cafe.questions || (Object(h.b)("CafePage cannot render without this.props.cafe.questions"), this.redirect = !0), this.props.cafe.questions[0] || (Object(h.b)("CafePage cannot render without this.props.cafe.questions[0]"), this.redirect = !0), this.state.redirect && (Object(h.b)("CafePage cannot render if this.state.redirect"), this.redirect = !0), !this.redirect) return o.a.createElement("div", {
                                ...
                                className: m.a.regularBody,
                                id: "regularBody"
                            }, this.state.showTour ? o.a.createElement(C.a, {
                            ...
                            })) : null, this.state.askTour ? o.a.createElement(x.a, {
                            ...
                            }) : this.state.goal && !this.state.showTour ? o.a.createElement(x.a, {
                            ...
                            }) : "pay" === this.state.ability || "tax" === this.state.ability ? o.a.createElement(x.a, {
            ...
            t.a = Object(q.c)(Object(l.g)(Object(n.b)((function(e) {
                return {
                    id: e.hosts.id,
                    client: e.clients.client,
                    cafe: e.cafes.cafe
