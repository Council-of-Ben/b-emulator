                            ...
                            if (this.props.host && this.props.host.settings) {
                                ...
                                return s.a.createElement("div", {
                                    ...
                                    return s.a.createElement("div", {
                                        ...
                                        }, Object(L.e)(i.place)), s.a.createElement(A.a, {
                                            name: i.blook,
                                ...
                                }, "$".concat(Object(L.l)(this.state.totalCash)))), this.state.lunch ? s.a.createElement("div", {
                                    className: N.a.modal
                                }, s.a.createElement("i", {
                    ...
                    return t = r, (a = [{
                        ...
                        value: function() {
                            return this.props.client && this.props.client.standing && this.props.client.standing[0] ? s.a.createElement("div", {
                                ...
                                myStat: "$".concat(Object(w.l)(this.state.me.cash)),
        ...
        GQvx: function(e, t, a) {
            ...
            var z = function(e) {
                ...
                return t = l, (a = [{
                    ...
                    key: "render",
                    value: function() {
                        return this.props.client && this.props.client.hwId ? this.redirect = !1 : this.state.notLoggedIn && (this.redirect = !0), this.redirect || !this.props.id && (!this.props.client || !this.props.client.hwId) || this.state.ready && 0 === this.state.questions.length ? s.a.createElement(u.a, {
                            to: "/play"
                        }) : s.a.createElement("div", {
                        ...
                        }, "III: $".concat(Object(T.s)(65), " / 1s")), s.a.createElement("div", {
                        ...
                        }, "$".concat(Object(T.s)(3e4)))), s.a.createElement("div", {
                            ...
                            className: b.a.blookDesc
                        }, "I: $".concat(Object(T.s)(25e3), " / 3s")), s.a.createElement("div", {
                            className: b.a.factoryButtonContainer
                        }, s.a.createElement("div", {
                            className: b.a.factoryUpgrade,
                            style: {
                            ...
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.s)(2e6)))), s.a.createElement("div", {
                            className: b.a.factoryClass
                            ...
                            className: b.a.blookDesc
                        }, "IV: $".concat(Object(T.s)(3700), " / 4s")), s.a.createElement("div", {
                            className: b.a.factoryButtonContainer
                        }, s.a.createElement("div", {
                            className: b.a.factoryUpgrade,
                            style: {
                            ...
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.s)(1e6)))), s.a.createElement("div", {
                            className: b.a.factoryClass
                        }, "❄️"))), s.a.createElement("div", {
                            className: b.a.factory
                        }, s.a.createElement("div", {
                            ...
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.s)(8e4)))), s.a.createElement("div", {
                            className: b.a.factoryClass
                        }, "🐾"))), s.a.createElement("div", {
                            className: b.a.factory
                        }, s.a.createElement("div", {
                            ...
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.s)(5400)))), s.a.createElement("div", {
                            className: b.a.factoryClass
                        }, "🌴"))), s.a.createElement("div", {
                            className: b.a.factory
                        }, s.a.createElement("div", {
                            ...
                            className: b.a.upgradeText
                        }, "$".concat(Object(T.s)(390)))), s.a.createElement("div", {
                            className: b.a.factoryClass
                        }, "🌴"))))))
                    }
                    ...
                    value: function() {
                        if (this.props.host && this.props.host.standings && this.props.host.standings[0] || this.state.standings && this.state.standings[0]) return s.a.createElement("div", {
                            ...
                            stats: this.state.standings.map((function(e) {
                                return "$".concat(Object(_.l)(e.cash))
                            })),
                ...
                ue = function(e) {
                    ...
                    function l(e) {
                        ...
                        return function(e, t) {
                            ...
                            askTour: !0,
                            zoomedImage: ""
                        }, t.dbRefStage = {}, t.dbRefAction = {}, t.waiting = !1, t.timeouts = [], t.upgrades = 0, t.corrects = {}, t.incorrects = {}, t.reminder = 0, t.reminding = !1, t.safe = !1, t.winSent = !1, t.isSolo = !1, t.isHW = !1, t.fullTimer = 60, t.questions = [], t.freeQuestions = [], t.msg = {}, t.isReading = !1, t.tourRef = s.a.createRef(), t.randomQ = t.randomQ.bind(se(t)), t.onAnswer = t.onAnswer.bind(se(t)), t.onKeyPress = t.onKeyPress.bind(se(t)), t.goNext = t.goNext.bind(se(t)), t.chooseBlook = t.chooseBlook.bind(se(t)), t.addCash = t.addCash.bind(se(t)), t.upgrade = t.upgrade.bind(se(t)), t.deleteBlook = t.deleteBlook.bind(se(t)), t.closeAd = t.closeAd.bind(se(t)), t.checkResize = t.checkResize.bind(se(t)), t.readToMe = t.readToMe.bind(se(t)), t
                    }
                    return t = l, (a = [{
                        key: "componentDidMount",
                        ...
                        key: "componentWillUnmount",
                        value: function() {
                            this.props.factoryDisconnect(this.upgrades, this.corrects, this.incorrects, this.state.cash, this.state.blooks), Object(D.r)(), document.removeEventListener("keypress", this.onKeyPress), clearTimeout(this.remindTimeout), clearInterval(this.cashInterval), clearInterval(this.timerInterval), clearInterval(this.incorrectInterval), clearTimeout(this.questionTimeout), clearTimeout(this.feedbackTimeout), clearTimeout(this.minuteTimeout), clearTimeout(this.adTimeout), clearInterval(this.hazardInterval), clearTimeout(this.nightTimeout), clearTimeout(this.glitchTimeout), clearTimeout(this.lolTimeout), clearTimeout(this.jokeTimeout), clearTimeout(this.slowTimeout), clearTimeout(this.danceTimeout), clearTimeout(this.nameTimeout), clearTimeout(this.reminderTimeout), this.timeouts.forEach((function(e) {
                                clearTimeout(e)
                        ...
                        value: function() {
                            ...
                            var e = Object(D.m)(this.freeQuestions);
                            return this.freeQuestions.splice(this.freeQuestions.indexOf(e), 1), e.random && (e.answers = Object(D.t)(e.answers)), e
                        }
                    }, {
                        key: "chooseBlook",
                        value: function(e) {
                        ...
                        value: function() {
                            var e = this;
                            if (!this.props.client || !this.props.client.questions || !this.props.client.questions[0]) return s.a.createElement(u.a, {
                                to: "/play"
                            });
                            var t = "night" === this.state.color,
                                a = "error" === this.state.color,
                            ...
                            return s.a.createElement("div", {
                            ...
                            }, p.isMobile ? null : s.a.createElement("i", {
                            ...
                            }), this.state.feedback || this.state.choices[0] || p.isMobile && !this.state.showQ || !window.speechSynthesis ? null : s.a.createElement("i", {
                                className: h()(S.a.expandIcon, "fas fa-volume-up"),
                                role: "button",
                                tabIndex: 0,
                                onClick: this.readToMe
                            }), p.isMobile && this.state.cash > 1e9 ? "" : this.state.fullTimer || this.state.name), s.a.createElement("div", {
                                className: S.a.headerTextRight
                            }, "$".concat(Object(D.l)(this.state.cash)))), this.state.ready && !p.isMobile ? s.a.createElement("div", {
                                ...
                                }, "+$".concat(Object(D.s)(Math.round(n.cash[n.level] * n.bonus)))) : null, s.a.createElement("div", {
                                    className: S.a.blookHolder,
                                    style: {
                                        boxShadow: re(n.bonus),
                                        backgroundColor: t ? "#000" : a ? o[3] : null
                                    }
                                }, s.a.createElement(F.a, {
                                    name: n.name,
                                ...
                                }, "".concat(ie[n.level], ": $").concat(Object(D.s)(Math.round(n.cash[n.level] * n.bonus)), " / ").concat(n.time[n.level], "s")), s.a.createElement("div", {
                                ...
                                }, "$".concat(Object(D.s)(n.price[n.level])))) : s.a.createElement("div", {
                            ...
                            }, "Correct ".concat(this.state.question.correctAnswers.length > 1 ? "Answers" : "Answer", ": "), Object(D.c)(this.state.question.correctAnswers, "#fff", 28)), s.a.createElement("div", {
                            ...
                            }, s.a.createElement(y.StaticMathField, {
                                className: S.a.qMathField,
                                style: {
                                    color: t ? "#fff" : A.b.default.text,
                                    borderColor: t ? "#fff" : A.b.default.text
                                }
                            }, this.state.question.text.slice(this.state.question.text.indexOf("`*`") + 3, this.state.question.text.length - 3))) : null, s.a.createElement(m.Textfit, {
                                ...
                                }, n.slice(3, n.length - 3))) : s.a.createElement(m.Textfit, {
                                ...
                                return e.state.deleteFor.name && e.state.deleteFor.name !== n.name ? null : "g" === n.class ? s.a.createElement("div", {
                                    ...
                                    className: h()(S.a.glitchIcon, n.icon),
                                    style: {
                                        color: t ? "#fff" : n.color,
                                ...
                                }, "$".concat(Object(D.s)(n.cash[0]), " / ").concat(n.time[0], "s")), s.a.createElement("div", {
                                    className: S.a.blookChoiceName,
                                    style: {
                                        color: t ? "#fff" : null
                                    }
                            ...
                            }, "Match Blooks with ".concat(ce(this.state.classes), " for the Class Synergy Bonus!")) : null) : null), this.state.zoomedImage ? s.a.createElement("div", {
                                ...
                                draggable: !1
                            })) : null) : this.state.ready && p.isMobile ? s.a.createElement("div", {
                                className: O.a.regularBody,
                                id: "regularBody",
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[0] : null
                                ...
                                return e.state.deleteFor.name && e.state.deleteFor.name !== n.name ? null : "g" === n.class ? s.a.createElement("div", {
                                    ...
                                    className: h()(S.a.mGlitchIcon, n.icon),
                                    style: {
                                        color: t ? "#fff" : n.color,
                            ...
                            }, "Match Blooks with ".concat(ce(this.state.classes), " for the Class Synergy Bonus!")) : null) : null) : null, this.state.zoomedImage ? s.a.createElement("div", {
                                className: h()(O.a.modal, O.a.modalButton),
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                            ...
                            }, "Glitch By: ".concat(this.state.glitcherName)), s.a.createElement(F.a, {
                                name: this.state.glitcherBlook,
                                className: p.isMobile ? S.a.mGlitcherBlook : S.a.glitcherBlook
                            })) : null, this.state.glitchMsg ? s.a.createElement(I.a, {
                                ...
                                return e + t
                            }), 0) > 0 ? s.a.createElement(L.a, {
                                ads: this.state.ads,
                                onClick: this.closeAd,
                                night: t,
                                hazards: [a].concat(K(o))
                            }) : null, this.state.lol ? s.a.createElement(z.a, null) : null, this.state.joke ? s.a.createElement(q.a, null) : null, this.state.slow ? s.a.createElement(R.a, {
                                night: t
                            ...
                            }, "One Minute Remaining"))) : null), this.state.dance ? s.a.createElement(M.a, {
                                name: this.state.glitcherName,
                                blook: this.state.glitcherBlook
                            }) : null, this.state.askTour ? s.a.createElement(I.a, {
                            ...
                            }) : this.state.popUpAmount > 0 && !this.state.showTour ? s.a.createElement(I.a, {
                                text: "Cash" === this.state.popUpType ? "Your goal is to make $".concat(Object(D.l)(this.state.popUpAmount), "!") : "Your goal is to make as much money as you can in ".concat(this.state.popUpAmount, " ").concat(1 === this.state.popUpAmount ? "minute" : "minutes", "!"),
                                buttonOne: {
                                    text: "OK",
                                    click: function() {
                                        return e.setState({
