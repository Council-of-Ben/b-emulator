        ...
        "+Oo3": function(e, t, r) {
            ...
            function D() {
                ...
                return p.prototype = d, n(w, "constructor", {
                    ...
                    value: p,
                    configurable: !0
                }), p.displayName = c(d, i, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === p || "GeneratorFunction" === (t.displayName || t.name))
                }, e.mark = function(e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, d) : (e.__proto__ = d, c(e, i, "GeneratorFunction")), e.prototype = Object.create(w), e
                }, e.awrap = function(e) {
                    return {
                        __await: e
                    }
                }, v(g.prototype), c(g.prototype, s, (function() {
                    return this
                })), e.AsyncIterator = g, e.async = function(t, r, n, o, a) {
                    void 0 === a && (a = Promise);
                    var s = new g(l(t, r, n, o), a);
                    return e.isGeneratorFunction(r) ? s : s.next().then((function(e) {
                        return e.done ? e.value : s.next()
                    }))
                }, v(w), c(w, i, "Generator"), c(w, a, (function() {
                    return this
            ...
            var n = r("q1tI"),
                ...
                T = function() {
                    ...
                    return e.forEach((function(e) {
                        var r = e.blook ? E[Object(k.a)(e.blook)] : E[x.a[e].rarity];
                        t.push({
                            card: e,
            ...
            var F = function(e) {
                ...
                return t = c, (r = [{
                    ...
                    value: function() {
                        var e = this;
                        0 === this.freeQuestions.length && (this.freeQuestions = JSON.parse(JSON.stringify(this.props.tower.questions)));
                        var t = Object(E.k)(this.freeQuestions);
                        this.freeQuestions.splice(this.freeQuestions.indexOf(t), 1), t.random && (t.answers = Object(E.r)(t.answers)), this.setState({
                            question: t,
                            phase: "question"
                        }, (function() {
                ...
                q = function(e) {
                    ...
                    function c(e) {
                        ...
                        return function(e, t) {
                            ...
                            message: "",
                            name: ""
                        }, t.here = !0, t.stats = {}, t.saveStats = t.saveStats.bind(B(t)), t
                    }
                    return t = c, (r = [{
                        key: "componentDidMount",
                        value: (a = E().mark((function e() {
                            var t, r, n, o, a, s, i, c, l;
                ...
                return t = c, (r = [{
                    ...
                    value: function(e) {
                        ...
                        if (this.ready) {
                            ...
                            e ? (r = [].concat(S(this.props.tower.cards), [this.state.card]), this.props.setTowerCards(r)) : (n += this.state.health, this.props.setTowerLife(n)), this.props.tower.towerId ? E.a.put("/api/towers/save", {
                                id: this.props.tower.towerId,
                                stage: "map",
                                cards: r,
                                life: n
