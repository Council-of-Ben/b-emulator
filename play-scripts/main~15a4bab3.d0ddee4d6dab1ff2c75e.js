    ...
    [0], {
        ...
        "179K": function(e, t, i) {
            ...
            function P() {
                ...
                return d.prototype = p, o(v, "constructor", p), o(p, "constructor", d), d.displayName = o(p, n, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === d || "GeneratorFunction" === (t.displayName || t.name))
                }, e.mark = function(e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, p) : (e.__proto__ = p, o(e, n, "GeneratorFunction")), e.prototype = Object.create(v), e
                }, e.awrap = function(e) {
                    return {
                        __await: e
                    }
            ...
            var F = function(e) {
                    return a.a.createElement("div", {
                        ...
                        className: v.a.xpText
                    }, Object(k.s)(e.xp)), a.a.createElement("img", {
                        src: x.a.basic.xp,
                        alt: "Xp",
                        className: v.a.xpImage,
                        draggable: !1
                    }))
                },
                D = function(e) {
                            ...
                            return P().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 12:
                                        ...
                                        }), 4750), t && (this.saveStats(t.name, (function() {})), C.a.put("/api/users/plan").then((function(e) {
                                            o.here && o.setState({
                                                name: t.name,
        ...
        KM4Z: function(e, t, i) {
            ...
            var Q = function(e) {
                ...
                return t = n, (i = [{
                        ...
                        if (this.props.host && this.props.host.settings) {
                            if (this.audio.volume = .65, this.audio.play(), this.audio.addEventListener("ended", (function() {
                                ...
                                var t = 60 * this.props.host.settings.amount,
                                    i = 4;
                                this.setState({
                                    timer: v.a.duration(t, "seconds").format("mm:ss")
                    ...
                    value: function() {
                        var e = this;
                        clearInterval(this.timerInterval), clearInterval(this.clientsInterval), !this.ok && this.props.host && this.props.host.id && (this.props.liveGameController.removeHost(this.props.host.id), this.props.deleteHost()), this.audio.currentTime = 0, this.audio.pause(), this.audio.removeEventListener("ended", (function() {
                            e.audio.currentTime = 0, e.audio.play()
                        }), !1)
                    }
                }, {
        ...
        NLPy: function(e, t, i) {
            ...
            t.a = Object(v.c)(Object(c.f)(Object(n.b)((function(e) {
                return {
                    id: e.hosts.id,
                    client: e.clients.client
                }
            ...
            var _ = new(y((function e() {
                ...
                C = function(e, t, i) {
                    ...
                    return t.getChildren().filter((function(e) {
                        ...
                        var i = v.a.Math.Distance.Between(e.x, e.y, t.x, t.y);
                ...
                A = new v.a.Class({
                    ...
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "egg"), this.setDepth(3), this.name = "egg", this.lifespan = 0, this.targets = []
                    },
                    fire: function() {
                        ...
                        var t = j(_.dir);
                        _.scene.physics.velocityFromAngle(v.a.Math.RadToDeg(t), T(_.abilities.egg.speed), this.body.velocity), this.setRotation(t + Math.PI / 2), this.lifespan = _.abilities.egg.lifespan
                    },
                    update: function(e, t) {
                ...
                R = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "nut"), this.setScale(.5), this.setDepth(3), this.name = "nut", this.lifespan = 0, this.targets = []
                    },
                    fire: function() {
                        ...
                        var i = C(_.player, _.enemies),
                            s = i ? v.a.Math.Angle.Between(_.player.x, _.player.y, i.x, i.y) : Object(w.n)(-Math.PI, Math.PI);
                        _.scene.physics.velocityFromAngle(v.a.Math.RadToDeg(s), T(_.abilities.nut.speed), this.body.velocity), this.setRotation(s - Math.PI / 2), this.lifespan = _.abilities.nut.lifespan
                    },
                    update: function(e, t) {
                        this.lifespan -= t, this.lifespan <= 0 && (this.setActive(!1), this.setVisible(!1))
                    }
                ...
                N = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "slime"), this.setDepth(3), this.name = "slime", this.lifespan = 0, this.targets = []
                    },
                    fire: function(e) {
                ...
                z = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "jesterBall-1"), this.setDepth(3), this.name = "jesterBall", this.lifespan = 0, this.targets = []
                    },
                    fire: function(e) {
                ...
                L = new v.a.Class({
                    ...
                    fire: function(e) {
                        this.setTexture(_.abilities.horseshoe.texture), this.setScale(0), this.setActive(!0), this.setVisible(!0), this.setPosition(_.player.x, _.player.y), this.targets = [], this.targetRefresh = _.abilities.horseshoe.targetRefresh, this.posAngle = e, v.a.Math.RotateAroundDistance(this, _.player.x, _.player.y, v.a.Math.DegToRad(this.posAngle), T(150)), this.setRotation(v.a.Math.Angle.Between(_.player.x, _.player.y, this.x, this.y) - Math.PI / 2), this.lifespan = _.abilities.horseshoe.lifespan, _.scene.addTween({
                            targets: this,
                    ...
                    update: function(e, t) {
                        ...
                        var i = v.a.Math.GetSpeed(T(_.abilities.horseshoe.speed), 1) / (2 * Math.PI * T(150)) * 360;
                ...
                D = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "shell-1"), this.setDepth(3), this.name = "shell", this.lifespan = 0, this.targets = []
                    },
                    fire: function() {
                    ...
                    update: function(e, t) {
                        if (this.lifespan -= t, 0 !== _.abilities.shell.evolution) {
                            ...
                            if (i || this.isTargeting) {
                                var s = i ? v.a.Math.Angle.Between(this.x, this.y, i.x, i.y) : Object(w.n)(-Math.PI, Math.PI);
                                _.scene.physics.velocityFromAngle(v.a.Math.RadToDeg(s), T(_.abilities.shell.speed), this.body.velocity), i || (this.isTargeting = !1)
                            }
                        }
                ...
                V = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "pizza-1"), this.setDepth(3), this.name = "pizza", this.lifespan = 0, this.targets = []
                    },
                    fire: function() {
                ...
                U = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "banana-1"), this.setDepth(3), this.name = "banana", this.lifespan = 0, this.targets = []
                    },
                    fire: function(e, t) {
                        ...
                        var i = new v.a.Math.Vector2(this.body.velocity);
                ...
                G = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "arrow-1"), this.setDepth(3), this.name = "arrow", this.lifespan = 0, this.targets = []
                    },
                    fire: function(e) {
                        ...
                        var t = v.a.Math.RadToDeg(j(_.dir)) + e;
                        _.scene.physics.velocityFromAngle(t, T(_.abilities.arrow.speed), this.body.velocity), this.setRotation(v.a.Math.DegToRad(t) + Math.PI / 2), this.lifespan = _.abilities.arrow.lifespan
                    },
                    update: function(e, t) {
                        this.lifespan -= t, this.lifespan <= 0 && (this.setActive(!1), this.setVisible(!1))
                    }
                ...
                H = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "peacock-1"), this.setDepth(3), this.name = "peacock", this.lifespan = 0, this.targets = []
                    },
                    fire: function() {
                        ...
                        var e = C(_.player, _.enemies),
                            t = e ? v.a.Math.Angle.Between(_.player.x, _.player.y, e.x, e.y) : Object(w.n)(-Math.PI, Math.PI);
                        _.scene.physics.velocityFromAngle(v.a.Math.RadToDeg(t), T(_.abilities.peacock.speed), this.body.velocity), this.setRotation(t - Math.PI / 2), this.lifespan = _.abilities.peacock.lifespan
                    },
                    update: function(e, t) {
                        if (this.lifespan -= t, this.isPulledBack) {
                            var i = v.a.Math.Angle.Between(this.x, this.y, _.player.x, _.player.y);
                            _.scene.physics.velocityFromAngle(v.a.Math.RadToDeg(i), T(1.5 * _.abilities.peacock.speed), this.body.velocity), this.setRotation(i - Math.PI / 2)
                        }
                ...
                X = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "bone"), this.setDepth(3), this.name = "bone", this.lifespan = 0, this.targets = []
                    },
                    fire: function() {
                        ...
                        var s = v.a.Math.Angle.Between(this.x, this.y, _.player.x, _.player.y);
                        _.scene.physics.velocityFromAngle(v.a.Math.RadToDeg(s), T(_.abilities.bone.speed), this.body.velocity), this.body.setAngularVelocity((e > Math.PI ? 1 : -1) * Object(w.n)(600, 700)), this.lifespan = 2 * v.a.Math.Distance.Between(this.x, this.y, _.player.x, _.player.y) / T(_.abilities.bone.speed) * 1e3
                    },
                    update: function(e, t) {
                        this.lifespan -= t, this.lifespan <= 0 && (this.setActive(!1), this.setVisible(!1))
                    }
                ...
                Y = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "bee-1"), this.setDepth(3), this.name = "bee", this.lifespan = 0, this.targets = []
                    },
                    fire: function(e) {
                        this.setTexture(_.abilities.bee.texture), this.setScale(O(this, _.abilities.bee.width)), this.setActive(!0), this.setVisible(!0), this.targets = [], this.setPosition(_.player.x, _.player.y), this.straightX = this.x, this.straightY = this.y, this.dirAngle = v.a.Math.DegToRad(e), this.dx = Math.cos(this.dirAngle), this.dy = Math.sin(this.dirAngle), this.setRotation(this.dirAngle + Math.PI / 2), this.lifespan = _.abilities.bee.lifespan, this.duration = 0
                    },
                    update: function(e, t) {
                        this.lifespan -= t, this.duration += t, this.straightX += this.dx * (v.a.Math.GetSpeed(T(_.abilities.bee.speed), 1) * t), this.straightY += this.dy * (v.a.Math.GetSpeed(T(_.abilities.bee.speed), 1) * t), this.x = this.straightX + Math.sin(.01 * this.duration) * _.abilities.bee.waveAmplitude * Math.cos(Math.PI / 2 + Math.abs(this.dirAngle)), this.y = this.straightY + Math.sin(.01 * this.duration) * _.abilities.bee.waveAmplitude * Math.sin(Math.PI / 2 + Math.abs(this.dirAngle)), this.lifespan <= 0 && (this.setActive(!1), this.setVisible(!1))
                    }
                }),
                W = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "bubble"), this.setScale(.5), this.setDepth(3), this.name = "bubble", this.lifespan = 0, this.targets = []
                    },
                    fire: function(e) {
                        ...
                        var s = 2 !== _.abilities.bubble.evolution ? C(_.player, _.enemies) : null,
                            a = s ? v.a.Math.RadToDeg(v.a.Math.Angle.Between(_.player.x, _.player.y, s.x, s.y)) : e,
                ...
                Q = new v.a.Class({
                    ...
                    fire: function(e) {
                        ...
                        var i = j(_.dir);
                        _.scene.physics.velocityFromAngle(v.a.Math.RadToDeg(i), T(_.abilities.laser.speed), this.body.velocity), this.setRotation(i), this.lifespan = _.abilities.laser.lifespan
                    },
                    update: function(e, t) {
                        this.lifespan -= t, this.lifespan <= 0 && (this.setActive(!1), this.setVisible(!1))
                    }
                ...
                Z = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "syrup"), this.setDepth(2), this.name = "syrup", this.lifespan = 0, this.targets = []
                    },
                    fire: function(e) {
                ...
                ee = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "shield"), this.setDepth(1), this.name = "shield", this.lifespan = 0, this.targets = []
                    },
                    fire: function() {
                ...
                te = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "bird-1"), this.setDepth(3), this.name = "bird"
                    },
                    fire: function(e, t) {
                        this.setTexture("bird-".concat(t + 1)), this.birdIndex = t, this.setScale(O(this, _.abilities.birdFeather.birdWidth)), this.setActive(!0), this.setVisible(!0), this.setPosition(_.player.x, _.player.y), this.fireCd = _.abilities.birdFeather.fireRate, this.posAngle = e, v.a.Math.RotateAroundDistance(this, _.player.x, _.player.y, v.a.Math.DegToRad(this.posAngle), T(200)), this.setRotation(v.a.Math.Angle.Between(_.player.x, _.player.y, this.x, this.y) - Math.PI)
                    },
                    update: function(e, t) {
                        this.fireCd -= t;
                        var i = v.a.Math.GetSpeed(T(_.abilities.birdFeather.birdSpeed), 1) / (2 * Math.PI * T(200)) * 360;
                        if (this.posAngle += i * t, this.setPosition(_.player.x, _.player.y), v.a.Math.RotateAroundDistance(this, _.player.x, _.player.y, v.a.Math.DegToRad(this.posAngle), T(200)), this.setRotation(v.a.Math.Angle.Between(_.player.x, _.player.y, this.x, this.y) - Math.PI), this.fireCd <= 0) {
                            ...
                            for (var s = 0; s < _.abilities.birdFeather.numProjectiles; s++) {
                                ...
                                a && a.fire(this, s * (360 / _.abilities.birdFeather.numProjectiles) + v.a.Math.RadToDeg(this.rotation) - 90)
                            }
                        }
                    }
                }),
                ...
                se = new v.a.Class({
                    Extends: v.a.GameObjects.Text,
                    initialize: function() {
                        v.a.GameObjects.Text.call(this, _.scene, 0, 0, "", {
                            fontFamily: "Arial",
                            fontSize: T(32),
                            color: "#fff",
                            align: "center"
                ...
                re = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "xp-1"), this.setScale(O(this, 20)), this.setDepth(1)
                    },
                    ...
                    update: function(e, t) {
                        if (this.isMoving) {
                            ...
                            v.a.Math.Distance.Between(_.player.x, _.player.y, this.x, this.y) < T(_.magnetTime > 0 ? 2500 : 150) && (this.isMoving = !0)
                        }
                    }
                }),
                ...
                oe = new v.a.Class({
                    Extends: v.a.GameObjects.Image,
                    initialize: function() {
                        v.a.GameObjects.Image.call(this, _.scene, 0, 0, "bat"), this.setDepth(2)
                    },
                    start: function(e) {
                        var t = ne[e];
            ...
            var je = function(e) {
                        ...
                        value: function(e, t) {
                            ...
                            if (o.length > 0 && (l = o[0]).body.setVelocity(0), this.cursors.left.isDown || this.cursors.keyA.isDown ? (_.player.setVelocityX(-s), _.hpBar.body.setVelocityX(-s), _.dir.x = -1, n && n.body.setVelocityX(-s), l && l.body.setVelocityX(-s)) : this.cursors.right.isDown || this.cursors.keyD.isDown ? (_.player.setVelocityX(s), _.hpBar.body.setVelocityX(s), _.dir.x = 1, n && n.body.setVelocityX(s), l && l.body.setVelocityX(s)) : (this.cursors.up.isDown || this.cursors.down.isDown || this.cursors.keyW.isDown || this.cursors.keyS.isDown) && (_.dir.x = 0), this.cursors.up.isDown || this.cursors.keyW.isDown ? (_.player.setVelocityY(-s), _.hpBar.body.setVelocityY(-s), _.dir.y = 1, n && n.body.setVelocityY(-s), l && l.body.setVelocityY(-s)) : this.cursors.down.isDown || this.cursors.keyS.isDown ? (_.player.setVelocityY(s), _.hpBar.body.setVelocityY(s), _.dir.y = -1, n && n.body.setVelocityY(s), l && l.body.setVelocityY(s)) : (this.cursors.left.isDown || this.cursors.right.isDown || this.cursors.keyA.isDown || this.cursors.keyD.isDown) && (_.dir.y = 0), 0 !== _.dir.x && 0 !== _.dir.y && (this.cursors.left.isDown || this.cursors.right.isDown || this.cursors.keyA.isDown || this.cursors.keyD.isDown) && (_.player.setVelocity(0), _.hpBar.body.setVelocity(0), 1 === _.dir.x ? (_.player.setVelocityX(a), _.hpBar.body.setVelocityX(a), n && n.body.setVelocityX(a), l && l.body.setVelocityX(a)) : (_.player.setVelocityX(-a), _.hpBar.body.setVelocityX(-a), n && n.body.setVelocityX(-a), l && l.body.setVelocityX(-a)), 1 === _.dir.y ? (_.player.setVelocityY(-a), _.hpBar.body.setVelocityY(-a), n && n.body.setVelocityY(-a), l && l.body.setVelocityY(-a)) : (_.player.setVelocityY(a), _.hpBar.body.setVelocityY(a), n && n.body.setVelocityY(a), l && l.body.setVelocityY(a))), this.input.activePointer.isDown) {
                                ...
                                var c = this.input.activePointer.position,
                                    h = v.a.Math.Angle.BetweenPoints(_.player, {
                ...
                Ce = function(e) {
                    return {
                        ...
                        scale: {
                            mode: v.a.Scale.FIT,
                            autoCenter: v.a.Scale.CENTER_BOTH
                        },
                        physics: {
                            default: "arcade"
                        },
        ...
        kSiZ: function(e, t, i) {
            ...
            var T = function(e) {
                ...
                return t = n, (i = [{
                            ...
                            this.setState({
                                ...
                                e.startTimeout = setTimeout((function() {
                                    ...
                                    e.props.liveGameController.getDatabaseVal("c", (function(s) {
                                        ...
                                        })), e.props.host && e.props.host.id && (e.props.liveGameController.removeHost(e.props.host.id), e.props.deleteHost()), e.waitTimeout = setTimeout((function() {
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        clearTimeout(this.startTimeout), clearTimeout(this.waitTimeout), this.props.host && this.props.host.id && (this.props.liveGameController.removeHost(this.props.host.id), this.props.deleteHost())
                    }
                }, {
                    key: "render",
                    value: function() {
