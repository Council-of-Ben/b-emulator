    ...
    [6], {
        ...
        "8eya": function(e, t, n) {
            ...
            function T() {
                ...
                var y = Object.getPrototypeOf,
                    _ = y && y(y(E([])));
                _ && _ !== t && n.call(_, a) && (d = _);
                var v = m.prototype = h.prototype = Object.create(d);
                                ...
                                return new t((function(o, s) {
                                    ! function r(o, a, s, i) {
                                        ...
                                        if ("throw" !== c.type) {
                                            var l = c.arg,
                                                f = l.value;
                                            return f && "object" == j(f) && n.call(f, "__await") ? t.resolve(f.__await).then((function(e) {
                                                r("next", e, s, i)
                                            }), (function(e) {
                                                r("throw", e, s, i)
                ...
                return p.prototype = m, r(v, "constructor", {
                    value: m,
                    configurable: !0
                }), r(m, "constructor", {
                    value: p,
                    configurable: !0
                }), p.displayName = c(m, i, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === p || "GeneratorFunction" === (t.displayName || t.name))
                }, e.mark = function(e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, m) : (e.__proto__ = m, c(e, i, "GeneratorFunction")), e.prototype = Object.create(v), e
                }, e.awrap = function(e) {
                    return {
                        __await: e
                    }
                }, b(g.prototype), c(g.prototype, s, (function() {
                    return this
                })), e.AsyncIterator = g, e.async = function(t, n, r, o, a) {
                    void 0 === a && (a = Promise);
                    var s = new g(l(t, n, r, o), a);
                    return e.isGeneratorFunction(n) ? s : s.next().then((function(e) {
                        return e.done ? e.value : s.next()
                    }))
                }, b(v), c(v, i, "Generator"), c(v, a, (function() {
                    return this
                ...
                q = function(e) {
                    ...
                    function c(e) {
                        ...
                        return function(e, t) {
                            ...
                            isBen: !1,
                            isLoading: !1
                        }, t.here = !0, t.loading = !1, t.name = "", t.onPlay = t.onPlay.bind(G(t)), t.selectMode = t.selectMode.bind(G(t)), t.startFactory = t.startFactory.bind(G(t)), t
                    }
                    return t = c, (n = [{
                        ...
                        value: (a = T().mark((function e() {
                            ...
                            return T().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 6:
                                        if (this.name = t.name, ["Bot", "Ben", "test"].includes(t.name) && this.setState({
                                                isBen: !0
                                            }), this.props.host && this.props.host.id && this.props.liveGameController.removeHostAndDeleteGame(), this.props.deleteHost(), (n = Object(k.g)("id")) ? (this.props.addGameId(n), this.setState({
                                                ready: !0
                                            })) : this.setState({
                                                isLoading: !0,
                                                ready: !0
                        ...
                        value: function() {
                            ...
                            return o.a.createElement("div", {
                                ...
                                className: v.a.selectText
                            }, "Select a Game Mode"), o.a.createElement("div", {
                                className: v.a.modesArray
                            }, Object.entries(w.a).map((function(t) {
                                var n = E(t, 2),
                                    r = n[0],
                                    a = n[1];
                                return !a.solo || e.state.isLoading && R.includes(r) || !(a.active || e.state.isBen && [].includes(r)) ? null : o.a.createElement("div", {
                                    ...
                                    className: v.a.plusHolder
                                }, o.a.createElement("i", {
                                    className: h()(v.a.plusIcon, "fas fa-plus")
            ...
            t.a = Object(g.c)(Object(l.f)(Object(s.b)((function() {
                return {}
            }), (function(e) {
                return Object(a.b)({
                    deleteHost: m.d,
                ...
                return t = s, (n = [{
                    ...
                    value: function() {
                        if (this.props.host && this.props.host.standings && this.props.host.standings[0] || this.state.standings && this.state.standings[0]) return o.a.createElement("div", {
                            className: f()(_.a.body, d.a.background),
                            style: {
                            ...
                            stats: this.state.standings.map((function(e) {
                                return "".concat(Object(g.j)(e.numBlooks), " ").concat(1 === e.numBlooks ? "Blook" : "Blooks")
                            })),
            ...
            var F = function(e) {
                ...
                function c(e) {
                    ...
                    return function(e, t) {
                        ...
                        muted: !!e.host && e.host.muted,
                        userToBlock: ""
                    }, t.ok = !1, t.isTeam = e.host && e.host.settings && "Teams" === e.host.settings.mode, t.getClients = t.getClients.bind(M(t)), t.goNext = t.goNext.bind(M(t)), t.changeMuted = t.changeMuted.bind(M(t)), t.blockUser = t.blockUser.bind(M(t)), t.audio = new Audio(j.a), t.audio.muted = t.state.muted, t
                }
                return t = c, (n = [{
                    key: "componentDidMount",
                    value: function() {
                    ...
                    value: function() {
                        var e = this;
                        clearInterval(this.timerInterval), !this.ok && this.props.host && this.props.host.id && (this.props.liveGameController.removeHostAndDeleteGame(), this.props.deleteHost()), this.audio.currentTime = 0, this.audio.pause(), this.audio.removeEventListener("ended", (function() {
                            e.audio.currentTime = 0, e.audio.play()
                        }), !1)
                    }
                }, {
                    key: "getClients",
                    value: (a = T().mark((function e(t, n) {
                            ...
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return e.next = 4, new Promise((function(e) {
                                        l.props.liveGameController.getDatabaseVal("a", (function(t) {
                                            var r = t || {},
                                            ...
                                            l.props.liveGameController.removeVal("a");
                                            var a = [],
                                                s = o.map((function(e) {
                                                    return e.name
                                                })),
                                ...
                                case 7:
                                    return e.next = 9, new Promise((function(e) {
                                        l.props.liveGameController.getDatabaseVal("c", (function(t) {
                                            var r = t || {};
        ...
        oQpA: function(e, t, n) {
            ...
            var H = function(e) {
                ...
                return t = c, (n = [{
                        ...
                        return I().wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    return e.abrupt("return");
                                case 2:
                                    return Object(j.a)(), this.isTeam || this.props.liveGameController.setVal({
                                        path: "c/".concat(this.props.client.name, "/bs"),
                                        val: 3
                                    }), e.next = 6, this.props.liveGameController.getDatabaseRef("stg");
                                case 6:
                                    ...
                                    })), e.next = 10, this.props.liveGameController.getDatabaseRef("c/".concat(this.isTeam ? this.props.client.team.name : this.props.client.name));
                                case 10:
                    ...
                    key: "componentWillUnmount",
                    value: function() {
                        this.msg.onend = function() {}, window.speechSynthesis.cancel(), Object(j.p)(), clearTimeout(this.nextTimeout), clearTimeout(this.nextReadyTimeout), clearTimeout(this.waitTimeout), clearTimeout(this.claimTimeout), clearTimeout(this.pickingTimeout), this.here = !1, Object.keys(this.dbRefStage).length && this.dbRefStage.off("value"), Object.keys(this.dbRefMe).length && this.dbRefMe.off("value")
                    }
                }, {
                    key: "onAnswer",
                    value: function(e) {
                    ...
                    value: function(e) {
                        ...
                        if (this.picking)
                            if (this.picking = !1, "defend" === e) {
                                ...
                                this.setState({
                                    numDefense: n
                                }), this.isTeam ? this.props.liveGameController.setVal({
                            ...
                            t.randomQ()
                        }), 15e3), this.props.liveGameController.getDatabaseVal("c", (function(n) {
                    ...
                    value: function(e) {
                        var t = this;
                        this.state.ready && !this.next && (this.next = !0, clearTimeout(this.claimTimeout), this.props.liveGameController.setVal({
                    ...
                    value: function() {
                        var e = this;
                        if (!this.props.client || !this.props.client.questions || !this.props.client.questions[0]) return o.a.createElement(l.c, {
                            to: "/play"
                        });
                        ...
                        return o.a.createElement("div", {
                            ...
                            className: h()(y.a.regularBody, v.a.background, T({}, v.a.fadeOut, this.state.fadeOut))
                            ...
                            className: h()(v.a.prizeContainer, T({}, v.a.noButton, this.state.numDefense >= 4)),
                            role: "button",
                            tabIndex: 0,
        ...
        tmkA: function(e, t, n) {
            ...
            var G = function(e) {
                    ...
                    }, Object(x.q)(e.numBlooks)), o.a.createElement(w.a, {
                        name: e.blook,
                        className: y.a.blookImg
                    }))
                },
                A = function(e) {
                    ! function(e, t) {
                    ...
                    function s(e) {
                        ...
                        return function(e, t) {
                            ...
                            ready: !1,
                            isBlocked: !1
                        }, t.isTeam = e.client && e.client.team, t.saveStats = t.saveStats.bind(N(t)), t
                    }
                    return t = s, (n = [{
                        key: "componentDidMount",
                        value: function() {
                        ...
                        value: function() {
                            return this.props.client && this.props.client.standing && this.props.client.standing[0] ? o.a.createElement("div", {
                                ...
                                myStat: "".concat(Object(x.j)(this.state.me.numBlooks), " ").concat(1 === this.state.me.numBlooks ? "Blook" : "Blooks"),
