    ...
    [20], {
        ...
        "8pR5": function(e, t, a) {
            ...
            function W() {
                ...
                return f.prototype = h, i(y, "constructor", h), i(h, "constructor", f), f.displayName = i(h, r, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                ...
                }, g(b.prototype), i(b.prototype, s, (function() {
                    return this
                })), e.AsyncIterator = b, e.async = function(t, a, o, n, s) {
                    void 0 === s && (s = Promise);
                    var r = new b(l(t, a, o, n), s);
                    return e.isGeneratorFunction(a) ? r : r.next().then((function(e) {
                        return e.done ? e.value : r.next()
                    }))
                }, g(y), i(y, r, "Generator"), i(y, n, (function() {
                    return this
                    ...
                    abrupt: function(e, t) {
                        ...
                        return r.type = e, r.arg = t, s ? (this.method = "next", this.next = s.finallyLoc, u) : this.complete(r)
                    },
                            ...
                            if (this.props.host && this.props.host.settings) {
                                ...
                                return n.a.createElement("div", {
                                    ...
                                    return n.a.createElement("div", {
                                        ...
                                        }, Object(z.e)(i.place)), n.a.createElement(A.a, {
                                            name: i.blook,
                            ...
                            return new t((function(o, r) {
                                ! function o(n, s, r, i) {
                                    ...
                                    if ("throw" !== l.type) {
                                        var u = l.arg,
                                            m = u.value;
                                        return m && "object" == E(m) && a.call(m, "__await") ? t.resolve(m.__await).then((function(e) {
                                            o("next", e, r, i)
                                        }), (function(e) {
                                            o("throw", e, r, i)
                                        })) : t.resolve(m).then((function(e) {
            ...
            var q = function(e) {
                ...
                function l(e) {
                    ...
                    return function(e, t) {
                        ...
                        questions: [],
                        ready: !1
                    }, t.redirect = !1, t.here = !0, t.startGame = t.startGame.bind(A(t)), t
                }
                return t = l, (a = [{
                    key: "componentDidMount",
                    value: (s = O().mark((function e() {
                        var t = this;
                    ...
                    return t = l, (a = [{
                        ...
                        value: function() {
                            ...
                            var t = "night" === this.state.color,
                                ...
                                o = this.state.hazards;
                            return n.a.createElement("div", {
                                className: p.isMobile ? O.a.mBody : O.a.body,
                                id: "body",
                                style: {
                                    overflow: "hidden",
                                    backgroundColor: t ? "#000" : a ? o[0] : null
                                ...
                                className: "Vortex" === this.state.glitch ? O.a.factorySpin : "Reverse" === this.state.glitch ? O.a.factoryReverse : "Flip" === this.state.glitch ? O.a.factoryFlip : "Micro" === this.state.glitch ? O.a.factoryMicro : null
                            }, n.a.createElement("div", {
                                ...
                                className: O.a.regularBody,
                                id: "regularBody",
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[2] : null
                                }
                            }, this.state.showTour ? n.a.createElement(P.a, {
                                steps: v,
                                onExit: function() {
                                    return e.setState({
                                        showTour: !1
                                ...
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[3] : A.b.default.background
                                }
                            }, this.state.question.audio ? n.a.createElement("div", {
                                className: S.a.imageContainer,
                                style: {
                                    backgroundColor: t ? "#000" : a ? o[4] : A.b.default.background
                                }
                                ...
                                style: {
                                    color: t ? "#fff" : A.b.default.text,
                                    borderColor: t ? "#fff" : A.b.default.text
                                }
                                ...
                                return n.a.createElement("div", {
                                    ...
                                    style: {
                                        backgroundColor: t ? "#000" : a ? o[0] : A.b.default.answers[r].background
                                    },
                                    onClick: function() {
                                        return e.onAnswer(s)
                                    },
                                    ...
                                    style: {
                                        color: A.b.default.answers[r].text,
                                        borderColor: A.b.default.answers[r].text
                                    }
                                ...
                                className: h()(O.a.modal, O.a.modalButton),
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                                    return e.setState({
