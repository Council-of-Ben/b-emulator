    ...
    [9], {
        "5BnW": function(e, t, n) {
            ...
            function h() {
                ...
                var g = m.prototype = f.prototype = Object.create(A);
                ...
                return d.prototype = m, i(g, "constructor", m), i(m, "constructor", d), d.displayName = i(m, c, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === d || "GeneratorFunction" === (t.displayName || t.name))
                }, e.mark = function(e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, m) : (e.__proto__ = m, i(e, c, "GeneratorFunction")), e.prototype = Object.create(g), e
                }, e.awrap = function(e) {
                    return {
                        __await: e
                    }
            ...
            var b = {
                ...
                v = function() {
                    ...
                    var t, n, a, o, s, u, l, f, d, g, v, V, w, x, O, E, j, k;
                    return t = e, n = [{
                        key: "_intializeFirebase",
                        value: (k = m(h().mark((function e() {
                        ...
                        key: "getDatabaseVal",
                        value: (j = m(h().mark((function e(t, n) {
                            var r, a;
                            return h().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                        ...
                        key: "_setHost",
                        value: (O = m(h().mark((function e(t, n, r, a) {
                            var o;
                            return h().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                    ...
                                    case 6:
                                        ...
                                        }, this._isHost = !0, e.prev = 8, e.next = 11, i.a.post("/c/firebase/games", o);
                                    case 11:
                                        e.next = 17;
                                        break;
                                    case 13:
                                        e.prev = 13, e.t0 = e.catch(8), this._isHost = !1, Object(c.b)("error attempting to host a game", e.t0);
                                    case 17:
                                    case "end":
                                        return e.stop()
                                }
                        ...
                        key: "setVal",
                        value: (w = m(h().mark((function e(t, n) {
                            var r;
                            return h().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                        ...
                        key: "_setClient",
                        value: (V = m(h().mark((function e(t, n) {
                            var r, a = this;
                            return h().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                                ...
                                                var n = m(h().mark((function n(o) {
                                                    ...
                                                    return h().wrap((function(n) {
                                                        for (;;) switch (n.prev = n.next) {
                                                            ...
                                                            case 3:
                                                                return c = o.data, r._isHost = !0, r._setLiveGameCode(c.id), n.next = 8, e._setFirebaseAuthToken(c.fbToken);
                                                            case 8:
                                                                t(c);
                                                            case 9:
                                                            case "end":
                        ...
                        key: "joinGame",
                        value: (l = m(h().mark((function t(n, r) {
                            var a, o, c;
                            return h().wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                    ...
                                    case 7:
                                        return a = {
                                            id: n,
                                            name: r
                                        }, t.next = 10, i.a.put("/c/firebase/join", a);
                                    case 10:
                                        if (o = t.sent, !(c = o.data).success) {
                                            t.next = 21;
                                            break
                                        }
                                        return t.next = 15, this._setLiveGameCode(n);
                                    case 15:
                                        return t.next = 17, e._setFirebaseAuthToken(c.fbToken);
                                    case 17:
                                        return t.next = 19, this._setClient(r, c.blook);
                                    case 19:
                                        t.next = 23;
                                        break;
                                    case 21:
                                        return t.next = 23, this._setLiveGameCode(null);
                                    case 23:
                            ...
                            return h().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 15:
                                        ...
                                        })), setTimeout(m(h().mark((function e() {
                                            return h().wrap((function(e) {
                                                for (;;) switch (e.prev = e.next) {
                                                    case 0:
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 5:
                                        return e.next = 7, n.signInWithCustomToken(t).catch((function(e) {
                                            Object(c.b)(e, {
                                                while: "siging in with custom token"
                                            })
                                        }));
                                    case 7:
                    ...
                    }], n && A(t.prototype, n), a && A(t, a), Object.defineProperty(t, "prototype", {
                        writable: !1
                    }), e
                }(),
