    ...
    [5], {
        "25NL": function(e, t, a) {
            ...
            function y() {
                ...
                return m.prototype = p, i(g, "constructor", p), i(p, "constructor", m), m.displayName = i(p, s, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === m || "GeneratorFunction" === (t.displayName || t.name))
                }, e.mark = function(e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, p) : (e.__proto__ = p, i(e, s, "GeneratorFunction")), e.prototype = Object.create(g), e
                }, e.awrap = function(e) {
                    return {
                        __await: e
                    }
                }, b(C.prototype), i(C.prototype, r, (function() {
                    return this
                })), e.AsyncIterator = C, e.async = function(t, a, n, o, r) {
                    void 0 === r && (r = Promise);
                    var s = new C(l(t, a, n, o), r);
                    return e.isGeneratorFunction(a) ? s : s.next().then((function(e) {
                        return e.done ? e.value : s.next()
                    }))
                }, b(g), i(g, s, "Generator"), i(g, o, (function() {
                    return this
                    ...
                    abrupt: function(e, t) {
                        ...
                        return s.type = e, s.arg = t, r ? (this.method = "next", this.next = r.finallyLoc, _) : this.complete(s)
                    },
        ...
        "Z+lD": function(e, t, a) {
            ...
            (function(e) {
                ...
                function P() {
                    ...
                    var f = Object.getPrototypeOf,
                        h = f && f(f(k([])));
                    h && h !== t && a.call(h, o) && (d = h);
                    var y = p.prototype = u.prototype = Object.create(d);
                    ...
                    return m.prototype = p, i(y, "constructor", p), i(p, "constructor", m), m.displayName = i(p, s, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                        var t = "function" == typeof e && e.constructor;
                        return !!t && (t === m || "GeneratorFunction" === (t.displayName || t.name))
                    }, e.mark = function(e) {
                        return Object.setPrototypeOf ? Object.setPrototypeOf(e, p) : (e.__proto__ = p, i(e, s, "GeneratorFunction")), e.prototype = Object.create(y), e
                    }, e.awrap = function(e) {
                        return {
                            __await: e
                        }
                    }, x(g.prototype), i(g.prototype, r, (function() {
                        return this
                    })), e.AsyncIterator = g, e.async = function(t, a, n, o, r) {
                        void 0 === r && (r = Promise);
                        var s = new g(l(t, a, n, o), r);
                        return e.isGeneratorFunction(a) ? s : s.next().then((function(e) {
                            return e.done ? e.value : s.next()
                        }))
                    }, x(y), i(y, s, "Generator"), i(y, o, (function() {
                        return this
                        ...
                        finish: function(e) {
                            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                                var a = this.tryEntries[t];
                                if (a.finallyLoc === e) return this.complete(a.completion, a.afterLoc), v(a), _
                            }
                        },
                        catch: function(e) {
                            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                ...
                var D = function(e) {
                    ...
                    W = function(e) {
                        ...
                        return t = c, (a = [{
                            ...
                            key: "getIsPlus",
                            value: (i = A(P().mark((function e(t, a) {
                            ...
                            value: function(e) {
                                var t, a = "q";
                                this.state.addingEqNum < 5 && (a = "answer".concat(this.state.addingEqNum)), this.setState((O(t = {}, "".concat(a, "Eq"), e), O(t, "".concat(a, "Img"), {}), O(t, "qAudio", "q" === a ? null : this.state.qAudio), O(t, "addingEqNum", 0), t))
                            }
                        }, {
                            key: "addAudio",
                            value: function(e) {
                            ...
                            value: function(e) {
                                ...
                                }), this.questionText.current.focus()) : (this.setState(O({}, "answer".concat(this.state.symbolTarget), this.state["answer".concat(this.state.symbolTarget)] + e)), this["answer".concat(this.state.symbolTarget, "Text")].current.focus()), this.setState({
                                    symbolTarget: 0
                                })
                            }
                        }, {
                            key: "save",
                            value: (r = A(P().mark((function e(t) {
                            ...
                            value: function() {
                                ...
                                return o.a.createElement("div", {
                                    ...
                                    className: s()(f.a.randomButton, O({}, f.a.isRandom, this.state.random)),
                                    role: "button",
                                    tabIndex: -1,
                                    onClick: function() {
                                        return e.setState({
                                    ...
                                    style: {
                                        backgroundColor: x.a.default.background
                                    }
                                }, o.a.createElement("div", {
                                    ...
                                    className: s()(f.a.questionTextContainer, O({}, f.a.errorBorder, "question" === this.state.error.type)),
                                    role: "button",
                                    tabIndex: -1,
                                    onClick: function() {
                                    ...
                                    return o.a.createElement("div", {
                                        ...
                                        style: {
                                            backgroundColor: x.a.default.answers[t - 1].background
                                        }
                                    }, o.a.createElement("div", {
                                        className: f.a.answerLeftContainer
                                    }, o.a.createElement("div", {
                                        className: s()(f.a.correctButton, O({}, f.a.correctAnswer, e.state.correctAnswers.includes(t))),
                                        role: "button",
                                        tabIndex: -1,
                                        onClick: function() {
                                        ...
                                        tabIndex: -1,
                                        onClick: function() {
                                            return e.setState(O({}, "answer".concat(t, "Img"), {}))
                                        }
                                    }, o.a.createElement("i", {
                                        ...
                                        tabIndex: 0,
                                        onClick: function() {
                                            return e.setState(O({}, "answer".concat(t, "Eq"), ""))
                                        }
                                    }, o.a.createElement("i", {
                                        className: s()("fas fa-trash-alt", f.a.answerIcon)
                                    }))) : o.a.createElement("div", {
                                        className: s()(f.a.answerTextContainer, O({}, f.a.errorBorder, e.state.error.type === "answer".concat(t) || "correctAnswers" === e.state.error.type && [1, 2].includes(t))),
                                        role: "button",
                                        tabIndex: -1,
                                        onClick: function() {
                                        ...
                                        className: f.a.placeholder,
                                        style: {
                                            color: x.a.default.answers[t - 1].text
                                        }
                                        ...
                                        onChange: function(a) {
                                            var n;
                                            return e.setState((O(n = {}, "answer".concat(t), a.target.value), O(n, "error", e.state.error.type === "answer".concat(t) ? {} : e.state.error), n))
                                        },
                                ...
                                })))))), this.state.addingImgNum || this.state.addingQImg ? o.a.createElement(g.a, {
                                    onClose: function() {
                                        return e.setState({
                                            addingImgNum: 0,
                                            addingQImg: !1
                                    ...
                                    onDone: function(t, a) {
                                        ...
                                        return e.setState((O(n = {
                                            ...
                                            url: t,
                                            file: a
                                        }), O(n, "qEq", e.state.addingQImg ? "" : e.state.qEq), O(n, "qAudio", e.state.addingQImg ? null : e.state.qAudio), O(n, "answer".concat(e.state.addingImgNum, "Eq"), e.state.addingQImg ? e.state["answer".concat(e.state.addingImgNum, "Eq")] : ""), n))
                                    }
                                }) : this.state.addingEqNum ? o.a.createElement(b.a, {
                                ...
                                }) : this.state.addingAudio ? o.a.createElement(C.a, {
                                ...
                                }) : this.state.symbolTarget ? o.a.createElement(v.a, {
                                    select: this.addSymbol
                                }) : this.state.plusMsg ? o.a.createElement(k.a, {
            ...
            var A = function(e) {
                ...
                function u(e) {
                    ...
                    return function(e, t) {
                        ...
                        isClosing: !1,
                        hasPlus: !1
                    }, t.loading = !1, t.setsContainer = o.a.createRef(), t.questionsContainer = o.a.createRef(), t.onSearch = t.onSearch.bind(P(t)), t.getSet = t.getSet.bind(P(t)), t.addQuestion = t.addQuestion.bind(P(t)), t.close = t.close.bind(P(t)), t
                }
                return t = u, (a = [{
                    key: "componentDidMount",
                    value: function() {
                        var e = this;
                        E.a.put("/api/users/plan").then((function(t) {
                            e.setState({
                    ...
                    value: function(e, t) {
                        ...
                        if (e && e.preventDefault(), !this.loading) {
                            this.loading = !0;
                            var n = t;
                            n || (n = 0), E.a.get("/api/games/search", {
                                params: {
                    ...
                    value: (r = T().mark((function e(t) {
                        ...
                        return T().wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                ...
                                case 5:
                                    this.setState({
                                        addedNums: [].concat(O(this.state.addedNums), [t.number]),
                                        addingNum: 0
                                    });
                                case 6:
                                case "end":
                    ...
                    value: function() {
                        ...
                        return o.a.createElement(o.a.Fragment, null, o.a.createElement("div", {
                            ...
                            return o.a.createElement("div", {
                                ...
                                src: Object(I.f)(t.coverImage.url),
                                alt: "Cover",
                            ...
                            }, "".concat(Object(I.k)(t.questions.length), " Qs"))), o.a.createElement("div", {
                            ...
                            }, "".concat(Object(I.k)(t.playCount), " ").concat(1 === t.playCount ? "Play" : "Plays"), t.verified ? o.a.createElement("i", {
                            ...
                            return o.a.createElement("div", {
                                ...
                                return 2 === e.split("`~`").length ? o.a.createElement("div", {
                                    ...
                                    style: {
                                        backgroundColor: k.a.default.answers[a].background
                                    },
                                    key: e
                                }, o.a.createElement("img", {
                                    src: Object(I.f)(e.split("`~`")[1]),
                                    alt: "Answer",
                            ...
                            src: Object(I.f)(this.state.zoomedImage, !0),
                            alt: "Upload",
        ...
        "ca/f": function(e, t, a) {
            ...
            var b = ["#1f77b4", "#ffa31e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#b3dc23", "#0bc2cf"],
                C = function(e) {
                    ...
                    }, "/ ".concat(Object(x.k)(m)))) : null, void 0 !== C ? o.a.createElement("div", {
                    ...
                    })) : null, void 0 !== j ? o.a.createElement("div", {
            ...
            var k = {
                ...
                N = function(e) {
                    ...
                    return o.a.createElement(o.a.Fragment, null, o.a.createElement("div", {
                        ...
                        className: l()(k[O.big].icon, m.a.bigIcon)
                    }), "Set Creator" === O.big ? "Create" : O.big)), O.medium.filter((function(e) {
                    ...
                    }))) : null, "Starter" === T.plan && "Teacher" === T.role ? o.a.createElement(c.b, {
                        className: m.a.plusButton,
                        to: "/upgrade"
                    }, o.a.createElement("i", {
                        className: l()("fas fa-plus", m.a.plusIcon)
                    }), "Upgrade to Plus") : null), o.a.createElement("div", {
                    ...
                    }), "Settings"), o.a.createElement(c.b, {
                        className: m.a.profileDropdownOption,
                        to: "/logout"
                    }, o.a.createElement("i", {
                        ...
                        className: l()(k[O.big].icon, m.a.bigIcon)
                    }), "Set Creator" === O.big ? "Create" : O.big)), [].concat(g(O.medium), ["Logout"]).filter((function(e) {
                        return !k[e].showIf || k[e].showIf(T)
                    })).map((function(e) {
                        var a, n;
                        return k[e].realLink ? o.a.createElement("a", {
