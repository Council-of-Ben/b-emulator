        ...
        "57Jf": function(t, e, r) {
            ...
            function O() {
                    ...
                    return a._invoke = function(t, e, r) {
                        ...
                        return function(n, a) {
                            ...
                            for (r.method = n, r.arg = a;;) {
                                ...
                                var l = c(t, e, r);
                                if ("normal" === l.type) {
                                    if (o = r.done ? "completed" : "suspendedYield", l.arg === u) continue;
                                    return {
                                        value: l.arg,
                                        done: r.done
                                    }
                ...
                function v(t, e) {
                    ...
                    var n = o.arg;
                    return n ? n.done ? (e[t.resultName] = n.value, e.next = t.nextLoc, "return" !== e.method && (e.method = "next", e.arg = void 0), e.delegate = null, u) : n : (e.method = "throw", e.arg = new TypeError("iterator result is not an object"), e.delegate = null, u)
                }
                ...
                return h.prototype = d, s(y, "constructor", d), s(d, "constructor", h), h.displayName = s(d, i, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                    var e = "function" == typeof t && t.constructor;
                    return !!e && (e === h || "GeneratorFunction" === (e.displayName || e.name))
                }, t.mark = function(t) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(t, d) : (t.__proto__ = d, s(t, i, "GeneratorFunction")), t.prototype = Object.create(y), t
                }, t.awrap = function(t) {
                    return {
                        __await: t
                    }
                    ...
                    return this
                })), t.AsyncIterator = b, t.async = function(e, r, o, n, a) {
                    void 0 === a && (a = Promise);
                    var i = new b(l(e, r, o, n), a);
                    return t.isGeneratorFunction(r) ? i : i.next().then((function(t) {
                        return t.done ? t.value : i.next()
                    }))
                }, g(y), s(y, i, "Generator"), s(y, n, (function() {
                    return this
                ...
                return e = l, (r = [{
                        ...
                        return O().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    ...
                                    return Object(d.b)("NamePage cannot proceed without user"), window.location.href = "".concat("https://id.blooket.com", "/login"), t.abrupt("return");
                                case 7:
                                    this.name = e.name;
                                case 8:
                                case "end":
                    ...
                    value: function(t) {
                        ...
                        if (t.preventDefault(), !this.loading) {
                            ...
                            var r = Object(E.u)(this.state.name);
                            this.setState({
                                nameError: r
                            }, (function() {
                                e.state.nameError ? (e.loading = !1, e.setState({
                                    loading: !1
                                })) : k.a.put("/api/users/change/name", {
                                    name: e.name,
                                    newName: e.state.name
                                }).then((function(t) {
                                    !0 === t.data.success ? Object(x.b)() : (e.loading = !1, e.setState(j({
                                        loading: !1
                        ...
                        return C().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    ...
                                    return Object(d.b)("ClassesPage cannot proceed without user"), window.location.href = "".concat("https://id.blooket.com", "/login"), t.abrupt("return");
                                case 7:
                                    return this.setState({
                                        user: e
                                    }), t.next = 10, new Promise((function(t) {
                                        w.a.put("/api/users/plan").then((function(e) {
                                            o.here && t("Starter" !== e.data.plan)
                                        })).catch((function() {
                                            t(!1)
                                        }))
                                    }));
                    ...
                    value: function(t) {
                        ...
                        if (t && t.preventDefault(), !this.loading) {
                            ...
                            this.setState({
                                ...
                                e.here && (Object(d.b)(t), e.loading = !1, e.setState({
                                    isCreating: !1,
                                    loading: !1
                                }))
                            }))
                ...
                return e = l, (r = [{
                        ...
                        return O().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    ...
                                    return Object(d.b)("EmailPage cannot proceed without user or user.hasPassword"), window.location.href = "".concat("https://id.blooket.com", "/login"), t.abrupt("return");
                                case 7:
                                    this.email = e.email;
                                case 8:
                                case "end":
                    ...
                    value: function(t) {
                        ...
                        if (t.preventDefault(), !this.loading) {
                            ...
                            var r = Object(E.r)(this.state.email),
                                o = "";
                            this.state.password || (o = "Where's the password?"), this.setState({
                                ...
                                e.state.emailError || e.state.passwordError ? (e.loading = !1, e.setState({
                                    loading: !1
                                })) : k.a.put("/api/users/change/email", {
                                    email: e.email,
                ...
                return e = s, (r = [{
                            ...
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 7:
                                    this.email = e.email, this.setState({
                                        ...
                                        ready: !0
                                    }), C.a.get("/api/users/check-auth").then((function() {
                                        C.a.get("/api/config").then(function() {
                        ...
                        if (t.preventDefault(), !this.loading) {
                            ...
                            this.state.password || (r = "Where's The Password?"), this.setState({
                                ...
                                e.state.passwordError ? (e.loading = !1, e.setState({
                                    loading: !1
                                })) : C.a.delete("/api/users", {
                                    params: {
                                        email: e.email,
                                        password: e.state.password
                                    }
                                }).then((function(t) {
                                    t.data.success ? Object(k.b)() : (e.loading = !1, e.setState({
                                        loading: !1,
                    ...
                    value: function(t) {
                        ...
                        this.setState({
                            loading: !0,
                            passwordError: ""
                        }), C.a.delete("/api/users/google", {
                            params: {
                                access_token: t.accessToken,
                                email: this.email
                            }
                        }).then((function(t) {
                            t.data.success ? Object(k.b)() : e.setState({
                                passwordError: t.data.msg,
                                loading: !1
                            })
                        })).catch((function() {
                    ...
                    value: function() {
                        ...
                        return n.a.createElement("div", {
                            ...
                            tabIndex: 0
                        })) : n.a.createElement(n.a.Fragment, null, n.a.createElement("div", null, this.state.googleClientId ? n.a.createElement(d.GoogleLogin, {
                        ...
                        return j().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    ...
                                    return Object(d.b)("AddPasswordPage cannot continue without user"), window.location.href = "".concat("https://id.blooket.com", "/login"), t.abrupt("return");
                                case 7:
                                    this.name = e.name;
                                case 8:
                                case "end":
                        ...
                        if (t.preventDefault(), !this.loading) {
                            ...
                            this.state.password ? this.state.password.length < 8 ? r = "Password must have at least 8 characters." : this.state.password.length > 72 ? r = "Password is too long (trouble encrypting)." : /(?=.*[A-Z])/.test(this.state.password) ? /(?=.*[a-z])/.test(this.state.password) ? /(?=.*[0-9])/.test(this.state.password) || (r = "Password must have at least 1 number digit.") : r = "Password must have at least 1 lowercase letter." : r = "Password must have at least 1 uppercase letter." : r = "Where's The Password?", this.state.password !== this.state.password2 && (o = "The passwords don't match."), this.state.password2 || (o = "Where's The Confirming Password?"), this.setState({
                                ...
                                e.state.passwordError || e.state.password2Error ? (e.loading = !1, e.setState({
                                    ...
                                    !0 === t.data.success ? Object(x.b)() : (e.loading = !1, e.setState({
                                        loading: !1,
                                        passwordError: t.data.msg
                                    }))
                                })).catch((function(t) {
                        ...
                        return j().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    ...
                                    return Object(d.b)("ClassJoinPage cannot proceed without user"), window.location.href = "".concat("https://id.blooket.com", "/login"), t.abrupt("return");
                                case 7:
                                    E.a.get("/api/classes", {
                                        params: {
                                            id: this.classId
                ...
                return e = l, (r = [{
                    ...
                    value: function() {
                        ...
                        return this.props.match.params.id ? this.state.ready && !this.state.name ? (Object(p.b)("ClassPage cannot be rendered without this.state.name"), n.a.createElement(c.a, {
                            ...
                            className: d()("fas fa-plus-square", g.a.buttonIcon)
                            ...
                            className: d()("fas fa-pencil-alt", g.a.buttonIcon)
                            ...
                            className: d()("fas fa-trash-alt", g.a.buttonIcon)
                        }), "Delete Class"), n.a.createElement(u.b, {
                            className: g.a.button,
                            to: "/dashboard?p=Classes"
                        }, n.a.createElement("i", {
                            className: d()("fas fa-reply", g.a.buttonIcon)
                            ...
                            return n.a.createElement("div", {
                                ...
                                className: d()(g.a.extraRowIcon, "fas fa-eye")
                            }), "View"), n.a.createElement("div", {
                                className: d()(g.a.extraRow, g.a.extraRowRed),
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                                    return t.setState({
                                ...
                                className: d()(g.a.extraRowIcon, "fas fa-user-slash")
                            }), "Kick")))
                        })))) : n.a.createElement("div", {
                    ...
                    return e = l, (r = [{
                        ...
                        value: function() {
                            ...
                            return n.a.createElement("div", {
                                ...
                                className: d()(y.a.left, P({}, y.a.mShowLeft, this.state.showMobileBlooks))
                                ...
                                return n.a.createElement("div", {
                                    ...
                                    return n.a.createElement("div", {
                                        ...
                                        name: r,
                                        className: d()(y.a.blook, P({}, y.a.lockedBlook, !j.a.includes(r) && !t.state.blookData[r]))
                                    ...
                                    }, t.state.blookData[r] ? Object(N.k)(t.state.blookData[r]) : 0) : n.a.createElement("i", {
                                        className: d()("fas fa-lock", y.a.blookLock)
                                    }))
                                }))))
                            }))) : n.a.createElement("div", {
                            ...
                            }, j.a.includes(this.state.blook) ? "Free Blook" : this.state.blookData[this.state.blook] ? "".concat(Object(N.k)(this.state.blookData[this.state.blook]), " Owned") : "Locked"), n.a.createElement("div", {
