(window.webpackJsonp = window.webpackJsonp || []).push([
    [9], {
                ...
                return t = l, (a = [{
                    ...
                    value: function(e) {
                        ...
                        this.loading || (this.loading = !0, this.setState({
                            unfavoriting: !0
                        }), S.a.put("/api/users/updatefavorites", {
                            id: e,
                            isUnfavoriting: !0
                        }).then((function() {
                            if (t.here) {
                    ...
                    value: function(e) {
                        var t = this;
                        S.a.put("/api/users/plan").then((function(a) {
                    ...
                    value: function() {
                        ...
                        if (!this.loading) {
                            ...
                            this.setState({
                                loading: !0
                            }), S.a.put("/api/users/favorite-folders/new", {
                    ...
                    value: function() {
                        ...
                        if (!this.loading) {
                            ...
                            this.setState({
                                loading: !0
                            }), S.a.put("/api/users/favorite-folders/edit", {
                    ...
                    value: function() {
                        var e = this;
                        this.loading || (this.loading = !0, S.a.put("/api/users/favorite-folders/addsets", {
                    ...
                    value: function(e) {
                        var t = this;
                        this.loading || (this.loading = !0, S.a.put("/api/users/favorite-folders/removeset", {
                            folderName: this.state.folderName,
                            setId: e
                        }).then((function(a) {
                            if (t.here) {
                    ...
                    value: function() {
                        ...
                        this.loading || (this.loading = !0, this.setState({
                            loading: !0
                        }), S.a.put("/api/users/favorite-folders/delete", {
                    ...
                    value: function() {
                        ...
                        return o.a.createElement("div", {
                        ...
                        }, this.state.inFolder ? o.a.createElement(T.a, {
                            ...
                            var a = I(t, 2),
                                n = a[0],
                                r = a[1];
                            return e.shouldShowFolder(n, r) ? o.a.createElement(T.a, {
                                outsideClass: C.a.folderButton,
                                color: r.color,
                                key: n,
                                onClick: function() {
                            ...
                            }, "".concat(Object(N.k)(t.questions.length), " ").concat(1 === t.questions.length ? "Question" : "Questions"))), o.a.createElement("div", {
                ...
                return t = l, (a = [{
                    ...
                    value: function() {
                        ...
                        return o.a.createElement("div", {
                            ...
                            }), S.a[t.settings.type].name), o.a.createElement("div", {
                                className: w.a.info
                            }, o.a.createElement("i", {
                        ...
                        }), "Discover Sets"))))) : null, this.state.games.length > this.state.numGames ? o.a.createElement(j.a, {
                            ...
                            return new t((function(n, s) {
                                ! function n(o, r, s, i) {
                                    ...
                                    if ("throw" !== l.type) {
                                        var u = l.arg,
                                            d = u.value;
                                        return d && "object" == j(d) && a.call(d, "__await") ? t.resolve(d.__await).then((function(e) {
                                            n("next", e, s, i)
                                        }), (function(e) {
                                            n("throw", e, s, i)
                                        })) : t.resolve(d).then((function(e) {
            ...
            var A = function(e) {
                ...
                function l(e) {
                    ...
                    return function(e, t) {
                        ...
                        deleteCheck: !1,
                        loading: !1
                    }, t.here = !0, t.onDeleteConfirm = t.onDeleteConfirm.bind(q(t)), t
                }
                return t = l, (a = [{
                    key: "componentDidMount",
                    ...
                    value: function(e) {
                        ...
                        if (!this.state.loading) {
                            ...
                            this.setState({
                                loading: !0
                            }), E.a.delete("/api/homeworks", {
                                params: {
                                    id: this.state.deleteId
                                }
                            }).then((function() {
                                if (t.here) {
                                    var e = F(t.state.homeworks);
                                    e.splice(e.map((function(e) {
                                        return e._id
                                    })).indexOf(t.state.deleteId), 1), t.setState({
                                        loading: !1,
                    ...
                    value: function() {
                        ...
                        return o.a.createElement("div", {
                            ...
                            return o.a.createElement("div", {
                                ...
                                className: p()("far fa-file-alt", v.a.hwIcon),
                                style: {
                            ...
                            className: p()("fas fa-question-circle", v.a.nothingIcon)
                        }), "Learn How to Assign HW"))))) : null, this.state.homeworks.length > this.state.numHomeworks ? o.a.createElement(N.a, {
            ...
            var H = function(e) {
                ...
                function l(e) {
                    ...
                    return function(e, t) {
                        ...
                        isPO: !1,
                        loading: !1
                    }, t.here = !0, t.copyToClipboard = t.copyToClipboard.bind(M(t)), t.removeMember = t.removeMember.bind(M(t)), t.deleteGroup = t.deleteGroup.bind(M(t)), t.editStripe = t.editStripe.bind(M(t)), t.dowloadReport = t.dowloadReport.bind(M(t)), t
                }
                return t = l, (a = [{
                    key: "componentDidMount",
                    ...
                    return t = l, (a = [{
                        ...
                        value: function() {
                            ...
                            return this.state.standingShown.name && (t = this.state.standingShown.corrects || {}, a = this.state.standingShown.incorrects || {}), o.a.createElement("div", {
                                ...
                                className: j.a.fullContainer
                            }, o.a.createElement("div", {
                                className: j.a.setContainer
                            }, o.a.createElement("div", {
                                className: j.a.setText
                            }, this.state.set)), o.a.createElement("div", {
                                className: j.a.row
                            }, o.a.createElement("div", {
                                className: j.a.column
                            }, o.a.createElement("div", {
                                className: j.a.miniTopContainer
                            }, o.a.createElement("div", {
                                className: j.a.miniTopText
                                ...
                                className: j.a.qHolder
                            }, o.a.createElement("div", {
                                className: j.a.headerContainer
                            }, o.a.createElement("div", {
                                ...
                                return o.a.createElement("div", {
                                    ...
                                    className: j.a.accuracyText
                                }, "".concat(Math.round(t.numCorrects / (t.numCorrects + t.numIncorrects) * 100), "%"), o.a.createElement("div", {
                                    className: j.a.accuracySmallText
                                }, "Correct")) : o.a.createElement("div", {
                                    className: j.a.leftEarlyText
                                }, "Left", o.a.createElement("br", null), "Early"), o.a.createElement(B.a, {
                                    name: t.blook,
                                ...
                                className: j.a.sortedContainer
                            }, o.a.createElement("div", {
                                className: j.a.sortedText
                                ...
                                return o.a.createElement("div", {
                                    ...
                                    className: j.a.questionImageContainer,
                                    role: "button",
                                    tabIndex: 0,
                                ...
                                className: j.a.plusContainer
                            }, o.a.createElement("div", {
                                className: j.a.plusText
                                ...
                                draggable: !1
                            })) : null, this.state.deleteCheck ? o.a.createElement(I.a, {
                                text: "Do you really want to delete this history?",
                                loading: this.state.loading,
                                buttonOne: {
                                    text: "Yes",
                                ...
                                className: j.a.plusModalContainer
                            }, o.a.createElement("i", {
                                className: h()("fas fa-times", j.a.plusTimes),
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                                    return e.setState({
                                ...
                                className: j.a.standingModalContainer
                            }, o.a.createElement("i", {
                                className: h()("fas fa-times", j.a.plusTimes),
                                role: "button",
                                tabIndex: 0,
                                ...
                                return o.a.createElement("div", {
                                    ...
                                    className: j.a.modalQuestionText
                ...
                return t = l, (a = [{
                    ...
                    value: function() {
                        return o.a.createElement("div", {
                            ...
                            className: y.a.infoHeader
                        }, "How do I change my profile Blook on the Stats page?"), o.a.createElement("div", {
                            className: y.a.text
                        }, "\n                We set that automatically to your most used Blook. For now, the only way to change it is to play more games\n                with the Blook you want to appear there.\n                ")), o.a.createElement("div", {
                            className: y.a.infoContainer
                        }, o.a.createElement("div", {
                            className: y.a.infoHeader
        ...
        ouvC: function(e, t, a) {
                ...
                le = function(e) {
                    ...
                    return t = l, (a = [{
                            ...
                            return J().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 4:
                                        ...
                                        return Object(E.b)("HomeworkPage cannot proceed without user"), window.location.href = "".concat("https://id.blooket.com", "/login"), e.abrupt("return");
                                    case 9:
                                        this.setState({
                                            user: t
                                        }), this.refresh(), H.a.put("/api/users/plan").then((function(e) {
                                            "Starter" !== e.data.plan && a.here && a.setState({
                                                plus: !0
                                            })
                                        })).catch((function(e) {
                        ...
                        value: function() {
                            ...
                            this.loading || (this.loading = !0, this.setState({
                                loading: !0
                            }), H.a.put("/api/homeworks/delete-result", {
                        ...
                        value: function() {
                            ...
                            this.setState({
                                standings: []
                            }), H.a.get("/api/homeworks/byid/results", {
                                params: {
                                    id: this.id
                                }
                            }).then((function(t) {
                        ...
                        value: function() {
                            var e = this;
                            if (!this.props.match.params.id) return Object(E.b)("HomeworkPage cannot be rendered without id"), void(window.location.href = "".concat("https://id.blooket.com", "/login"));
                            if (this.state.ready && !this.state.set) return Object(E.b)("HomeworkPage cannot be rendered without this.state.set"), o.a.createElement(u.a, {
                                to: "/404"
                            });
                            var t = {},
                                a = {};
                            return this.state.standingShown.name && (t = this.state.standingShown.data.corrects || {}, a = this.state.standingShown.data.incorrects || {}), o.a.createElement("div", {
                                className: y.isMobile ? S.a.mBody : S.a.body
                            }, o.a.createElement(B.a, {
                                title: "Homework | Blooket",
                                desc: "View your recent homework and review how the players performed and what questions were most missed."
                            }), o.a.createElement(O.a, {
                                ...
                                className: T.a.copiedNotification
                            }, "Copied!") : null)), o.a.createElement("div", {
                                className: T.a.endDateText
                            }, "HW Closes At: ".concat(this.state.endDate)), o.a.createElement("i", {
                                className: h()("fas fa-angle-down", T.a.downIcon)
                            })), o.a.createElement("div", {
                                className: T.a.setText
                            }, this.state.set), o.a.createElement("div", {
                                className: T.a.row
                            }, o.a.createElement("div", {
                                className: T.a.column
                            }, o.a.createElement("div", {
                                className: T.a.miniTopContainer
                            }, o.a.createElement("div", {
                                className: T.a.miniTopText
                            }, this.state.date)), o.a.createElement("div", {
                                ...
                                className: T.a.correctContainer
                            }, o.a.createElement("div", {
                                className: T.a.correctText
                            }, "".concat(this.state.numPlayers, " ").concat(1 === this.state.numPlayers ? "Player" : "Players"))), o.a.createElement("div", {
                                className: T.a.correctContainer
                            }, o.a.createElement("div", {
                                className: T.a.correctText,
                            ...
                            }, "".concat(Object(A.k)(this.state.corrects), " Correct"))), o.a.createElement("div", {
                                className: T.a.correctContainer
                            }, o.a.createElement("div", {
                                className: T.a.correctText,
                                style: {
                            ...
                            }, "".concat(Object(A.k)(this.state.incorrects), " Incorrect"))), this.state.plus ? o.a.createElement("div", {
                                className: T.a.downloadButton,
                                role: "button",
                                tabIndex: 0,
                                onClick: this.downloadResult
                            }, o.a.createElement("i", {
                                ...
                                className: h()(T.a.refreshIcon, "fas fa-trash-alt")
                                ...
                                className: h()(T.a.refreshIcon, "fas fa-history")
                                ...
                                className: h()("fas fa-sync-alt", T.a.refreshIcon)
                            }), "Refresh")), this.state.standings.length > 0 ? o.a.createElement("div", {
                                className: T.a.qHolder
                            }, o.a.createElement("div", {
                                className: T.a.headerContainer
                            }, o.a.createElement("div", {
                                ...
                                className: T.a.keyGroup
                            }, o.a.createElement("i", {
                                className: h()("fas fa-user", T.a.keyIcon),
                                style: {
                                    color: "#4bc22e"
                                }
                                ...
                                return o.a.createElement("div", {
                                    ...
                                    className: T.a.accuracyText
                                }, "".concat(Math.round(t.numCorrects / (t.numCorrects + t.numIncorrects) * 100), "%"), o.a.createElement("div", {
                                    className: T.a.accuracySmallText
                                }, "Correct")) : o.a.createElement("div", {
                                    className: T.a.leftEarlyText
                                }, "No", o.a.createElement("br", null), "Progress"), ["Tower", "Cafe", "Defense"].includes(e.state.type) ? o.a.createElement("i", {
                                    className: h()(t.data.alive ? "fas fa-user" : "fas fa-user-slash", T.a.standingIcon),
                                    style: {
                                        color: t.data.alive ? "#4bc22e" : "#c43a35"
                                    }
                                }) : o.a.createElement(F.a, {
                                    name: t.blook,
                                    className: T.a.blookImage
                                }), o.a.createElement(w.a, {
                                    ...
                                    className: T.a.barContainer
                                }, o.a.createElement("div", {
                                    className: T.a.correctBar,
                                    style: {
                                        width: t.numCorrects || t.numIncorrects ? "".concat(t.numCorrects / (t.numCorrects + t.numIncorrects) * 100, "%") : "100%",
                                        minWidth: t.numCorrects ? 50 : null
                                    }
                                }, t.numCorrects ? o.a.createElement("div", {
                                    className: T.a.barText
                                }, t.numCorrects) : null), t.numIncorrects ? o.a.createElement("div", {
                                    className: T.a.barText
                                }, t.numIncorrects) : null), "Tower" === e.state.type ? o.a.createElement("div", {
                                    className: T.a.statText
                                    ...
                                    className: T.a.statText
                                }, "$".concat(Object(A.k)(t.data.cash))) : "Cafe" === e.state.type ? o.a.createElement("div", {
                                    className: T.a.statText
                                    ...
                                    className: T.a.statText
                                }, Object(A.k)(t.data.guests), o.a.createElement("i", {
                                    className: h()("fas fa-users", T.a.statIcon)
                                })) : "Brawl" === e.state.type ? o.a.createElement("div", {
                                    className: T.a.statText
                                }, "Level ".concat(t.data.level)) : null), o.a.createElement("div", {
                                    className: T.a.deleteStanding,
                                    role: "button",
                                    tabIndex: 0,
                                    onClick: function() {
                                        return e.setState({
                                ...
                                className: T.a.sortedContainer
                            }, o.a.createElement("div", {
                                className: T.a.sortedText
                            }, "Sorted By:"), o.a.createElement("div", {
                                className: T.a.sortedButton,
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                                    return e.changeSort("number")
                                ...
                                return o.a.createElement("div", {
                                    key: t.number,
                                    className: T.a.questionContainer
                                }, o.a.createElement("div", {
                                    className: T.a.questionImageContainer,
                                    role: "button",
                                    tabIndex: 0,
                                    onClick: t.image ? function() {
                                        return e.setState({
                                    ...
                                    src: Object(A.f)(t.image),
                                    alt: "Question Background",
                                    className: T.a.questionImage
                                })) : o.a.createElement("div", {
                                    className: T.a.imageNumber,
                                    style: {
                                        marginLeft: t.image ? -170 : 0
                                    }
                                    ...
                                    className: T.a.qMathField
                                }, t.text.slice(t.text.indexOf("`*`") + 3, t.text.length - 3))) : null, o.a.createElement("div", {
                                    className: h()(T.a.questionCenterContainer, W({}, T.a.questionWithFunc, t.text.includes("`*`") || t.audio))
                                }, o.a.createElement("div", {
                                    className: T.a.questionText
                                }, t.text.includes("`*`") ? t.text.slice(0, t.text.indexOf("`*`")) : t.text), o.a.createElement("div", {
                                    className: T.a.answerText
                                }, "Answer: ", Object(A.e)(t.correctAnswers))), o.a.createElement("div", {
                                    className: T.a.questionStatsContainer
                                }, o.a.createElement(g.a, {
                                ...
                                className: h()(S.a.modal, S.a.modalButton),
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                                    return e.setState({
                                ...
                                src: Object(A.f)(this.state.zoomedImage, !0),
                                alt: "Upload",
                                className: S.a.bigImage,
                                draggable: !1
                            })) : null, this.state.deleteCheck ? o.a.createElement(I.a, {
                                ...
                                className: T.a.plusModalContainer
                            }, o.a.createElement("i", {
                                className: h()("fas fa-times", T.a.plusTimes),
                                role: "button",
                                tabIndex: 0,
                                onClick: function() {
                                    return e.setState({
                                ...
                                className: T.a.plusText
                            }, "Get Blooket Plus For Detailed Game Reports!"), o.a.createElement(c.b, {
                                className: T.a.upgradeButton,
                                to: "/upgrade"
                            }, "Upgrade"))) : this.state.deleteStanding.name ? o.a.createElement(I.a, {
                            ...
                            }) : this.state.extendPop ? o.a.createElement(I.a, {
                                ...
                                className: T.a.standingModalContainer
                            }, o.a.createElement("i", {
                                className: h()("fas fa-times", T.a.plusTimes),
                                role: "button",
                                tabIndex: 0,
                                ...
                                className: T.a.modalRow
                            }, ["Tower", "Cafe", "Defense"].includes(this.state.type) ? o.a.createElement("i", {
                                className: h()(this.state.standingShown.data.alive ? "fas fa-user" : "fas fa-user-slash", T.a.modalIcon),
                                style: {
                                    color: this.state.standingShown.data.alive ? "#4bc22e" : "#c43a35"
                                }
                            }) : o.a.createElement(F.a, {
                                name: this.state.standingShown.blook,
                                className: T.a.modalBlook
                            }), o.a.createElement("div", {
                                className: T.a.modalColumn
                            }, this.state.standingShown.name, o.a.createElement("div", {
                                className: T.a.modalDesc
                            }, "Tower" === this.state.type ? 34 === this.state.standingShown.data.stage ? "Ascended the Tower!" : "Cleared ".concat(this.state.standingShown.data.stage, " ").concat(1 === this.state.standingShown.data.stage ? "Stage" : "Stages") : "Factory" === this.state.type ? "$".concat(Object(A.k)(this.state.standingShown.data.cash)) : "Cafe" === this.state.type ? "Day ".concat(this.state.standingShown.data.day) : "Defense" === this.state.type ? "Round ".concat(this.state.standingShown.data.round - 1) : "Kingdom" === this.state.type ? "".concat(Object(A.k)(this.state.standingShown.data.guests), " ").concat(1 === this.state.standingShown.data.guests ? "Guest" : "Guests") : "Kingdom" === this.state.type ? "Level ".concat(this.state.standingShown.data.level) : null)), o.a.createElement("div", {
                                className: T.a.modalStats
                            }, o.a.createElement(g.a, {
                                ...
                                className: T.a.mainDivider
                            }, " "), this.state.stdQuestions.map((function(n, r) {
                                return o.a.createElement("div", {
                                    key: n.number,
                                    className: T.a.modalQuestionColumn,
                                    style: {
                                        paddingBottom: r + 1 === e.state.stdQuestions.length ? 10 : 0
                                    }
                                }, o.a.createElement("div", {
                                    ...
                                    src: Object(A.f)(n.image),
                                    alt: "Question Background",
                                    className: T.a.modalQuestionImage
                                })) : n.text.includes("`*`") ? o.a.createElement("div", {
                                    className: T.a.modalFuncContainer
                                }, o.a.createElement(C.StaticMathField, {
                                    className: T.a.qModalMathField
                                }, n.text.slice(n.text.indexOf("`*`") + 3, n.text.length - 3))) : null, o.a.createElement("div", {
                                    style: {
                                        paddingLeft: 10,
                                        fontWeight: "bold"
                                    ...
                                    className: T.a.modalQuestionText
                                }, n.text.includes("`*`") ? n.text.slice(0, n.text.indexOf("`*`")) : n.text), o.a.createElement("div", {
                                    className: T.a.modalQuestionStats
                                }, o.a.createElement(g.a, {
            ...
            t.a = Object(k.c)(Object(u.g)(Object(s.b)((function() {
                return {}
            }), (function(e) {
                return Object(r.b)({}, e)
            }))(le)))
