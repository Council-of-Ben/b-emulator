    ...
    [17], {
            ...
            var u, s = function(t, e, r, n, i) {
                ...
                l = function() {
                    function t(e) {
                        ...
                        }(this, t), u.set(this, void 0), s(this, u, e, "f"), this.plugins = [], this.interactorsInitializers = new Map, this.moversInitializers = new Map, this.updatersInitializers = new Map, this.interactors = new Map, this.movers = new Map, this.updaters = new Map, this.presets = new Map, this.drawers = new Map, this.pathGenerators = new Map
                    }
                    var e, r, o;
                    return e = t, (r = [{
                        key: "getPlugin",
        ...
        Avkg: function(t, e, r) {
            ...
            var p = function(t) {
                ...
                function f(t, e, r, n) {
                    ...
                    return function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, f), (i = u.call(this, t, e, r)).canvasSize = n, i.canvasSize = Object.assign({}, n), i
                }
                return e = f, (r = [{
                    key: "contains",
                    value: function(t) {
                    ...
                    value: function(t) {
                        ...
                        if (void 0 !== e.size) {
                            var u = new i.a(o.x, o.y, 2 * e.size.width, 2 * e.size.height);
                            return c(h(f.prototype), "intersects", this).call(this, u)
                        }
                        return !1
                    }
        ...
        D2zs: function(t, e, r) {
            ...
            function l() {
                ...
                function j(t, e) {
                    ...
                    if (void 0 === r) {
                        if (e.delegate = null, "throw" === e.method) {
                            if (t.iterator.return && (e.method = "return", e.arg = void 0, j(t, e), "throw" === e.method)) return p;
                ...
                return d.prototype = y, n(w, "constructor", {
                    value: y,
                    configurable: !0
                }), n(y, "constructor", {
                    value: d,
                ...
                }, x(k.prototype), s(k.prototype, c, (function() {
                    return this
                })), t.AsyncIterator = k, t.async = function(e, r, n, i, o) {
                    void 0 === o && (o = Promise);
                    var a = new k(f(e, r, n, i), o);
                    return t.isGeneratorFunction(r) ? a : a.next().then((function(t) {
                        return t.done ? t.value : a.next()
                    }))
                }, x(w), s(w, u, "Generator"), s(w, a, (function() {
                    return this
                ...
                return e = t, (r = [{
                    ...
                    value: function(t) {
                        var e, r = this,
                            ...
                            u = n.a.mouseLeaveEvent;
                        if ("window" === c) o.interactivity.element = window, u = n.a.mouseOutEvent;
                        else if ("parent" === c && o.canvas.element) {
                            var s = o.canvas.element;
                            o.interactivity.element = null !== (e = s.parentElement) && void 0 !== e ? e : s.parentNode
                    ...
                    key: "mouseTouchMove",
                    value: function(t) {
                        var e, r, i, o, a, c, u, s = this.container,
                            l = s.actualOptions;
                        if (null === (e = s.interactivity) || void 0 === e ? void 0 : e.element) {
                            var f;
                            s.interactivity.mouse.inside = !0;
                            var h = s.canvas.element;
                            if (t.type.startsWith("mouse")) {
                                ...
                                } else p.target === s.canvas.element && (f = {
                                ...
                                f = {
                                    ...
                                    y: k.clientY - (null !== (u = null == O ? void 0 : O.top) && void 0 !== u ? u : 0)
                                }
                            }
                            var j = s.retina.pixelRatio;
                            f && (f.x *= j, f.y *= j), s.interactivity.mouse.position = f, s.interactivity.status = n.a.mouseMoveEvent
                        }
                    }
                }, {
        ...
        FBI6: function(t, e, r) {
            ...
            var y, m = function(t, e, r, n, i) {
                ...
                w = function() {
                    function t(e, r, s, l, p, v) {
                        var d, g, w, x, k, O, j;
                        ! function(t, e) {
                            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                        }(this, t), this.id = r, this.container = s, this.group = v, y.set(this, void 0), m(this, y, e, "f"), this.fill = !0, this.close = !0, this.lastPathTime = 0, this.destroyed = !1, this.unbreakable = !1, this.splitCount = 0, this.misplaced = !1, this.retina = {
                            maxDistance: {}
                        }, this.ignoresResizeRatio = !0;
                        var E = s.retina.pixelRatio,
                            P = s.actualOptions,
                            S = new a.a;
                        S.load(P.particles);
                        var L = S.shape.type,
                        ...
                        this.size = {
                            ...
                            value: Object(n.p)(_) * s.retina.pixelRatio,
                            max: Object(n.m)(I) * E,
                            min: Object(n.n)(I) * E,
                            loops: 0,
                        ...
                        if (A.enable) {
                            switch (this.size.status = 0, A.startValue) {
                                case "min":
                                    ...
                                    break;
                                case "random":
                                    this.size.value = Object(n.r)(this.size) * E, this.size.status = Math.random() >= .5 ? 0 : 1;
                                    break;
                                case "max":
                                default:
                                    this.size.value = this.size.max, this.size.status = 1
                            }
                            this.size.velocity = (null !== (j = this.retina.sizeAnimationSpeed) && void 0 !== j ? j : s.retina.sizeAnimationSpeed) / 100 * s.retina.reduceFactor, A.sync || (this.size.velocity *= Math.random())
                        }
                        ...
                        this.gravity = {
                            ...
                            inverse: R.inverse
                        }, this.position = this.calcPosition(s, l, Object(n.g)(C, 0, s.zLayers)), this.initialPosition = this.position.copy(), this.offset = u.a.origin;
                        var F = s.particles;
                        F.needsSort = F.needsSort || F.lastZIndex < this.position.z, F.lastZIndex = this.position.z, this.zIndexFactor = this.position.z / s.zLayers, this.sides = 24;
                        var D = s.drawers.get(this.shape);
                        D || (D = b(this, y, "f").plugins.getShapeDrawer(this.shape)) && s.drawers.set(this.shape, D), (null == D ? void 0 : D.loadShape) && (null == D || D.loadShape(this));
                        ...
                        var G, H = h(s.particles.updaters);
                        try {
                            for (H.s(); !(G = H.n()).done;) {
                                var q = G.value;
                                q.init && q.init(this)
                    ...
                    return e = t, (r = [{
                        ...
                        value: function(t, e, r) {
                            var i, o, a, c, u, l = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0,
                                p = h(t.plugins);
                            try {
                                for (p.s(); !(u = p.n()).done;) {
                                    var v = f(u.value, 2),
                                    ...
                                    if (void 0 !== y) return s.a.create(y.x, y.y, r)
                                }
                            } catch (t) {
                                p.e(t)
                            } finally {
                            ...
                            return O(null !== (i = k.left) && void 0 !== i ? i : k.default), O(null !== (o = k.right) && void 0 !== o ? o : k.default), j(null !== (a = k.top) && void 0 !== a ? a : k.default), j(null !== (c = k.bottom) && void 0 !== c ? c : k.default), this.checkOverlap(w, l) ? this.calcPosition(t, void 0, r, l + 1) : w
                        }
                    }, {
                        key: "checkOverlap",
                        value: function(t) {
                            ...
                            var c, u = !1,
                                s = h(this.container.particles.array);
                            try {
                                for (s.s(); !(c = s.n()).done;) {
                                    var l = c.value;
        ...
        FDSO: function(t, e, r) {
            ...
            function s() {
                ...
                return d.prototype = y, n(w, "constructor", {
                    ...
                    value: d,
                    configurable: !0
                }), d.displayName = l(y, u, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                    var e = "function" == typeof t && t.constructor;
                    return !!e && (e === d || "GeneratorFunction" === (e.displayName || e.name))
                }, t.mark = function(t) {
                ...
                }, x(k.prototype), l(k.prototype, c, (function() {
                    return this
                })), t.AsyncIterator = k, t.async = function(e, r, n, i, o) {
                    void 0 === o && (o = Promise);
                    var a = new k(f(e, r, n, i), o);
            ...
            var y = function() {
                ...
                return e = t, (r = [{
                        ...
                        return s().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 5:
                                    ...
                                    return u = a.status, console.error("Error tsParticles - fetch status: ".concat(u)), console.error("Error tsParticles - File config not found"), t.abrupt("return");
                                case 9:
                    ...
                    key: "set",
                    value: (y = f(s().mark((function t(e, r, n, i) {
                        var o;
                        return s().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                    ...
                    key: "loadJSON",
                    value: (l = f(s().mark((function t(e, r, n) {
                        var i, o;
                        return s().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                    ...
                    key: "setJSON",
                    value: (u = f(s().mark((function t(e, r, n, i) {
                        var o, a, c, u;
                        return s().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return e instanceof HTMLElement ? (u = e, o = r, c = n) : (a = e, u = r, o = n, c = i), t.abrupt("return", this.loadRemoteOptions({
                                        tagId: a,
                                        url: o,
                                        index: c,
                                        element: u
                ...
                return e = u, (r = [{
                    ...
                    value: function(t) {
                        ...
                        var c = e.size,
                            u = c.width,
                            s = c.height;
                        return a.x < o.x + n && a.x + u > o.x && a.y < o.y + i && a.y + s > o.y
                    }
                ...
                return e = t, (r = [{
                    ...
                    value: function() {
                        ...
                        if (e.canvas.element) {
                            ...
                            e.canvas.size.width = s.offsetWidth * u, e.canvas.size.height = s.offsetHeight * u
                        }
                        var l = r.particles;
                        this.attractDistance = Object(n.o)(l.move.attract.distance) * u, this.linksDistance = l.links.distance * u, this.linksWidth = l.links.width * u, this.sizeAnimationSpeed = Object(n.o)(l.size.animation.speed) * u, this.maxSpeed = Object(n.o)(l.move.gravity.maxSpeed) * u;
                        var f = r.interactivity.modes;
                        this.connectModeDistance = f.connect.distance * u, this.connectModeRadius = f.connect.radius * u, this.grabModeDistance = f.grab.distance * u, this.repulseModeDistance = f.repulse.distance * u, this.bounceModeDistance = f.bounce.distance * u, this.attractModeDistance = f.attract.distance * u, this.slowModeRadius = f.slow.radius * u, this.bubbleModeDistance = f.bubble.distance * u, f.bubble.size && (this.bubbleModeSize = f.bubble.size * u)
                    }
                }, {
                    key: "initParticle",
                    value: function(t) {
        ...
        hZ54: function(t, e, r) {
            ...
            function f() {
                ...
                return d.prototype = y, n(w, "constructor", {
                    ...
                    value: d,
                    configurable: !0
                }), d.displayName = u(y, c, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                    var e = "function" == typeof t && t.constructor;
                    return !!e && (e === d || "GeneratorFunction" === (e.displayName || e.name))
                }, t.mark = function(t) {
            ...
            var g, w = function(t, e, r, n, i) {
                ...
                k = function() {
                    function t(e, r) {
                        ...
                        this.linksColors = new Map, this.quadTree = new u.a(new s.a(-n.width / 4, -n.height / 4, 3 * n.width / 2, 3 * n.height / 2), 4), this.movers = x(this, g, "f").plugins.getMovers(r, !0), this.updaters = x(this, g, "f").plugins.getUpdaters(r, !0)
                    }
                    var e, r, l, h, y, m;
                    return e = t, (r = [{
                        key: "count",
                        ...
                        value: function() {
                            ...
                            if (this.addManualParticles(), !n) {
                                for (var c in r.particles.groups)
                                    for (var u = r.particles.groups[c], s = this.count, l = 0; l < (null === (t = u.number) || void 0 === t ? void 0 : t.value) && s < r.particles.number.value; s++, l++) this.addParticle(void 0, u, c);
                        ...
                        value: (y = p(f().mark((function t(e) {
                            var r, n, i, o, a, u, s, l, h, p, y, m, b, g, w, x, k, O, j, E, P, S, L, z, T;
                            return f().wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        r = this.container, n = [], r.pathGenerator.update(), i = d(r.plugins);
                                        try {
                                            for (i.s(); !(o = i.n()).done;) a = v(o.value, 2), void 0 !== (u = a[1]).update && u.update(e)
                                        } catch (t) {
                                            i.e(t)
                                        } finally {
                                            i.f()
                                        }
                                        s = d(this.array), t.prev = 5, s.s();
                                    case 7:
                                        if ((l = s.n()).done) {
                                            t.next = 39;
                                            break
                                    ...
                                    case 39:
                                        ...
                                        break;
                                    case 41:
                                        t.prev = 41, t.t1 = t.catch(5), s.e(t.t1);
                                    case 44:
                                        return t.prev = 44, s.f(), t.finish(44);
                                    case 47:
                                        for (O = 0, j = n; O < j.length; O++) E = j[O], this.remove(E);
                        ...
                        value: (h = p(f().mark((function t(e) {
                            ...
                            return f().wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return r = this.container, n = this.container.canvas.size, this.quadTree = new u.a(new s.a(-n.width / 4, -n.height / 4, 3 * n.width / 2, 3 * n.height / 2), 4), r.canvas.clear(), t.next = 5, this.update(e);
                                    case 5:
                        ...
                        value: function(t, e, r) {
                            ...
                            if (null === (n = t.number.density) || void 0 === n ? void 0 : n.enable) {
                                var i = t.number,
                                    ...
                                    u = Math.min(a, c) * o + e,
                                    s = Math.min(this.count, this.array.filter((function(t) {
                                        return t.group === r
                                    })).length);
                                this.limit = i.limit * o, s < u ? this.push(Math.abs(u - s), void 0, t, r) : s > u && this.removeQuantity(s - u, r)
                            }
                        }
                    }, {
        ...
        hs3Q: function(t, e, r) {
            ...
            var f = function(t) {
                ...
                function s(t, e, r) {
                    ...
                    if (function(t, e) {
                            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                        }(this, s), n = a.call(this, t, e), "number" != typeof t && t) n.z = t.z;
                    else {
                ...
                return e = s, n = [{
                    ...
                    key: "add",
                    value: function(t) {
                        return t instanceof s ? s.create(this.x + t.x, this.y + t.y, this.z + t.z) : o(l(s.prototype), "add", this).call(this, t)
                    }
                }, {
                    key: "addTo",
                    value: function(t) {
                        o(l(s.prototype), "addTo", this).call(this, t), t instanceof s && (this.z += t.z)
                    }
                }, {
                    key: "sub",
                    value: function(t) {
                        return t instanceof s ? s.create(this.x - t.x, this.y - t.y, this.z - t.z) : o(l(s.prototype), "sub", this).call(this, t)
                    }
                }, {
                    key: "subFrom",
                    value: function(t) {
                        o(l(s.prototype), "subFrom", this).call(this, t), t instanceof s && (this.z -= t.z)
                    }
                }, {
                    key: "mult",
                    value: function(t) {
                    ...
                    key: "multTo",
                    value: function(t) {
                        o(l(s.prototype), "multTo", this).call(this, t), this.z *= t
                    }
                }, {
                    key: "div",
                    value: function(t) {
                    ...
                    key: "divTo",
                    value: function(t) {
                        o(l(s.prototype), "divTo", this).call(this, t), this.z /= t
                    }
                }, {
                    key: "copy",
                    value: function() {
                    ...
                    key: "setTo",
                    value: function(t) {
                        o(l(s.prototype), "setTo", this).call(this, t);
                        var e = t;
        ...
        ibU6: function(t, e, r) {
            ...
            var l = function() {
                ...
                return e = t, (r = [{
                    ...
                    key: "query",
                    value: function(t, e) {
                        var r, n, i, o, u = null != e ? e : [];
                        if (!t.intersects(this.rectangle)) return [];
                        var s, l = c(this.points);
                        try {
                            for (l.s(); !(s = l.n()).done;) {
                                var f = s.value;
                                !t.contains(f.position) && Object(a.i)(t.position, f.position) > f.particle.getRadius() || u.push(f.particle)
                            }
                        } catch (t) {
                            l.e(t)
                        } finally {
                        ...
                        return this.divided && (null === (r = this.northEast) || void 0 === r || r.query(t, u), null === (n = this.northWest) || void 0 === n || n.query(t, u), null === (i = this.southEast) || void 0 === i || i.query(t, u), null === (o = this.southWest) || void 0 === o || o.query(t, u)), u
                    }
                }, {
                    key: "subdivide",
                    value: function() {
        ...
        jPhR: function(t, e, r) {
            ...
            function i() {
                ...
                return d.prototype = y, o(w, "constructor", {
                    value: y,
                    configurable: !0
                }), o(y, "constructor", {
                    value: d,
                    configurable: !0
                }), d.displayName = l(y, s, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                    var e = "function" == typeof t && t.constructor;
                    return !!e && (e === d || "GeneratorFunction" === (e.displayName || e.name))
                }, t.mark = function(t) {
                ...
                }, x(k.prototype), l(k.prototype, u, (function() {
                    return this
                })), t.AsyncIterator = k, t.async = function(e, r, n, i, o) {
                    void 0 === o && (o = Promise);
                    var a = new k(f(e, r, n, i), o);
                            ...
                            return i().wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 5:
                                        ...
                                        if (!(s = u.value).isEnabled(e)) {
                                            t.next = 10;
                                            break
                                        }
                                        return t.next = 10, s.interact(e, r);
                                    case 10:
                                        t.next = 5;
                                        break;
                                    case 12:
        ...
        mZtP: function(t, e, r) {
            ...
            var f = function(t) {
                ...
                function s(t, e, r) {
                    ...
                    return function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, s), (n = o.call(this, t, e)).radius = r, n
                }
                return e = s, (r = [{
                    key: "contains",
                    value: function(t) {
                    ...
                    value: function(t) {
                        ...
                        if (void 0 !== e.size) {
                            var u = e.size.width,
                                s = e.size.height,
                                l = Math.pow(o - u, 2) + Math.pow(a - s, 2);
                            return !(o > c + u || a > c + s) && (o <= u || a <= s || l <= c * c)
                        }
                        return !1
                    }
                }]) && a(e.prototype, r), n && a(e, n), Object.defineProperty(e, "prototype", {
