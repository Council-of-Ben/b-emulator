        ...
        "3BRs": function(e, t, n) {
            ...
            (function(t, r, i) {
                ...
                function y(e, t) {
                    ...
                    this.highWaterMark = i || 0 === i ? i : r && (f || 0 === f) ? f : d, this.highWaterMark = Math.floor(this.highWaterMark), this.finalCalled = !1, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1, this.destroyed = !1;
                    ...
                    if (e._writev && n && n.next) {
                        ...
                        for (; n;) {
                            var f = n.chunk,
                                d = n.encoding,
                                l = n.callback;
                            if (v(e, t, !1, t.objectMode ? 1 : f.length, f, d, l), n = n.next, t.bufferedRequestCount--, t.writing) break
                        }
                ...
                f.inherits(w, l), y.prototype.getBuffer = function() {
        ...
        BQ0V: function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return function(e) {
                    ...
                    return function(e) {
                        return function(s) {
                            n = t(), a = o.detectMutations(), o = d(n), (0, r.default)(!a.wasMutated, u, (a.path || []).join("."));
                            var l = e(s);
                            return n = t(), a = o.detectMutations(), o = d(n), a.wasMutated && (0, r.default)(!a.wasMutated, f, (a.path || []).join("."), (0, i.default)(s)), l
                        }
                    }
                }
            };
            ...
            var u = ["A state mutation was detected between dispatches, in the path `%s`.", "This may cause incorrect behavior.", "(http://redux.js.org/docs/Troubleshooting.html#never-mutate-reducer-arguments)"].join(" "),
                f = ["A state mutation was detected inside a dispatch, in the path: `%s`.", "Take a look at the reducer(s) handling the action %s.", "(http://redux.js.org/docs/Troubleshooting.html#never-mutate-reducer-arguments)"].join(" ")
        },
        CWBI: function(e, t, n) {
            e.exports = n("sZro")
        },
                ...
                return {
                    detectMutations: function() {
                        return function e(t) {
                            ...
                            for (var d = Object.keys(f), l = 0; l < d.length; l++) {
                                var h = d[l],
                                    c = a.concat(h);
            ...
            (function(t, r) {
                ...
                function m(e, t, n, r, i) {
                    ...
                    null === t ? (a.reading = !1, function(e, t) {
                        ...
                        var n;
                        r = t, f.isBuffer(r) || r instanceof d || "string" == typeof t || void 0 === t || e.objectMode || (n = new TypeError("Invalid non-string/buffer chunk"));
                        var r;
                        return n
                ...
                Object.defineProperty(v.prototype, "destroyed", {
                    ...
                    return r.objectMode ? n = !0 : "string" == typeof e && ((t = t || r.defaultEncoding) !== r.encoding && (e = f.from(e, t), t = ""), n = !0), m(this, e, t, !1, n)
                ...
                v.prototype.read = function(e) {
                    ...
                    var u = (!t || !1 !== t.end) && e !== r.stdout && e !== r.stderr ? d : v;

                    function f(t, r) {
                        c("onunpipe"), t === n && r && !1 === r.hasUnpiped && (r.hasUnpiped = !0, c("cleanup"), e.removeListener("close", y), e.removeListener("finish", w), e.removeListener("drain", l), e.removeListener("error", g), e.removeListener("unpipe", f), n.removeListener("end", d), n.removeListener("end", v), n.removeListener("data", b), h = !0, !o.awaitDrain || e._writableState && !e._writableState.needDrain || l())
                    }
                    ...
                    function b(t) {
                        c("ondata"), p = !1, !1 !== e.write(t) || p || ((1 === o.pipesCount && o.pipes === e || o.pipesCount > 1 && -1 !== q(o.pipes, e)) && !h && (c("false write response, pause", n._readableState.awaitDrain), n._readableState.awaitDrain++, p = !0), n.pause())
                    }
